...
final class SiteMenu(trans: I18nKeys) {
  ...
  private val authenticated = List(play, user, team, forum, message)//, game, tournament, user, team, forum, message)
  private val anonymous = List(play, user, team, forum)//, game, tournament, user, team, forum)
