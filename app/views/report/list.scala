...
import lidraughts.report.Report.WithSuspect
...
object list {
  ...
  def apply(
    reports: List[lidraughts.report.Report.WithSuspect],
    filter: String,
    counts: lidraughts.report.Room.Counts,
    streamers: Int
        ...
        div(id := "report_list", cls := "page-menu__content box")(
          div(cls := "header")(
            ...
            span(cls := "tabs")(
              ...
              lidraughts.report.Room.all.map { room =>
                a(
