...
object index {
  ...
  def apply(
    ...
    def widget(s: lidraughts.streamer.Streamer.WithUser, stream: Option[lidraughts.streamer.Stream]) = a(
      cls := "overlay",
      href := {
    ...
    views.html.base.layout(
      ...
      moreJs = infiniteScrollTag
        ...
        main(cls := "page-menu")(
          ...
          div(cls := "page-menu__content box streamers")(
            h1(dataIcon := "", cls := "text")(title),
            !requests option div(cls := "list live")(
              live.map { s =>
                div(cls := "streamer")(widget(s.withoutStream, s.stream))
              }
            ),
