...
object embed {
  ...
  private implicit def lang(implicit req: RequestHeader): Lang = lidraughts.i18n.I18nLangPicker(req, none)

  def apply(s: lidraughts.study.Study, chapter: lidraughts.study.Chapter, data: lidraughts.study.JsonView.JsData)(implicit req: RequestHeader) = frag(
    doctype,
