...
object bits {
  ...
  def authLinks(me: User, active: String, order: lidraughts.study.Order)(implicit ctx: Context) = frag(
  ...
  def widget(s: lidraughts.study.Study.WithChaptersAndLiked)(implicit ctx: Context) = frag(
