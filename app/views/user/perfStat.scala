  ...
  private def glicko(u: User, perfType: PerfType, perf: Perf, percentile: Option[Double])(implicit
    ...
    st.section(cls := "glicko")(
      ...
      p(
        ...
        ratingDeviation(
          strong(
            title := ratingDeviationHelp.txt(lila.rating.Glicko.provisionalDeviation, lila.rating.Glicko.standardRankableDeviation, lila.rating.Glicko.variantRankableDeviation)
