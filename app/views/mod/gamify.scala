...
object gamify {
  ...
  def index(leaderboards: lidraughts.mod.Gamify.Leaderboards, history: List[lidraughts.mod.Gamify.HistoryMonth])(implicit ctx: Context) = {
  ...
  def period(leaderboards: lidraughts.mod.Gamify.Leaderboards, period: lidraughts.mod.Gamify.Period)(implicit ctx: Context) = {
  ...
  def champion(champ: Option[lidraughts.mod.Gamify.ModMixed], img: String, period: lidraughts.mod.Gamify.Period)(implicit ctx: Context) =
    div(cls := "champ")(
      ...
      a(cls := "button button-empty", href := routes.Mod.gamifyPeriod(period.name))("View ", period.name, " leaderboard")
    )
}
