...
object irwin {
  ...
  def dashboard(dashboard: lidraughts.irwin.IrwinDashboard)(implicit ctx: Context) = base.layout(
        ...
        div(cls := "irwin page-menu__content box")(
          div(cls := "box__top")(
            ...
            div(cls := "box__top__actions")(
              a(href := "https://monitor.lidraughts.ovh/dashboard/db/lidraughts-moderation", cls := "button button-empty")("Monitoring")
            )
          ),
  ...
  def report(report: lidraughts.irwin.IrwinReport.WithPovs)(implicit ctx: Context): Frag =
    div(id := "mz_irwin")(
      header(
      ...
      table(cls := "slist")(
        tbody(
          report.withPovs.sortBy(-_.report.activation).map {
            case lidraughts.irwin.IrwinReport.GameReport.WithPov(gameReport, pov) =>
              tr(cls := "text")(
                td(cls := "moves")(
