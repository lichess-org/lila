...
object tourForm:
  ...
  def create(form: Form[Data])(implicit ctx: WebContext) =
  ...
  def edit(t: RelayTour, form: Form[Data])(implicit ctx: WebContext) =
  ...
  private def layout(title: String, menu: Option[String])(body: Modifier*)(implicit ctx: WebContext) =
  ...
  private def inner(form: Form[Data])(implicit ctx: WebContext) = frag(
