      ...
      main(cls := "box box-pad features")(
        table(
          ...
          tbody(
            ...
            tr(check)(
              trans.features.availableInNbLanguages(a(href := "https://crowdin.com/project/lichess")("140+"))
            ),
            tr(check)(
          ...
          tbody(
            ...
            tr(check)(
              trans.features.availableInNbLanguages(a(href := "https://crowdin.com/project/lichess")("100+"))
            ),
            tr(check)(
              trans.features.lightOrDarkThemeCustomBoardsPiecesAndBackground()
            ),
