...
trait RequestGetter:
  ...
  protected def get(name: String)(using ctx: AnyContext): Option[String] = get(name, ctx.req)
  protected def getAs[A](
      name: String
  )(using ctx: AnyContext, sr: SameRuntime[String, A]): Option[A] = get(name).map(sr.apply)
  ...
  protected def getUserStr(name: String)(using ctx: AnyContext): Option[UserStr] =
  ...
  protected def getInt(name: String)(using AnyContext) =
  ...
  protected def getLong(name: String)(using AnyContext) =
  ...
  protected def getBool(name: String)(using AnyContext): Boolean =
  ...
  protected def getBoolOpt(name: String)(using AnyContext): Option[Boolean] =
