...
trait SetupHelper { self: I18nHelper =>
  ...
  def translatedTimeModeChoices(implicit lang: Lang) = List(
  ...
  def translatedReasonChoices(implicit lang: Lang) = List(
  ...
  def translatedSideChoices(implicit lang: Lang) = List(
    ("black", trans.black.txt(), none),
    ("random", trans.randomColor.txt(), none),
    ("white", trans.white.txt(), none)
  )

  def translatedAnimationChoices(implicit lang: Lang) = List(
  ...
  def translatedClockTenthsChoices(implicit lang: Lang) = List(
  ...
  def translatedMoveEventChoices(implicit lang: Lang) = List(
  ...
  def translatedTakebackChoices(implicit lang: Lang) = List(
  ...
  def translatedMoretimeChoices(implicit lang: Lang) = List(
  ...
  def translatedAutoQueenChoices(implicit lang: Lang) = List(
  ...
  def translatedAutoThreefoldChoices(implicit lang: Lang) = List(
  ...
  def submitMoveChoices(implicit lang: Lang) = List(
  ...
  def confirmResignChoices(implicit lang: Lang) = List(
    (Pref.ConfirmResign.NO, trans.no.txt()),
    (Pref.ConfirmResign.YES, trans.yes.txt())
  )

  def translatedRookCastleChoices(implicit lang: Lang) = List(
  ...
  def translatedChallengeChoices(implicit lang: Lang) = List(
  ...
  def privacyBaseChoices(implicit lang: Lang) = List(
  ...
  def translatedInsightShareChoices(implicit lang: Lang) = List(
  ...
  def translatedBoardResizeHandleChoices(implicit lang: Lang) = List(
  ...
  def translatedBlindfoldChoices(implicit lang: Lang) = List(
