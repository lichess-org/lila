...
This can be very annoying for your opponents. If this behavior continues to happen, we may be forced to terminate your account."""
  ...
  lazy val enableTwoFactor = MsgPreset(
    ...
    text = """Please enable two-factor authentication to secure your account at https://lichess.org/account/twofactor.
You received this message because your account has special responsibilities such as team leader, coach, teacher or streamer."""
  )
