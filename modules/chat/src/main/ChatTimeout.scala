...
object ChatTimeout {
  ...
  object Reason {
    case object PublicShaming extends Reason("shaming", "public shaming; please use newchess.fun/report")
    case object Insult
        extends Reason("insult", "disrespecting other players; see newchess.fun/page/chat-etiquette")
    case object Spam  extends Reason("spam", "spamming the chat; see newchess.fun/page/chat-etiquette")
    case object Other extends Reason("other", "inappropriate behavior; see newchess.fun/page/chat-etiquette")
