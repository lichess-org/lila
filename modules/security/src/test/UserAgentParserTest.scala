...
class UserAgentTrustTest extends munit.FunSuite:
  ...
  def parse(ua: String) = UserAgentParser.parse(UserAgent(ua))
  def susp(ua: String) = UserAgentParser.trust.isSuspicious(UserAgent(ua))
  def isDangerousIOS(ua: String) = UserAgentParser.trust.isDangerousIOS(parse(ua))
  def isDangerousSafari(ua: String) = UserAgentParser.trust.isDangerousSafari(parse(ua))
  def isDangerousChrome(ua: String) = UserAgentParser.trust.isDangerousChrome(parse(ua))
