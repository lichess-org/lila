...
import lidraughts.socket.Socket.{ SocketVersion, socketVersionFormat }
...
private[round] object VersionedEvent {
  ...
  private implicit val SocketVersionHandler = lidraughts.db.dsl.intAnyValHandler[SocketVersion](_.value, SocketVersion.apply)
