  ...
  "convert UCI analysis to PGN" should {
    "work :)" in {
      val uciAnalysis = Analysis("ke5ssdgj", List(
        ...
        Info(6, Eval(Some(Cp(-80)), None, None), List("g8f6", "e2e3", "c7c5", "g1f3", "b8c6", "b1c3", "c5d4", "e3d4", "f8e7", "f1e2", "f6e4")),
        ...
        Info(20, Eval(Some(Cp(-113)), None, None), List("c8d7", "b1d2", "c6e7", "d2f3", "c7c5", "f3e5", "c5d4", "e3d4", "f6e4", "e1g1", "a8c8", "d1e2", "e4g5", "f4g5", "g7e5", "e2e5", "c8c2")),
        Info(21, Eval(Some(Cp(-42)), None, None), List("g5e4", "d5e4", "e1g1", "g6g5", "d1h5", "g5f4", "f1f4", "d8d5", "h5d5", "e6d5", "h3c8", "a8c8", "b1c3", "f8d8")),
        Info(22, Eval(Some(Cp(-535)), None, None), List("c8e6", "g5e4", "d5e4", "h2h4", "g7f6", "h4h5", "f6h4", "e1f1", "g6g5", "b1d2", "e6f5", "f4g5", "d8g5", "h1h4", "g5h4")),
        Info(23, Eval(Some(Cp(-296)), None, None), List("g5e4", "d5e4", "h2h4", "f8f5", "b1c3", "f5h5", "d1d2", "h5h4", "h1g1", "h4h6", "d2f2", "d8h4", "f2h4", "h6h4", "g1g6", "h4h1", "e1f2", "h1h2", "g6g2")),
        Info(24, Eval(None, Some(Mate(3)), None), List("d8h4", "e1e2", "h4f2", "e2d3", "c6b4")),
        Info(25, Eval(Some(Cp(-935)), None, None), List("e1g1", "e6h3", "b1d2", "h3f1", "d1f1", "d8e8", "f1d3", "e4f6", "d2f3", "a7a6", "f3e5", "f6e4", "c1d2", "c6e5", "d4e5")),
        Info(26, Eval(Some(Cp(-2165)), None, None), List()),
        Info(27, Eval(Some(Cp(-2731)), None, None), List("g1g3", "h4h2", "d1f3", "e4g3", "c2c3", "h2g1", "e1d2", "g3e4", "d2c2", "e6g4", "f3g4", "g1g4", "b1d2", "g4e2", "a2a4", "a8e8", "a1a3", "e4d2", "c1d2", "e8e3")),
        Info(28, Eval(None, Some(Mate(2)), None), List("h4f2", "e2d3", "c6b4")),
        Info(29, Eval(None, Some(Mate(-2)), None), List())), 0, None, None, now)
