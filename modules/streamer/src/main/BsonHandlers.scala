...
private object BsonHandlers {
  ...
  implicit val StreamerIdBSONHandler: BSONHandler[Streamer.Id] = stringAnyValHandler[Streamer.Id](_.value, Streamer.Id.apply)
  ...
  implicit val StreamerNameBSONHandler: BSONHandler[Streamer.Name] = stringAnyValHandler[Streamer.Name](_.value, Streamer.Name.apply)
