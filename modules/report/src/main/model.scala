...
object Snooze {
  ...
  object Duration {
    case object TwentyMinutes extends Duration(1 hour, "20 minutes")
    case object OneHour       extends Duration(1 hour, "one hour")
    case object ThreeHours    extends Duration(1 hour, "three hours")
    case object OneDay        extends Duration(1 hour, "one day")
