...
private[coach] object BsonHandlers {
  ...
  implicit val CoachListedBSONHandler: BSONHandler[Coach.Listed] =
    booleanAnyValHandler[Coach.Listed](_.value, Coach.Listed.apply)
  ...
  implicit val CoachApprovedBSONHandler: BSONHandler[Coach.Approved] =
    booleanAnyValHandler[Coach.Approved](_.value, Coach.Approved.apply)
  ...
  implicit val CoachProfileBSONHandler: BSONDocumentHandler[CoachProfile] =
    Macros.handler[CoachProfile]
