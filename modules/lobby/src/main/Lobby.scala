...
import lidraughts.socket.Socket.Uids
...
private[lobby] final class Lobby(
  ...
  def receive = {
    ...
    case lidraughts.pool.HookThieve.GetCandidates(clock) =>
      sender ! lidraughts.pool.HookThieve.PoolHooks(HookRepo poolCandidates clock)
