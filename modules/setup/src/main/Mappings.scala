...
private object Mappings {
  ...
  val variantWithSfen           = number.verifying(Config.variantsWithSfen contains _)
  ...
  val variantWithSfenAndVariants = number.verifying(Config.variantsWithSfenAndVariants contains _)
