...
class FullOpeningTest extends Specification {
  ...
  "search" should {
    ...
    "ignore everything after a Crazyhouse drop" in {
      searchStr("e4 d5 exd5 Qxd5 Nc3 Qa5 d4 Nf6 Nf3 Bf5 @e5 @b4 Bd2") must beSome.like {
        case o => o.name == "Scandinavian Defense: Classical Variation"
      }
    }
    "find Muzio" in {
      searchStr(
    ...
    "find Old Benoni Defense" in {
      searchStr("d4 c5 d5 e5") must beSome.like {
        case o => o.name == "Old Benoni Defense"
      }
    }
  }
