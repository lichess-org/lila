...
object Speed {
  ...
  case object UltraBullet
      extends Speed(0, "ultraBullet", 0 to 59, "UltraBullet", "Insanely fast games: less than 1 minute")
  case object Bullet extends Speed(1, "bullet",  60 to  299, "Bullet", "Very fast games: less than 5 minutes")
  case object Blitz  extends Speed(2, "blitz",  300 to 1479, "Blitz",  "Fast games: 5 to 15 minutes")
  case object Rapid  extends Speed(5, "rapid", 1500 to 4499, "Rapid",  "Rapid games: 15 to 45 minutes")
  case object Classical
      extends Speed(3, "classical", 1500 to 21599, "Classical", "Classical games: at least 45 minutes")
