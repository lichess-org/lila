...
import lila.common.Form.{ cleanNonEmptyText, cleanText, markdownImage, mustNotContainNewChess, numberIn }
...
final private[team] class TeamForm(
  ...
  private object Fields {
    val name     = "name"     -> cleanText(minLength = 3, maxLength = 60).verifying(mustNotContainNewChess(false))
