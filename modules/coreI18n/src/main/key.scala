...
object I18nKey:
  ...
  object appeal:
    ...
    val `onlyOneAccountOnLeaderboards`: I18nKey = "appeal:onlyOneAccountOnLeaderboards"
    val `closedByModerators`: I18nKey = "appeal:closedByModerators"
    val `blogRestriction`: I18nKey = "appeal:blogRestriction"
    val `blogRestrictionInfo`: I18nKey = "appeal:blogRestrictionInfo"
    ...
    val `blogEtiquette`: I18nKey = "appeal:blogEtiquette"
  ...
  object arena:
    ...
    val `howArePlayersPaired`: I18nKey = "arena:howArePlayersPaired"
    ...
    val `defenderLabel`: I18nKey = "arena:defenderLabel"
  ...
  object contact:
    ...
    val `cantClearHistoryOrResetRatings`: I18nKey = "contact:cantClearHistoryOrResetRatings"
  ...
  object dgt:
    ...
    val `configureYourDgtBoard`: I18nKey = "dgt:configureYourDgtBoard"
  ...
  object localAnalysis:
    val `analyse`: I18nKey = "localAnalysis:analyse"
    val `localAnalysis`: I18nKey = "localAnalysis:localAnalysis"
    val `local`: I18nKey = "localAnalysis:local"
    val `currentAnalysis`: I18nKey = "localAnalysis:currentAnalysis"
    val `XAnalysis`: I18nKey = "localAnalysis:XAnalysis"
    val `cannotPublish`: I18nKey = "localAnalysis:cannotPublish"
    val `projected`: I18nKey = "localAnalysis:projected"
    val `nodesPerMove`: I18nKey = "localAnalysis:nodesPerMove"
    val `xNodesPerMove`: I18nKey = "localAnalysis:xNodesPerMove"
    val `using`: I18nKey = "localAnalysis:using"
    val `willUse`: I18nKey = "localAnalysis:willUse"
    val `quality`: I18nKey = "localAnalysis:quality"
    val `standardQuality`: I18nKey = "localAnalysis:standardQuality"
    val `broadcast`: I18nKey = "localAnalysis:broadcast"
    val `broadcastQuality`: I18nKey = "localAnalysis:broadcastQuality"
    val `timed`: I18nKey = "localAnalysis:timed"
    val `timedQuality`: I18nKey = "localAnalysis:timedQuality"
    val `outperformBroadcastXSeconds`: I18nKey = "localAnalysis:outperformBroadcastXSeconds"
    val `doneInX`: I18nKey = "localAnalysis:doneInX"
    val `moveXOfY`: I18nKey = "localAnalysis:moveXOfY"
    val `xTimesYQuality`: I18nKey = "localAnalysis:xTimesYQuality"
    val `downloadingXofY`: I18nKey = "localAnalysis:downloadingXofY"
    val `publish`: I18nKey = "localAnalysis:publish"
    val `published`: I18nKey = "localAnalysis:published"
    val `analysisUploadFailed`: I18nKey = "localAnalysis:analysisUploadFailed"
    val `serverAnalysisInProgress`: I18nKey = "localAnalysis:serverAnalysisInProgress"
    val `youCanPublish`: I18nKey = "localAnalysis:youCanPublish"
    val `turnOnRec`: I18nKey = "localAnalysis:turnOnRec"
    val `whenUpgradingOldChapters`: I18nKey = "localAnalysis:whenUpgradingOldChapters"
    val `looksLikeASimilar`: I18nKey = "localAnalysis:looksLikeASimilar"
    val `keepMine`: I18nKey = "localAnalysis:keepMine"
    val `useTheirs`: I18nKey = "localAnalysis:useTheirs"
    val `serverAlreadyHas`: I18nKey = "localAnalysis:serverAlreadyHas"
    val `startingPosition`: I18nKey = "localAnalysis:startingPosition"
    val `keepThisBrowserTabActive`: I18nKey = "localAnalysis:keepThisBrowserTabActive"
  ...
  object oauthScope:
    ...
    val `manageTeamsYouLead`: I18nKey = "oauthScope:manageTeamsYouLead"
  ...
  object preferences:
    ...
    val `youAreCurrentlyUsingDirectRouting`: I18nKey = "preferences:youAreCurrentlyUsingDirectRouting"
    val `youAreCurrentlyUsingCdnRouting`: I18nKey = "preferences:youAreCurrentlyUsingCdnRouting"
  ...
  object puzzleTheme:
    ...
    val `cornerMateKnightDeliversDescription`: I18nKey = "puzzleTheme:cornerMateKnightDeliversDescription"
    ...
    val `pillsburyMateRookAndBishopDescription`: I18nKey = "puzzleTheme:pillsburyMateRookAndBishopDescription"
    val `morphysMate`: I18nKey = "puzzleTheme:morphysMate"
    val `morphyMateBishopAndRookDescription`: I18nKey = "puzzleTheme:morphyMateBishopAndRookDescription"
    ...
    val `promotePawnToQueenRookOrMinor`: I18nKey = "puzzleTheme:promotePawnToQueenRookOrMinor"
  ...
  object site:
    ...
    val `whiteRanOutOfTime`: I18nKey = "whiteRanOutOfTime"
    val `blackRanOutOfTime`: I18nKey = "blackRanOutOfTime"
    ...
    val `cannotFilterByUnstableRating`: I18nKey = "cannotFilterByUnstableRating"
    ...
    val `positionAsImage`: I18nKey = "positionAsImage"
    ...
    val `moreChessEnginesCreatedByTheLichessCommunity`: I18nKey = "moreChessEnginesCreatedByTheLichessCommunity"
    ...
    val `emailLoginInstructions`: I18nKey = "emailLoginInstructions"
    ...
    val `defeatOnly`: I18nKey = "defeatOnly"
    val `drawAndDefeat`: I18nKey = "drawAndDefeat"
    ...
    val `lichessUpdates`: I18nKey = "lichessUpdates"
    val `contribute`: I18nKey = "contribute"
    val `changelog`: I18nKey = "changelog"
    ...
    val `extraClockTimeForHost`: I18nKey = "extraClockTimeForHost"
    ...
    val `keyShowOrHideCurrentVariation`: I18nKey = "keyShowOrHideCurrentVariation"
    ...
    val `readTheMessage`: I18nKey = "readTheMessage"
  ...
  object streamer:
    ...
    val `whenReadyToBeListedAsStreamer`: I18nKey = "streamer:whenReadyToBeListedAsStreamer"
  ...
  object study:
    ...
    val `pasteToEmbedChapterInForumOrBlog`: I18nKey = "study:pasteToEmbedChapterInForumOrBlog"
    ...
    val `loadGameFromTheWebTitle`: I18nKey = "study:loadGameFromTheWebTitle"
    val `loadGameFromTheWebText`: I18nKey = "study:loadGameFromTheWebText"
    ...
    val `justTheWordAnalysis`: I18nKey = "study:justTheWordAnalysis"
    val `analysisEditor`: I18nKey = "study:analysisEditor"
  ...
  object swiss:
    ...
    val `whyAreSwissTournamentsRestrictedToTeams`: I18nKey = "swiss:whyAreSwissTournamentsRestrictedToTeams"
    ...
    val `canPlayRoundRobinTournaments`: I18nKey = "swiss:canPlayRoundRobinTournaments"
  ...
  object team:
    ...
    val `teamUpdates`: I18nKey = "team:teamUpdates"
    val `subToTeamUpdates`: I18nKey = "team:subToTeamUpdates"
    val `newTeamUpdate`: I18nKey = "team:newTeamUpdate"
  ...
  object ublog:
    ...
    val `blogPostsByFriends`: I18nKey = "ublog:blogPostsByFriends"
    ...
    val `includesPromotedContent`: I18nKey = "ublog:includesPromotedContent"
    val `mandatoryForSponsoredContent`: I18nKey = "ublog:mandatoryForSponsoredContent"
    ...
    val `recentPosts`: I18nKey = "ublog:recentPosts"
    val `imageAlt`: I18nKey = "ublog:imageAlt"
    val `imageCredit`: I18nKey = "ublog:imageCredit"
    val `coverImage`: I18nKey = "ublog:coverImage"
    val `deleteBlog`: I18nKey = "ublog:deleteBlog"
    val `freeImagesComplyWithLicensing`: I18nKey = "ublog:freeImagesComplyWithLicensing"
    ...
    val `noCopyrightedImages`: I18nKey = "ublog:noCopyrightedImages"
