...
object I18nKey:
  ...
  object site:
    ...
    val `gameStart`: I18nKey = "gameStart"
    val `sanTakes`: I18nKey = "sanTakes"
    val `sanCheck`: I18nKey = "sanCheck"
    val `sanCheckmate`: I18nKey = "sanCheckmate"
    val `sanPromotesTo`: I18nKey = "sanPromotesTo"
    val `sanShortCastling`: I18nKey = "sanShortCastling"
    val `sanLongCastling`: I18nKey = "sanLongCastling"
    val `sanDroppedOn`: I18nKey = "sanDroppedOn"
    val `king`: I18nKey = "king"
    val `queen`: I18nKey = "queen"
    val `rook`: I18nKey = "rook"
    val `bishop`: I18nKey = "bishop"
    val `knight`: I18nKey = "knight"
    val `pawn`: I18nKey = "pawn"
