...
object I18nKey:
  ...
  object localAnalysis:
    ...
    val `currentGame`: I18nKey = "localAnalysis:currentGame"
    val `cannotBePublished`: I18nKey = "localAnalysis:cannotBePublished"
    ...
    val `ultra`: I18nKey = "localAnalysis:ultra"
    val `ultraQualityXSeconds`: I18nKey = "localAnalysis:ultraQualityXSeconds"
