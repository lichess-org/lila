...
object I18nKey:
  ...
  object site:
    ...
    val `forumUsageTemporarilyDisabled`: I18nKey = "forumUsageTemporarilyDisabled"
    val `youMayPostAgainX`: I18nKey = "youMayPostAgainX"
    val `complaintsThatCausedThis`: I18nKey = "complaintsThatCausedThis"
    val `whyThumbsDown`: I18nKey = "whyThumbsDown"
    val `disagree`: I18nKey = "disagree"
    val `offTopic`: I18nKey = "offTopic"
    val `spam`: I18nKey = "spam"
    val `offensive`: I18nKey = "offensive"
    val `abusive`: I18nKey = "abusive"
    val `dontAskMeAgain`: I18nKey = "dontAskMeAgain"
    val `ifYourReasonIsNotX`: I18nKey = "ifYourReasonIsNotX"
    val `checkXToOptOut`: I18nKey = "checkXToOptOut"
