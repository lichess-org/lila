...
object I18nKey:
  ...
  object site:
    ...
    val `fideFederations`: I18nKey = "fideFederations"
    val `top10Rating`: I18nKey = "top10Rating"
    val `fidePlayers`: I18nKey = "fidePlayers"
    val `fidePlayerNotFound`: I18nKey = "fidePlayerNotFound"
    val `fideProfile`: I18nKey = "fideProfile"
    val `federation`: I18nKey = "federation"
    val `ageThisYear`: I18nKey = "ageThisYear"
    val `unrated`: I18nKey = "unrated"
    val `recentTournaments`: I18nKey = "recentTournaments"
