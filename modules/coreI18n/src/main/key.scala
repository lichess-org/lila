...
object I18nKey:
  ...
  object study:
    ...
    val `recallNoMovesYet`: I18nKey = "study:recallNoMovesYet"
    val `recallExplanation`: I18nKey = "study:recallExplanation"
    val `recallHowToStoreMoves`: I18nKey = "study:recallHowToStoreMoves"
    val `recallMovesAreHidden`: I18nKey = "study:recallMovesAreHidden"
    val `recallPlayTheMoveYouRemember`: I18nKey = "study:recallPlayTheMoveYouRemember"
    val `recallWaitingForTheReply`: I18nKey = "study:recallWaitingForTheReply"
    val `recallRightMove`: I18nKey = "study:recallRightMove"
    val `recallWrongMove`: I18nKey = "study:recallWrongMove"
    val `recallEndOfTheLine`: I18nKey = "study:recallEndOfTheLine"
    val `showMoves`: I18nKey = "study:showMoves"
    val `hideMoves`: I18nKey = "study:hideMoves"
