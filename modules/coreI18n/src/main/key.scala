...
object I18nKey:
  ...
  object study:
    ...
    val `orPerformAStrongerOne`: I18nKey = "study:orPerformAStrongerOne"
    ...
    val `localAnalysis`: I18nKey = "study:localAnalysis"
    val `serverAnalysis`: I18nKey = "study:serverAnalysis"
    val `currentGame`: I18nKey = "study:currentGame"
    ...
    val `broadcast`: I18nKey = "study:broadcast"
    val `broadcastQuality`: I18nKey = "study:broadcastQuality"
    val `ultra`: I18nKey = "study:ultra"
    val `ultraQualityXSeconds`: I18nKey = "study:ultraQualityXSeconds"
    val `doneInX`: I18nKey = "study:doneInX"
    val `nodes`: I18nKey = "study:nodes"
    val `moveXOfY`: I18nKey = "study:moveXOfY"
    val `xTimesYQuality`: I18nKey = "study:xTimesYQuality"
    val `publish`: I18nKey = "study:publish"
    val `analysisUploadFailed`: I18nKey = "study:analysisUploadFailed"
    val `serverAnalysisInProgress`: I18nKey = "study:serverAnalysisInProgress"
    val `youCanPublish`: I18nKey = "study:youCanPublish"
    val `turnOnRec`: I18nKey = "study:turnOnRec"
    val `whenUpgradingOldChapters`: I18nKey = "study:whenUpgradingOldChapters"
    val `looksLikeASimilar`: I18nKey = "study:looksLikeASimilar"
    val `keepMine`: I18nKey = "study:keepMine"
    val `useTheirs`: I18nKey = "study:useTheirs"
    val `serverAlreadyHas`: I18nKey = "study:serverAlreadyHas"
    val `startingPosition`: I18nKey = "study:startingPosition"
