// Generated with bin/trans-dump at 2016-01-24 09:23:58 UTC
package lila.i18n
...
final class I18nKeys(translator: Translator) {
  ...
  val `current` = new Key("current")
  val `alternativelyYouCan` = new Key("alternativelyYouCan")
  val `revokeAllSessions` = new Key("revokeAllSessions")
  val `thisIsAListOfDevicesThatHaveLoggedIntoYourAccount` = new Key("thisIsAListOfDevicesThatHaveLoggedIntoYourAccount")
  ...
  val `whetherThePlayersOpponentWasAHumanOrAComputer` = new Key("whetherThePlayersOpponentWasAHumanOrAComputer")
  ...
  val `order` = new Key("order")
  val `ifAnalysis` = new Key("ifAnalysis")
  val `whetherComputerAnalysisAvailableOrNot` = new Key("whetherComputerAnalysisAvailableOrNot")
  val `rankIsUpdatedEveryFifteenMinute` = new Key("rankIsUpdatedEveryFifteenMinute")
  val `averageScoreAs` = new Key("averageScoreAs")
  ...
  val `aSquareNameAppearsOnTheBoardAndYouMustClickOnTheCorrectSquare` = new Key("aSquareNameAppearsOnTheBoardAndYouMustClickOnTheCorrectSquare")
  ...
  val `youCanAnalyseAGameMoreEffectivelyIfYouDontNeedToSearchForSquareNames` = new Key("youCanAnalyseAGameMoreEffectivelyIfYouDontNeedToSearchForSquareNames")
  val `itMakesItEasierToTalkToYourChessFriends` = new Key("itMakesItEasierToTalkToYourChessFriends")
  val `mostChessCourcesAndExcercisesUseTheAlgebraicNotationExtensively` = new Key("mostChessCourcesAndExcercisesUseTheAlgebraicNotationExtensively")
  val `chessInsights` = new Key("chessInsights")
  val `kidModeDescription` = new Key("kidModeDescription")
  val `delete` = new Key("delete")
  val `thisUserBlocksYouAndYouCannotAnswer` = new Key("thisUserBlocksYouAndYouCannotAnswer")
