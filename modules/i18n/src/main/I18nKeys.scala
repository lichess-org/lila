...
final class I18nKeys(translator: Translator) {
  ...
  val `ircChannel` = new Key("ircChannel")
  val `no` = new Key("no")
  val `yes` = new Key("yes")
  ...
  val `reopenTheTopic` = new Key("reopenTheTopic")
  val `closeTheTopic` = new Key("closeTheTopic")
  ...
  val `helpTranslateLichess` = new Key("helpTranslateLichess")
  val `sourceCode` = new Key("sourceCode")
  val `developers` = new Key("developers")
  val `contact` = new Key("contact")
  val `thanks` = new Key("thanks")
