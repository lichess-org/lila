...
object I18nKeys {
  ...
  val `theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim` = new Translated("theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim")
  ...
  val `nbConnectedPlayers` = new Translated("nbConnectedPlayers")
  val `gamesBeingPlayedRightNow` = new Translated("gamesBeingPlayedRightNow")
  ...
  val `freeOnlineChessGamePlayChessNowInACleanInterfaceNoRegistrationNoAdsNoPluginRequiredPlayChessWithComputerFriendsOrRandomOpponents` = new Translated("freeOnlineChessGamePlayChessNowInACleanInterfaceNoRegistrationNoAdsNoPluginRequiredPlayChessWithComputerFriendsOrRandomOpponents")
  ...
  val `xToYMinutes` = new Translated("xToYMinutes")
  ...
  val `closeYourAccount` = new Translated("closeYourAccount")
  ...
  val `board` = new Translated("board")
  val `pieces` = new Translated("pieces")
  ...
  val `keyYouCanDrawArrowsCirclesAndScrollToMove` = new Translated("keyYouCanDrawArrowsCirclesAndScrollToMove")
  ...
  val `pressShiftPlusClickOrRightClickToDrawCirclesAndArrowsOnTheBoard` = new Translated("pressShiftPlusClickOrRightClickToDrawCirclesAndArrowsOnTheBoard")
