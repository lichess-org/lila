// Generated with bin/trans-dump at 2016-03-21 13:23:20 UTC
package lila.i18n
...
final class I18nKeys(translator: Translator) {
  ...
  val `clickTheLinkInTheEmailToResetYourPassword` = new Key("clickTheLinkInTheEmailToResetYourPassword")
  ...
  val `itIsAGreatIdeaAndWeWillMakeSureYouStayAnonymous` = new Key("itIsAGreatIdeaAndWeWillMakeSureYouStayAnonymous")
  val `asAnAnonymousUserYouCanPlayTrainAndUseAllLichessFeatures` = new Key("asAnAnonymousUserYouCanPlayTrainAndUseAllLichessFeatures")
