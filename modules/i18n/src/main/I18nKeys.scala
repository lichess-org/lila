...
object I18nKeys:
  ...
  val `textualRepresentations` = I18nKey("textualRepresentations")
  val `gameInfo` = I18nKey("gameInfo")
  val `currentPosition` = I18nKey("currentPosition")
  val `board` = I18nKey("board")
  val `moveNotation` = I18nKey("moveNotation")
  val `pieceStyle` = I18nKey("pieceStyle")
  val `piecePrefixStyle` = I18nKey("piecePrefixStyle")
  val `showPosition` = I18nKey("showPosition")
  val `boardLayout` = I18nKey("boardLayout")
  val `arrowKeys` = I18nKey("arrowKeys")
  val `playBestComputerMove` = I18nKey("playBestComputerMove")
  val `announceComputerEvaluation` = I18nKey("announceComputerEvaluation")
  ...
  object puzzle:
    ...
    val `puzzleInfo` = I18nKey("puzzle:puzzleInfo")
    ...
    val `pieces` = I18nKey("puzzle:pieces")
    val `lastMove` = I18nKey("puzzle:lastMove")
    val `moveForm` = I18nKey("puzzle:moveForm")
    val `actions` = I18nKey("puzzle:actions")
    val `board` = I18nKey("puzzle:board")
    val `boardSettings` = I18nKey("puzzle:boardSettings")
    val `puzzleSettings` = I18nKey("puzzle:puzzleSettings")
    val `commands` = I18nKey("puzzle:commands")
    val `boardModeCommands` = I18nKey("puzzle:boardModeCommands")
    val `promotion` = I18nKey("puzzle:promotion")
    ...
    val `puzzleStatus` = I18nKey("puzzle:puzzleStatus")
