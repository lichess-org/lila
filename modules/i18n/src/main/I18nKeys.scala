...
val `loginToChat` = new Translated("loginToChat")
val `youHaveBeenTimedOut` = new Translated("youHaveBeenTimedOut")
...
val `winRate` = new Translated("winRate")
val `berserkRate` = new Translated("berserkRate")
val `performance` = new Translated("performance")
val `tournamentComplete` = new Translated("tournamentComplete")
val `movesPlayed` = new Translated("movesPlayed")
val `whiteWins` = new Translated("whiteWins")
val `blackWins` = new Translated("blackWins")
val `draws` = new Translated("draws")
val `nextXTournament` = new Translated("nextXTournament")
val `viewMoreTournaments` = new Translated("viewMoreTournaments")
val `averageOpponent` = new Translated("averageOpponent")
...
val `kidModeExplanation` = new Translated("kidModeExplanation")
val `inKidModeTheLichessLogoGetsIconX` = new Translated("inKidModeTheLichessLogoGetsIconX")
val `enableKidMode` = new Translated("enableKidMode")
val `disableKidMode` = new Translated("disableKidMode")
val `security` = new Translated("security")
val `thisIsAListOfDevicesThatHaveLoggedIntoYourAccount` = new Translated("thisIsAListOfDevicesThatHaveLoggedIntoYourAccount")
val `alternativelyYouCanX` = new Translated("alternativelyYouCanX")
val `revokeAllSessions` = new Translated("revokeAllSessions")
...
val `nbGamesPlayed` = new Translated("nbGamesPlayed")
val `nbRated` = new Translated("nbRated")
