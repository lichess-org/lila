...
object I18nKeys {
  ...
  object tourArrangements {
    ...
    val `startGame` = new I18nKey("tourArrangements:startGame")
    val `goToGame` = new I18nKey("tourArrangements:goToGame")
    val `waitingForOther` = new I18nKey("tourArrangements:waitingForOther")
    val `proposeTime` = new I18nKey("tourArrangements:proposeTime")
    val `cancelScheduled` = new I18nKey("tourArrangements:cancelScheduled")
    ...
    val `playingRightNow` = new I18nKey("tourArrangements:playingRightNow")
    val `latestGames` = new I18nKey("tourArrangements:latestGames")
    val `gameWillNotStart` = new I18nKey("tourArrangements:gameWillNotStart")
    val `organized` = new I18nKey("tourArrangements:organized")
    val `accepted` = new I18nKey("tourArrangements:accepted")
    val `removed` = new I18nKey("tourArrangements:removed")
    val `proposed` = new I18nKey("tourArrangements:proposed")
    val `ready` = new I18nKey("tourArrangements:ready")
    val `notReady` = new I18nKey("tourArrangements:notReady")
    val `starts` = new I18nKey("tourArrangements:starts")
}
