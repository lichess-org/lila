...
val `welcomeToLichess` = new I18nKey("welcomeToLichess")
val `thisIsYourProfilePage` = new I18nKey("thisIsYourProfilePage")
val `kidModeIsEnabled` = new I18nKey("kidModeIsEnabled")
val `newPlayerWhatNow` = new I18nKey("newPlayerWhatNow")
val `learnChessRules` = new I18nKey("learnChessRules")
val `improveWithChessTactics` = new I18nKey("improveWithChessTactics")
val `playTheAI` = new I18nKey("playTheAI")
val `playOpponentsAroundWorld` = new I18nKey("playOpponentsAroundWorld")
val `followYourFriends` = new I18nKey("followYourFriends")
val `playInTourns` = new I18nKey("playInTourns")
val `newPlayerLearnFrom` = new I18nKey("newPlayerLearnFrom")
val `studies` = new I18nKey("studies")
val `videos` = new I18nKey("videos")
val `configureLichessToYourLiking` = new I18nKey("configureLichessToYourLiking")
val `newPlayerExploreSite` = new I18nKey("newPlayerExploreSite")
val `newPlayerKidMode` = new I18nKey("newPlayerKidMode")
val `newPlayerImproveProfile` = new I18nKey("newPlayerImproveProfile")
val `improveIt` = new I18nKey("improveIt")
