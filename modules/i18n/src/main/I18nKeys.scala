...
object I18nKeys:
  ...
  val `highlights` = I18nKey("highlights")
  val `ads` = I18nKey("ads")
  val `accessability` = I18nKey("accessability")
  val `blindMode` = I18nKey("blindMode")
  val `disable` = I18nKey("disable")
  ...
  object nvui:
    ...
    val `puzzleInfo` = I18nKey("nvui:puzzleInfo")
    val `pieces` = I18nKey("nvui:pieces")
    val `lastMove` = I18nKey("nvui:lastMove")
    val `moveForm` = I18nKey("nvui:moveForm")
    val `actions` = I18nKey("nvui:actions")
    val `boardSettings` = I18nKey("nvui:boardSettings")
    val `puzzleSettings` = I18nKey("nvui:puzzleSettings")
    val `commands` = I18nKey("nvui:commands")
    val `boardModeCommands` = I18nKey("nvui:boardModeCommands")
    val `promotion` = I18nKey("nvui:promotion")
    val `puzzleStatus` = I18nKey("nvui:puzzleStatus")
