...
object I18nKeys:
  ...
  object features:
    ...
    val `playAndCreateX` = I18nKey("features:playAndCreateX")
    val `tournaments` = I18nKey("features:tournaments")
    val `simultaneousExhibitions` = I18nKey("features:simultaneousExhibitions")
    ...
    val `boardEditorAndAnalysisBoardWithSf14` = I18nKey("features:boardEditorAndAnalysisBoardWithSf14")
    ...
    val `xGlobalOpeningExplorer` = I18nKey("features:xGlobalOpeningExplorer")
    val `globalOpeningExplorer` = I18nKey("features:globalOpeningExplorer")
    ...
    val `availableInNbLanguages` = I18nKey("features:availableInNbLanguages")
