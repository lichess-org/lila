...
val `forceVariation` = new Translated("forceVariation", Site)
...
val `friends` = new Translated("friends", Site)
val `discussions` = new Translated("discussions", Site)
val `today` = new Translated("today", Site)
val `yesterday` = new Translated("yesterday", Site)
...
val `whiteCheckmatesInOneMove` = new Translated("whiteCheckmatesInOneMove", Site)
val `blackCheckmatesInOneMove` = new Translated("blackCheckmatesInOneMove", Site)
...
val `agreementAssistance` = new Translated("agreementAssistance", Site)
val `agreementNice` = new Translated("agreementNice", Site)
...
val `logInToLichess` = new Translated("logInToLichess", Emails)
...
val `hosted` = new Translated("hosted", Activity)
...
val `pgnTags` = new Translated("pgnTags", Study)
...
val `loadAGameFromPgn` = new Translated("loadAGameFromPgn", Study)
...
val `closedByX` = new Translated("closedByX", Clas)
...
val `closeAccount` = new Translated("closeAccount", Settings)
...
val `changedMindDoNotCloseAccount` = new Translated("changedMindDoNotCloseAccount", Settings)
val `closeAccountExplanation` = new Translated("closeAccountExplanation", Settings)
val `thisAccountIsClosed` = new Translated("thisAccountIsClosed", Settings)
}
...
val `boardHighlights` = new Translated("boardHighlights", Preferences)
val `pieceDestinations` = new Translated("pieceDestinations", Preferences)
val `boardCoordinates` = new Translated("boardCoordinates", Preferences)
val `moveListWhilePlaying` = new Translated("moveListWhilePlaying", Preferences)
val `pgnPieceNotation` = new Translated("pgnPieceNotation", Preferences)
val `chessPieceSymbol` = new Translated("chessPieceSymbol", Preferences)
val `pgnLetter` = new Translated("pgnLetter", Preferences)
val `zenMode` = new Translated("zenMode", Preferences)
val `displayBoardResizeHandle` = new Translated("displayBoardResizeHandle", Preferences)
val `onlyOnInitialPosition` = new Translated("onlyOnInitialPosition", Preferences)
val `blindfoldChess` = new Translated("blindfoldChess", Preferences)
val `chessClock` = new Translated("chessClock", Preferences)
val `tenthsOfSeconds` = new Translated("tenthsOfSeconds", Preferences)
val `whenTimeRemainingLessThanTenSeconds` = new Translated("whenTimeRemainingLessThanTenSeconds", Preferences)
val `horizontalGreenProgressBars` = new Translated("horizontalGreenProgressBars", Preferences)
val `soundWhenTimeGetsCritical` = new Translated("soundWhenTimeGetsCritical", Preferences)
val `giveMoreTime` = new Translated("giveMoreTime", Preferences)
val `gameBehavior` = new Translated("gameBehavior", Preferences)
val `howDoYouMovePieces` = new Translated("howDoYouMovePieces", Preferences)
val `clickTwoSquares` = new Translated("clickTwoSquares", Preferences)
val `dragPiece` = new Translated("dragPiece", Preferences)
val `bothClicksAndDrag` = new Translated("bothClicksAndDrag", Preferences)
val `premovesPlayingDuringOpponentTurn` = new Translated("premovesPlayingDuringOpponentTurn", Preferences)
val `takebacksWithOpponentApproval` = new Translated("takebacksWithOpponentApproval", Preferences)
val `inCasualGamesOnly` = new Translated("inCasualGamesOnly", Preferences)
val `promoteToQueenAutomatically` = new Translated("promoteToQueenAutomatically", Preferences)
val `whenPremoving` = new Translated("whenPremoving", Preferences)
val `claimDrawOnThreefoldRepetitionAutomatically` = new Translated("claimDrawOnThreefoldRepetitionAutomatically", Preferences)
val `whenTimeRemainingLessThanThirtySeconds` = new Translated("whenTimeRemainingLessThanThirtySeconds", Preferences)
val `moveConfirmation` = new Translated("moveConfirmation", Preferences)
val `inCorrespondenceGames` = new Translated("inCorrespondenceGames", Preferences)
val `correspondenceAndUnlimited` = new Translated("correspondenceAndUnlimited", Preferences)
val `confirmResignationAndDrawOffers` = new Translated("confirmResignationAndDrawOffers", Preferences)
val `castleByMovingTheKingTwoSquaresOrOntoTheRook` = new Translated("castleByMovingTheKingTwoSquaresOrOntoTheRook", Preferences)
