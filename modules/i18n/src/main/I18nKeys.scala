...
object I18nKeys:
  ...
  object nvui:
    val `textualRepresentations` = I18nKey("nvui:textualRepresentations")
    val `gameInfo` = I18nKey("nvui:gameInfo")
    val `currentPosition` = I18nKey("nvui:currentPosition")
    val `board` = I18nKey("nvui:board")
    val `moveNotation` = I18nKey("nvui:moveNotation")
    val `pieceStyle` = I18nKey("nvui:pieceStyle")
    val `piecePrefixStyle` = I18nKey("nvui:piecePrefixStyle")
    val `showPosition` = I18nKey("nvui:showPosition")
    val `boardLayout` = I18nKey("nvui:boardLayout")
    val `arrowKeys` = I18nKey("nvui:arrowKeys")
    val `playBestComputerMove` = I18nKey("nvui:playBestComputerMove")
