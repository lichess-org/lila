...
val `viewInFullSize` = new I18nKey("viewInFullSize")
  ...
  val `latestForumPostsNewBy` = new I18nKey(key = "latestForumPostsNewBy")
  val `latestForumPostsSaid` = new I18nKey(key = "latestForumPostsSaid")
...
val `resultsPerPage` = new I18nKey( key = "resultsPerPage")
...
val `postMaxPerPage` = new I18nKey( key="preferences:postMaxPerPage" )
val `topicMaxPerPage` = new I18nKey( key="preferences:topicMaxPerPage" )
