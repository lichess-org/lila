...
val `thisPlayerUsesChessComputerAssistance` = new I18nKey("thisPlayerUsesChessComputerAssistance")
...
val `feature` = new I18nKey("feature")
val `unfeature` = new I18nKey("unfeature")
val `reopenTopic` = new I18nKey("reopenTopic")
val `closeTopic` = new I18nKey("closeTopic")
val `sticky` = new I18nKey("sticky")
val `unsticky` = new I18nKey("unsticky")
val `createAsAMod` = new I18nKey("createAsAMod")
val `replyAsAMod` = new I18nKey("replyAsAMod")
