...
val `lichessIs` = new I18nKey("patron:lichessIs")
val `registeredWithBenevity` = new I18nKey("patron:registeredWithBenevity")
...
val `watchIMRosenCheckmateEnPassant` = new I18nKey("faq:watchIMRosenCheckmateEnPassant")
val `checkmateEnPassant` = new I18nKey("faq:checkmateEnPassant")
