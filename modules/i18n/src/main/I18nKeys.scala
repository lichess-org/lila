...
val `restrictedToTeamsANotForOnline` = new I18nKey("swiss:restrictedToTeamsANotForOnline")
val `restrictedToTeamsABetterMet` = new I18nKey("swiss:restrictedToTeamsABetterMet")
...
val `lateJoinAYes` = new I18nKey("swiss:lateJoinAYes")
val `lateJoinASingleBye` = new I18nKey("swiss:lateJoinASingleBye")
...
val `roundRobinAWontWork` = new I18nKey("swiss:roundRobinAWontWork")
val `roundRobinANoBecause` = new I18nKey("swiss:roundRobinANoBecause")
val `roundRobinATheClosestPossible` = new I18nKey("swiss:roundRobinATheClosestPossible")
