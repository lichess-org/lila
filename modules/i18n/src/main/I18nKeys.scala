...
val `conditionsOfEntry` = new Translated("conditionsOfEntry", Site)
val `leaveConditionsEmpty` = new Translated("leaveConditionsEmpty", Site)
val `fewerPlayers` = new Translated("fewerPlayers", Site)
val `showConditions` = new Translated("showConditions", Site)
