// Generated with bin/trans-dump at 2016-02-01 15:54:55 UTC
package lila.i18n
...
final class I18nKeys(translator: Translator) {
  ...
  val `revokeAllSessions` = new Key("revokeAllSessions")
  ...
  val `TheAverageRatingOfBothPlayers` = new Key("TheAverageRatingOfBothPlayers")
