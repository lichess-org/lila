...
val `searchUsername` = new Translated("searchUsername", Site)
val `gameUrlOrId` = new Translated("gameUrlOrId", Site)
val `gameUrl` = new Translated("gameUrl", Site)
...
val `customGameCollection` = new Translated("customGameCollection", Site)
...
val `study` = new Translated("study", Site)
...
val `withTarget` = new Translated("withTarget", Site)
...
val `simulFinished` = new Translated("simulFinished", Site)
...
val `solvedNbFrisianPuzzles` = new Translated("solvedNbFrisianPuzzles", Activity)
