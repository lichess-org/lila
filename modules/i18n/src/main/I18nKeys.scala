...
val `chessInsights` = new I18nKey("activity:chessInsights")
val `analyticsFromGames` = new I18nKey("activity:analyticsFromGames")
val `insightsOverNbRatedGames` = new I18nKey("activity:insightsOverNbRatedGames")
val `acplByDate` = new I18nKey("activity:acplByDate")
val `blursByDate` = new I18nKey("activity:blursByDate")
val `acplByBlur` = new I18nKey("activity:acplByBlur")
val `blursByResult` = new I18nKey("activity:blursByResult")
val `acplByTimeVariance` = new I18nKey("activity:acplByTimeVariance")
val `blursByTimeVariance` = new I18nKey("activity:blursByTimeVariance")
val `timeVarianceByDate` = new I18nKey("activity:timeVarianceByDate")
val `doIGainMoreRatingPointsAgainstWeakerOrStrongerOpponents` = new I18nKey("activity:doIGainMoreRatingPointsAgainstWeakerOrStrongerOpponents")
val `howQuicklyDoIMoveEachPieceInBulletAndBlitzGames` = new I18nKey("activity:howQuicklyDoIMoveEachPieceInBulletAndBlitzGames")
val `whatIsTheWinRateOfMyFavouriteOpeningsAsWhite` = new I18nKey("activity:whatIsTheWinRateOfMyFavouriteOpeningsAsWhite")
val `howOftenDoIPunishBlundersMadeByMyOpponentDuringEachGamePhase` = new I18nKey("activity:howOftenDoIPunishBlundersMadeByMyOpponentDuringEachGamePhase")
val `doIGainRatingWhenIDontCastleKingside` = new I18nKey("activity:doIGainRatingWhenIDontCastleKingside")
val `whenITradeQueensHowDoGamesEnd` = new I18nKey("whenITradeQueensHowDoGamesEnd")
val `whatIsTheAverageRatingOfMyOpponentsAcrossEachVariant` = new I18nKey("activity:whatIsTheAverageRatingOfMyOpponentAcrossEachVariant")
val `howDoIMoveEachPieceInTheOpening` = new I18nKey("activity:howDoIMoveEachPieceInTheOpening")
}
