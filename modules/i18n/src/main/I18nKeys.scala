...
val `backRankThreat` = new I18nKey("puzzleTheme:backRankThreat")
val `backRankThreatDescription` = new I18nKey("puzzleTheme:backRankThreatDescription")
...
val `matingNet` = new I18nKey("puzzleTheme:matingNet")
val `matingNetDescription` = new I18nKey("puzzleTheme:matingNetDescription")
