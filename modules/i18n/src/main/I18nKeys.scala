...
val `name` = new Translated("name", Study)
...
val `none` = new Translated("none", Study)
val `rightUnderTheBoard` = new Translated("rightUnderTheBoard", Study)
val `white` = new Translated("white", Study)
val `black` = new Translated("black", Study)
...
val `variant` = new Translated("variant", Study)
