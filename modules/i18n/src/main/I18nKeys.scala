...
val `newPieces` = new I18nKey("newPieces")
val `criticism` = new I18nKey("criticism")
...
val `previouslyOnNewChessTV` = new I18nKey("previouslyOnNewChessTV")
...
val `asFreeAsNewChess` = new I18nKey("asFreeAsNewChess")
...
val `getAFreeNewChessAccount` = new I18nKey("learn:getAFreeNewChessAccount")
...
val `applyToBeNewChessTeacher` = new I18nKey("class:applyToBeNewChessTeacher")
...
val `addNewChessUsernames` = new I18nKey("class:addNewChessUsernames")
...
val `inviteANewChessAccount` = new I18nKey("class:inviteANewChessAccount")
...
val `createANewNewChessAccount` = new I18nKey("class:createANewNewChessAccount")
...
val `whyIsNewChessCalledLichess` = new I18nKey("faq:whyIsNewChessCalledLichess")
...
val `yesNewChessInspiredOtherOpenSourceWebsites` = new I18nKey("faq:yesNewChessInspiredOtherOpenSourceWebsites")
...
object lag {
val `isNewChessLagging` = new I18nKey("lag:isNewChessLagging")
...
val `networkBetweenNewChessAndYou` = new I18nKey("lag:networkBetweenNewChessAndYou")
val `networkBetweenNewChessAndYouExplanation` = new I18nKey("lag:networkBetweenNewChessAndYouExplanation")
