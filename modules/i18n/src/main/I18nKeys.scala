...
val `canYouTellMeMyEmailIfIForgetIt` = new I18nKey("faq:canYouTellMeMyEmailIfIForgetIt")
val `supportCanNotTellYouYourEmail` = new I18nKey("faq:supportCanNotTellYouYourEmail")
val `thePasswordResetPage` = new I18nKey("faq:thePasswordResetPage")
