...
val `youAreBetterThanPercentOfX` = new I18nKey("youAreBetterThanPercentOfX")
val `userIsBetterThanPercentOfX` = new I18nKey("userIsBetterThanPercentOfX")
...
val `perfTypePlayers` = new I18nKey("perfTypePlayers")
