...
val `areThereWebsitesBasedOnLishogi` = new I18nKey("faq:areThereWebsitesBasedOnLishogi")
val `yesLishogiInspiredOtherOpenSourceWebsites` = new I18nKey("faq:yesLishogiInspiredOtherOpenSourceWebsites")
...
val `lishogiFollowFIDErules` = new I18nKey("faq:lishogiFollowFIDErules")
...
val `lishogiRecognizeAllOTBtitles` = new I18nKey("faq:lishogiRecognizeAllOTBtitles")
