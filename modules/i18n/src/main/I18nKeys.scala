// Generated with bin/trans-dump at 2016-01-29 11:50:29 UTC
package lila.i18n
...
final class I18nKeys(translator: Translator) {
  ...
  val `monthlyPerfTypeRatingDistribution` = new Key("monthlyPerfTypeRatingDistribution")
  val `nbPerfTypePlayersThisMonth` = new Key("nbPerfTypePlayersThisMonth")
  ...
  val `weHaveSentYouAnEmailToActivateYourAccount` = new Key("weHaveSentYouAnEmailToActivateYourAccount")
  ...
  val `weHaveSentYouAnEmailToResetYourPassword` = new Key("weHaveSentYouAnEmailToResetYourPassword")
  val `byRegisteringYouAgreeToBeBoundByOur` = new Key("byRegisteringYouAgreeToBeBoundByOur")
  val `cannotLogInFromYourIP` = new Key("cannotLogInFromYourIP")
  val `weHaveDetectedThatYouAreUsingTor` = new Key("weHaveDetectedThatYouAreUsingTor")
  val `weWillMakeSureYouStayAnonymousOnLichess` = new Key("weWillMakeSureYouStayAnonymousOnLichess")
  val `asAnonymousUserYouCanUseAllLichessFeatures` = new Key("asAnonymousUserYouCanUseAllLichessFeatures")
  val `security` = new Key("security")
  val `currentDevice` = new Key("currentDevice")
  val `alternativelyYouCan` = new Key("alternativelyYouCan")
  val `revokeAllSesisons` = new Key("revokeAllSesisons")
  ...
  val `kidModeDescription` = new Key("kidModeDescription")
  ...
  val `somethingWentWrongOnThisPage` = new Key("somethingWentWrongOnThisPage")
  val `worldMap` = new Key("worldMap")
  val `pageNotFound` = new Key("pageNotFound")
  val `knowingTheChessboardCoordinatesIsAVeryImportantChessSkill` = new Key("knowingTheChessboardCoordinatesIsAVeryImportantChessSkill")
  val `mostChessCoursesAndExercisesUseTheAlgebraicNotationExtensively` = new Key("mostChessCoursesAndExercisesUseTheAlgebraicNotationExtensively")
  val `itMakesItEasierToTalkToYourChessFriends` = new Key("itMakesItEasierToTalkToYourChessFriends")
  val `youCanAnalyseAGameMoreEffectively` = new Key("youCanAnalyseAGameMoreEffectively")
  val `aSquareNameAppearsOnTheBoard` = new Key("aSquareNameAppearsOnTheBoard")
  val `youHaveThirtySecondsToRecognizeAsManySquaresAsPossible` = new Key("youHaveThirtySecondsToRecognizeAsManySquaresAsPossible")
  val `computerAnalysisAvailable` = new Key("computerAnalysisAvailable")
  val `youCannotStartANewGameUntilThisOneIsFinished` = new Key("youCannotStartANewGameUntilThisOneIsFinished")
  val `ohNo` = new Key("ohNo")
  val `temporarilyBannedFromLobbyGames` = new Key("temporarilyBannedFromLobbyGames")
  val `why` = new Key("why")
  val `next` = new Key("next")
  val `delete` = new Key("delete")
  val `thisUserBlocksYouCannotAnswer` = new Key("thisUserBlocksYouCannotAnswer")
  val `playChessEverywhere` = new Key("playChessEverywhere")
  val `lichessOnTheGo` = new Key("lichessOnTheGo")
  val `challengeOnlinePlayers` = new Key("challengeOnlinePlayers")
  val `playStockfishLevelOneToEight` = new Key("playStockfishLevelOneToEight")
  val `loginOrPlayAsAnonymous` = new Key("loginOrPlayAsAnonymous")
  val `availableInEightyLanguages` = new Key("availableInEightyLanguages")
  val `asFreeAsLichess` = new Key("asFreeAsLichess")
  val `builtForTheLoveOfChessNotMoney` = new Key("builtForTheLoveOfChessNotMoney")
  val `zeroAdvertisment` = new Key("zeroAdvertisment")
  val `fullFeatured` = new Key("fullFeatured")
  val `realTimeWithIncrement` = new Key("realTimeWithIncrement")
  val `correspondenceGames` = new Key("correspondenceGames")
  val `overTheBoardOffline` = new Key("overTheBoardOffline")
  val `vsComputerOffline` = new Key("vsComputerOffline")
  val `moreOfTheFeaturesYouLoveWillBeAddedSoon` = new Key("moreOfTheFeaturesYouLoveWillBeAddedSoon")
  val `lookOutForUpdatesRegularly` = new Key("lookOutForUpdatesRegularly")
  val `theSiteIsBeingUpdatedBraceForImpact` = new Key("theSiteIsBeingUpdatedBraceForImpact")
  val `theSiteWillBeUpdatedInAFewMinutes` = new Key("theSiteWillBeUpdatedInAFewMinutes")
  val `sorryWeDoNotHaveAnyMorePuzzlesForYou` = new Key("sorryWeDoNotHaveAnyMorePuzzlesForYou")
  val `youPlayedQuiteALotOfThem` = new Key("youPlayedQuiteALotOfThem")
  val `returnToLichessHomepage` = new Key("returnToLichessHomepage")
  val `inTheMeanTimeYouCanBlockThisUser` = new Key("inTheMeanTimeYouCanBlockThisUser")
  val `theModeratorsWillRiviewItVerySoonAndTakeAction` = new Key("theModeratorsWillRiviewItVerySoonAndTakeAction")
  val `theNameOfThePlayerYouWishToSearch` = new Key("theNameOfThePlayerYouWishToSearch")
  val `theAverageRatingOfTheBothPlayers` = new Key("theAverageRatingOfTheBothPlayers")
  val `from` = new Key("from")
  val `to` = new Key("to")
  val `whetherThePlayerOpponentWasAHumanOrAComputer` = new Key("whetherThePlayerOpponentWasAHumanOrAComputer")
  val `stockfishLevel` = new Key("stockfishLevel")
  val `source` = new Key("source")
  val `numberOfTurns` = new Key("numberOfTurns")
  val `result` = new Key("result")
  val `winnerColor` = new Key("winnerColor")
  val `date` = new Key("date")
  val `sort` = new Key("sort")
  val `isAnalysis` = new Key("isAnalysis")
  val `whetherComputerAnalysisAvailableOrNot` = new Key("whetherComputerAnalysisAvailableOrNot")
  val `gamesFound` = new Key("gamesFound")
  val `permalink` = new Key("permalink")
  val `downloadPGN` = new Key("downloadPGN")
  val `noGameFound` = new Key("noGameFound")
  val `searchReady` = new Key("searchReady")
  val `opponentName` = new Key("opponentName")
  val `challengeDeclined` = new Key("challengeDeclined")
  val `hostColorForEachGame` = new Key("hostColorForEachGame")
  val `embedLichessOnYourSite` = new Key("embedLichessOnYourSite")
  val `doYouHaveAWebsiteAndWantToAddAPlayableChessSection` = new Key("doYouHaveAWebsiteAndWantToAddAPlayableChessSection")
  val `addTheFollowingLineToYourSiteHTML` = new Key("addTheFollowingLineToYourSiteHTML")
  val `embedTheLichessTVInYourSite` = new Key("embedTheLichessTVInYourSite")
  val `justAddTheFollowingLineToYourSiteHTML` = new Key("justAddTheFollowingLineToYourSiteHTML")
  val `embedTheDailyPuzzleInYourSite` = new Key("embedTheDailyPuzzleInYourSite")
  val `theTextIsAutomaticallyTranslatedToYourVisitorLanguage` = new Key("theTextIsAutomaticallyTranslatedToYourVisitorLanguage")
  val `lichessWidgets` = new Key("lichessWidgets")
  val `letYourWebsiteVisitorsKnowThatYouArePlayingOnLichess` = new Key("letYourWebsiteVisitorsKnowThatYouArePlayingOnLichess")
  val `seeMoreExamplesAndInstallationInstructions` = new Key("seeMoreExamplesAndInstallationInstructions")
  val `sorryEnginesAreNotAllowedInThisArea` = new Key("sorryEnginesAreNotAllowedInThisArea")
  val `lichessVariants` = new Key("lichessVariants")
  val `lichessWorldMap` = new Key("lichessWorldMap")
  val `mapOfLiveGames` = new Key("mapOfLiveGames")
  val `orangeGameInProgress` = new Key("orangeGameInProgress")
  val `whiteGameCreations` = new Key("whiteGameCreations")
  val `ratings` = new Key("ratings")
  val `youHaveAlreadyCreatedATeamThisWeek` = new Key("youHaveAlreadyCreatedATeamThisWeek")
  val `kickSomeoneOutOfTheTeam` = new Key("kickSomeoneOutOfTheTeam")
  val `whoDoYouWantToKickOutOfTheTeam` = new Key("whoDoYouWantToKickOutOfTheTeam")
  val `yourJoinRequestWillBeReviewedByTheTeamLeader` = new Key("yourJoinRequestWillBeReviewedByTheTeamLeader")
  val `team` = new Key("team")
  val `deletesTheTeamAndItsMemberships` = new Key("deletesTheTeamAndItsMemberships")
  val `yourJoinRequestIsBeingReviewedByTheTeamLeader` = new Key("yourJoinRequestIsBeingReviewedByTheTeamLeader")
  val `thisIsAPrivateTournament` = new Key("thisIsAPrivateTournament")
  val `shareThisURLToLetPeopleJoinIt` = new Key("shareThisURLToLetPeopleJoinIt")
  val `isItRated` = new Key("isItRated")
  val `thisTournamentIsRatedAndWillAffectYourRating` = new Key("thisTournamentIsRatedAndWillAffectYourRating")
  val `thisTournamentIsNotRatedAndWillNotAffectYourRating` = new Key("thisTournamentIsNotRatedAndWillNotAffectYourRating")
  val `someTournamentsAreRatedAndWillAffectYourRating` = new Key("someTournamentsAreRatedAndWillAffectYourRating")
  val `howAreScoresCalculated` = new Key("howAreScoresCalculated")
  val `aWinHasABaseOfTwoPointsADrawOnePointAndALossWorthsNothing` = new Key("aWinHasABaseOfTwoPointsADrawOnePointAndALossWorthsNothing")
  val `ifYouWinTwoGamesConsecutivelyYouWillStartADoublePointStreak` = new Key("ifYouWinTwoGamesConsecutivelyYouWillStartADoublePointStreak")
  val `forExampleTwoWinsFollowedByADrawWillBeWorthSixPoints` = new Key("forExampleTwoWinsFollowedByADrawWillBeWorthSixPoints")
  val `howScoresAreCalculatedDependsOnTheSystemUsedForTheTournament` = new Key("howScoresAreCalculatedDependsOnTheSystemUsedForTheTournament")
  val `inAllCasesAWinIsWorthTwiceAsMuchAsDrawAnsLossIsWorthNothing` = new Key("inAllCasesAWinIsWorthTwiceAsMuchAsDrawAnsLossIsWorthNothing")
  val `inTheArenaSystemWinningGamesIsASuccessionYieldsAnAdditionalBonus` = new Key("inTheArenaSystemWinningGamesIsASuccessionYieldsAnAdditionalBonus")
  val `howIsTheWinnerDecided` = new Key("howIsTheWinnerDecided")
  val `thePlayerWithTheMostPointsAtTheConclusionWillBeAnnouncedWinner` = new Key("thePlayerWithTheMostPointsAtTheConclusionWillBeAnnouncedWinner")
  val `howDoesThePairingWorks` = new Key("howDoesThePairingWorks")
  val `atTheBeginningofTheTournamentPlayersArePairedBaseOnTheirRating` = new Key("atTheBeginningofTheTournamentPlayersArePairedBaseOnTheirRating")
  val `asSoonAsYouFinishAGameReturnToTheTournamentLobby` = new Key("asSoonAsYouFinishAGameReturnToTheTournamentLobby")
  val `thisEnsuresMinimumWaitTime` = new Key("thisEnsuresMinimumWaitTime")
  val `playFastAndReturnToTheLobbyToPlayMoreGamesAndWinMorePoints` = new Key("playFastAndReturnToTheLobbyToPlayMoreGamesAndWinMorePoints")
  val `thePairingMechanismDependsOnTheSystemUsedForTheTournament` = new Key("thePairingMechanismDependsOnTheSystemUsedForTheTournament")
  val `inTheArenaSystemNewPairingsAreGeneratedAsSoonAsEnough` = new Key("inTheArenaSystemNewPairingsAreGeneratedAsSoonAsEnough")
  val `howDoesItEnd` = new Key("howDoesItEnd")
  val `theTournamentHasACountdownClock` = new Key("theTournamentHasACountdownClock")
  val `whenItReachesZeroTheTournamentRankingsAreFrozen` = new Key("whenItReachesZeroTheTournamentRankingsAreFrozen")
  val `gamesInProgressMustBeFinishedHoweverTheyDoNotCountForTheTournament` = new Key("gamesInProgressMustBeFinishedHoweverTheyDoNotCountForTheTournament")
  val `otherImportantRules` = new Key("otherImportantRules")
  val `youAreRequiredToMakeYourFirstMoveWithinTwentySecondsOfYourTurn` = new Key("youAreRequiredToMakeYourFirstMoveWithinTwentySecondsOfYourTurn")
  val `failingToMakeAMoveInThisTimeWillForfeitTheGameToYourOpponent` = new Key("failingToMakeAMoveInThisTimeWillForfeitTheGameToYourOpponent")
  val `drawingTheGameWithinTheFirstTenMovesOfPlayWillEarnNeitherPlayerAnyPoints` = new Key("drawingTheGameWithinTheFirstTenMovesOfPlayWillEarnNeitherPlayerAnyPoints")
  val `about` = new Key("about")
  val `terminateNow` = new Key("terminateNow")
  val `terminatesTheTournamentImmediately` = new Key("terminatesTheTournamentImmediately")
  val `lichessGames` = new Key("lichessGames")
  val `noneFound` = new Key("noneFound")
  val `freeChessVideoLibrary` = new Key("freeChessVideoLibrary")
  val `allVideosAreFreeToEveryone` = new Key("allVideosAreFreeToEveryone")
  val `clickOneOrManyTagsOnTheLeftToFilter` = new Key("clickOneOrManyTagsOnTheLeftToFilter")
  val `noVideoForTheseTags` = new Key("noVideoForTheseTags")
  val `thatIsAllWeGotForTheseTags` = new Key("thatIsAllWeGotForTheseTags")
  val `clearSearch` = new Key("clearSearch")
  val `viewMoreTags` = new Key("viewMoreTags")
  val `videoNotFound` = new Key("videoNotFound")
  val `returnToTheVideoLibrary` = new Key("returnToTheVideoLibrary")
  val `noVideoForThisSearch` = new Key("noVideoForThisSearch")
  val `thatIsAllWeGotForThisSearch` = new Key("thatIsAllWeGotForThisSearch")

  def keys = List(`playWithAFriend`, `playWithTheMachine`, `toInviteSomeoneToPlayGiveThisUrl`, `gameOver`, `waitingForOpponent`, `waiting`, `yourTurn`, `aiNameLevelAiLevel`, `level`, `toggleTheChat`, `toggleSound`, `chat`, `resign`, `checkmate`, `stalemate`, `white`, `black`, `randomColor`, `createAGame`, `whiteIsVictorious`, `blackIsVictorious`, `kingInTheCenter`, `threeChecks`, `raceFinished`, `variantEnding`, `playWithTheSameOpponentAgain`, `newOpponent`, `playWithAnotherOpponent`, `yourOpponentWantsToPlayANewGameWithYou`, `joinTheGame`, `whitePlays`, `blackPlays`, `theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim`, `makeYourOpponentResign`, `forceResignation`, `forceDraw`, `talkInChat`, `theFirstPersonToComeOnThisUrlWillPlayWithYou`, `whiteCreatesTheGame`, `blackCreatesTheGame`, `whiteJoinsTheGame`, `blackJoinsTheGame`, `whiteResigned`, `blackResigned`, `whiteLeftTheGame`, `blackLeftTheGame`, `shareThisUrlToLetSpectatorsSeeTheGame`, `theComputerAnalysisHasFailed`, `viewTheComputerAnalysis`, `requestAComputerAnalysis`, `computerAnalysis`, `analysis`, `blunders`, `mistakes`, `inaccuracies`, `moveTimes`, `flipBoard`, `threefoldRepetition`, `claimADraw`, `offerDraw`, `draw`, `nbConnectedPlayers`, `gamesBeingPlayedRightNow`, `viewAllNbGames`, `viewNbCheckmates`, `nbBookmarks`, `nbPopularGames`, `nbAnalysedGames`, `bookmarkedByNbPlayers`, `viewInFullSize`, `logOut`, `signIn`, `newToLichess`, `youNeedAnAccountToDoThat`, `signUp`, `computersAreNotAllowedToPlay`, `games`, `forum`, `xPostedInForumY`, `latestForumPosts`, `players`, `minutesPerSide`, `variant`, `variants`, `timeControl`, `realTime`, `correspondence`, `daysPerTurn`, `oneDay`, `nbDays`, `nbHours`, `time`, `rating`, `ratingStats`, `username`, `password`, `haveAnAccount`, `changePassword`, `changeEmail`, `email`, `emailIsOptional`, `passwordReset`, `forgotPassword`, `rank`, `gamesPlayed`, `nbGamesWithYou`, `declineInvitation`, `cancel`, `timeOut`, `drawOfferSent`, `drawOfferDeclined`, `drawOfferAccepted`, `drawOfferCanceled`, `whiteOffersDraw`, `blackOffersDraw`, `whiteDeclinesDraw`, `blackDeclinesDraw`, `yourOpponentOffersADraw`, `accept`, `decline`, `playingRightNow`, `finished`, `abortGame`, `gameAborted`, `standard`, `unlimited`, `mode`, `casual`, `rated`, `thisGameIsRated`, `rematch`, `rematchOfferSent`, `rematchOfferAccepted`, `rematchOfferCanceled`, `rematchOfferDeclined`, `cancelRematchOffer`, `viewRematch`, `play`, `inbox`, `chatRoom`, `spectatorRoom`, `composeMessage`, `noNewMessages`, `subject`, `recipient`, `send`, `incrementInSeconds`, `freeOnlineChess`, `spectators`, `nbWins`, `nbLosses`, `nbDraws`, `exportGames`, `ratingRange`, `giveNbSeconds`, `premoveEnabledClickAnywhereToCancel`, `thisPlayerUsesChessComputerAssistance`, `thisPlayerArtificiallyIncreasesTheirRating`, `opening`, `takeback`, `proposeATakeback`, `takebackPropositionSent`, `takebackPropositionDeclined`, `takebackPropositionAccepted`, `takebackPropositionCanceled`, `yourOpponentProposesATakeback`, `bookmarkThisGame`, `search`, `advancedSearch`, `tournament`, `tournaments`, `tournamentPoints`, `viewTournament`, `backToTournament`, `backToGame`, `freeOnlineChessGamePlayChessNowInACleanInterfaceNoRegistrationNoAdsNoPluginRequiredPlayChessWithComputerFriendsOrRandomOpponents`, `teams`, `nbMembers`, `allTeams`, `newTeam`, `myTeams`, `noTeamFound`, `joinTeam`, `quitTeam`, `anyoneCanJoin`, `aConfirmationIsRequiredToJoin`, `joiningPolicy`, `teamLeader`, `teamBestPlayers`, `teamRecentMembers`, `xJoinedTeamY`, `xCreatedTeamY`, `averageElo`, `location`, `settings`, `filterGames`, `reset`, `apply`, `leaderboard`, `pasteTheFenStringHere`, `pasteThePgnStringHere`, `fromPosition`, `continueFromHere`, `importGame`, `nbImportedGames`, `thisIsAChessCaptcha`, `clickOnTheBoardToMakeYourMove`, `notACheckmate`, `colorPlaysCheckmateInOne`, `retry`, `reconnecting`, `onlineFriends`, `noFriendsOnline`, `findFriends`, `favoriteOpponents`, `follow`, `following`, `unfollow`, `block`, `blocked`, `unblock`, `followsYou`, `xStartedFollowingY`, `nbFollowers`, `nbFollowing`, `more`, `memberSince`, `lastLogin`, `challengeToPlay`, `player`, `list`, `graph`, `lessThanNbMinutes`, `xToYMinutes`, `textIsTooShort`, `textIsTooLong`, `required`, `openTournaments`, `duration`, `winner`, `standing`, `createANewTournament`, `join`, `withdraw`, `points`, `wins`, `losses`, `winStreak`, `createdBy`, `tournamentIsStarting`, `membersOnly`, `boardEditor`, `startPosition`, `clearBoard`, `savePosition`, `loadPosition`, `isPrivate`, `reportXToModerators`, `profile`, `editProfile`, `firstName`, `lastName`, `biography`, `country`, `preferences`, `watchLichessTV`, `previouslyOnLichessTV`, `todaysLeaders`, `onlinePlayers`, `progressToday`, `progressThisWeek`, `progressThisMonth`, `leaderboardThisWeek`, `leaderboardThisMonth`, `activeToday`, `activePlayers`, `bewareTheGameIsRatedButHasNoClock`, `training`, `yourPuzzleRatingX`, `findTheBestMoveForWhite`, `findTheBestMoveForBlack`, `toTrackYourProgress`, `trainingSignupExplanation`, `recentlyPlayedPuzzles`, `puzzleId`, `puzzleOfTheDay`, `clickToSolve`, `goodMove`, `butYouCanDoBetter`, `bestMove`, `keepGoing`, `puzzleFailed`, `butYouCanKeepTrying`, `victory`, `giveUp`, `puzzleSolvedInXSeconds`, `wasThisPuzzleAnyGood`, `pleaseVotePuzzle`, `thankYou`, `ratingX`, `playedXTimes`, `fromGameLink`, `startTraining`, `continueTraining`, `retryThisPuzzle`, `thisPuzzleIsCorrect`, `thisPuzzleIsWrong`, `youHaveNbSecondsToMakeYourFirstMove`, `nbGamesInPlay`, `automaticallyProceedToNextGameAfterMoving`, `autoSwitch`, `openingId`, `yourOpeningRatingX`, `findNbStrongMoves`, `thisMoveGivesYourOpponentTheAdvantage`, `openingFailed`, `openingSolved`, `recentlyPlayedOpenings`, `puzzles`, `coordinates`, `openings`, `latestUpdates`, `tournamentWinners`, `name`, `description`, `no`, `yes`, `help`, `createANewTopic`, `topics`, `posts`, `lastPost`, `views`, `replies`, `replyToThisTopic`, `reply`, `message`, `createTheTopic`, `reportAUser`, `user`, `reason`, `whatIsIheMatter`, `cheat`, `insult`, `troll`, `other`, `reportDescriptionHelp`, `by %s`, `thisTopicIsNowClosed`, `theming`, `donate`, `blog`, `questionsAndAnswers`, `notes`, `typePrivateNotesHere`, `gameDisplay`, `pieceAnimation`, `materialDifference`, `closeAccount`, `closeYourAccount`, `changedMindDoNotCloseAccount`, `closeAccountExplanation`, `thisAccountIsClosed`, `invalidUsernameOrPassword`, `emailMeALink`, `currentPassword`, `newPassword`, `newPasswordAgain`, `boardHighlights`, `pieceDestinations`, `boardCoordinates`, `moveListWhilePlaying`, `chessClock`, `tenthsOfSeconds`, `never`, `whenTimeRemainingLessThanTenSeconds`, `horizontalGreenProgressBars`, `soundWhenTimeGetsCritical`, `gameBehavior`, `premovesPlayingDuringOpponentTurn`, `takebacksWithOpponentApproval`, `promoteToQueenAutomatically`, `claimDrawOnThreefoldRepetitionAutomatically`, `privacy`, `letOtherPlayersFollowYou`, `letOtherPlayersChallengeYou`, `sound`, `soundControlInTheTopBarOfEveryPage`, `yourPreferencesHaveBeenSaved`, `none`, `fast`, `normal`, `slow`, `insideTheBoard`, `outsideTheBoard`, `onSlowGames`, `always`, `inCasualGamesOnly`, `whenPremoving`, `whenTimeRemainingLessThanThirtySeconds`, `difficultyEasy`, `difficultyNormal`, `difficultyHard`, `xLeftANoteOnY`, `xCompetesInY`, `xAskedY`, `xAnsweredY`, `xCommentedY`, `timeline`, `seeAllTournaments`, `starting`, `allInformationIsPublicAndOptional`, `yourCityRegionOrDepartment`, `biographyDescription`, `maximumNbCharacters`, `blocks`, `listBlockedPlayers`, `human`, `computer`, `side`, `clock`, `unauthorizedError`, `noInternetConnection`, `connectedToLichess`, `signedOut`, `loginSuccessful`, `playOnTheBoardOffline`, `playOfflineComputer`, `opponent`, `learn`, `community`, `tools`, `increment`, `board`, `pieces`, `sharePGN`, `playOnline`, `playOffline`, `allowAnalytics`, `shareGameURL`, `error.required`, `error.email`, `error.email_acceptable`, `error.email_unique`, `blindfoldChess`, `moveConfirmation`, `inCorrespondenceGames`, `ifRatingIsPlusMinusX`, `onlyFriends`, `menu`, `castling`, `whiteCastlingKingside`, `whiteCastlingQueenside`, `blackCastlingKingside`, `blackCastlingQueenside`, `nbForumPosts`, `tpTimeSpentPlaying`, `watchGames`, `tpTimeSpentOnTV`, `watch`, `internationalEvents`, `videoLibrary`, `mobileApp`, `webmasters`, `contribute`, `contact`, `termsOfService`, `sourceCode`, `simultaneousExhibitions`, `host`, `createdSimuls`, `hostANewSimul`, `noSimulFound`, `noSimulExplanation`, `returnToSimulHomepage`, `aboutSimul`, `aboutSimulImage`, `aboutSimulRealLife`, `aboutSimulRules`, `aboutSimulSettings`, `create`, `whenCreateSimul`, `simulVariantsHint`, `simulClockHint`, `simulAddExtraTime`, `simulHostExtraTime`, `lichessTournaments`, `tournamentFAQ`, `tournamentOfficial`, `timeBeforeTournamentStarts`, `averageCentipawnLoss`, `keyboardShortcuts`, `keyMoveBackwardOrForward`, `keyGoToStartOrEnd`, `keyShowOrHideComments`, `keyEnterOrExitVariation`, `keyYouCanDrawArrowsCirclesAndScrollToMove`, `newTournament`, `tournamentHomeTitle`, `tournamentHomeDescription`, `tournamentNotFound`, `tournamentDoesNotExist`, `tournamentMayHaveBeenCanceled`, `returnToTournamentsHomepage`, `monthlyPerfTypeRatingDistribution`, `nbPerfTypePlayersThisMonth`, `yourPerfTypeRatingisRating`, `youAreBetterThanPercentOfPerfTypePlayers`, `youDoNotHaveAnEstablishedPerfTypeRating`, `checkYourEmail`, `weHaveSentYouAnEmailToActivateYourAccount`, `ifYouDoNotSeeTheEmailCheckOtherPlaces`, `areYouSureYouEvenRegisteredYourEmailOnLichess`, `itWasNotRequiredForYourRegistration`, `weHaveSentYouAnEmailToResetYourPassword`, `byRegisteringYouAgreeToBeBoundByOur`, `cannotLogInFromYourIP`, `weHaveDetectedThatYouAreUsingTor`, `weWillMakeSureYouStayAnonymousOnLichess`, `asAnonymousUserYouCanUseAllLichessFeatures`, `security`, `currentDevice`, `alternativelyYouCan`, `revokeAllSesisons`, `confirmResignation`, `letOtherPlayersMessageYou`, `shareYourInsightsData`, `kidMode`, `kidModeDescription`, `downloadAnnotated`, `downloadRaw`, `downloadImported`, `printFriendlyPDF`, `somethingWentWrongOnThisPage`, `worldMap`, `pageNotFound`, `knowingTheChessboardCoordinatesIsAVeryImportantChessSkill`, `mostChessCoursesAndExercisesUseTheAlgebraicNotationExtensively`, `itMakesItEasierToTalkToYourChessFriends`, `youCanAnalyseAGameMoreEffectively`, `aSquareNameAppearsOnTheBoard`, `youHaveThirtySecondsToRecognizeAsManySquaresAsPossible`, `computerAnalysisAvailable`, `youCannotStartANewGameUntilThisOneIsFinished`, `ohNo`, `temporarilyBannedFromLobbyGames`, `why`, `next`, `delete`, `thisUserBlocksYouCannotAnswer`, `playChessEverywhere`, `lichessOnTheGo`, `challengeOnlinePlayers`, `playStockfishLevelOneToEight`, `loginOrPlayAsAnonymous`, `availableInEightyLanguages`, `asFreeAsLichess`, `builtForTheLoveOfChessNotMoney`, `zeroAdvertisment`, `fullFeatured`, `realTimeWithIncrement`, `correspondenceGames`, `overTheBoardOffline`, `vsComputerOffline`, `moreOfTheFeaturesYouLoveWillBeAddedSoon`, `lookOutForUpdatesRegularly`, `theSiteIsBeingUpdatedBraceForImpact`, `theSiteWillBeUpdatedInAFewMinutes`, `sorryWeDoNotHaveAnyMorePuzzlesForYou`, `youPlayedQuiteALotOfThem`, `returnToLichessHomepage`, `inTheMeanTimeYouCanBlockThisUser`, `theModeratorsWillRiviewItVerySoonAndTakeAction`, `theNameOfThePlayerYouWishToSearch`, `theAverageRatingOfTheBothPlayers`, `from`, `to`, `whetherThePlayerOpponentWasAHumanOrAComputer`, `stockfishLevel`, `source`, `numberOfTurns`, `result`, `winnerColor`, `date`, `sort`, `isAnalysis`, `whetherComputerAnalysisAvailableOrNot`, `gamesFound`, `permalink`, `downloadPGN`, `noGameFound`, `searchReady`, `opponentName`, `challengeDeclined`, `hostColorForEachGame`, `embedLichessOnYourSite`, `doYouHaveAWebsiteAndWantToAddAPlayableChessSection`, `addTheFollowingLineToYourSiteHTML`, `embedTheLichessTVInYourSite`, `justAddTheFollowingLineToYourSiteHTML`, `embedTheDailyPuzzleInYourSite`, `theTextIsAutomaticallyTranslatedToYourVisitorLanguage`, `lichessWidgets`, `letYourWebsiteVisitorsKnowThatYouArePlayingOnLichess`, `seeMoreExamplesAndInstallationInstructions`, `sorryEnginesAreNotAllowedInThisArea`, `lichessVariants`, `lichessWorldMap`, `mapOfLiveGames`, `orangeGameInProgress`, `whiteGameCreations`, `ratings`, `youHaveAlreadyCreatedATeamThisWeek`, `kickSomeoneOutOfTheTeam`, `whoDoYouWantToKickOutOfTheTeam`, `yourJoinRequestWillBeReviewedByTheTeamLeader`, `team`, `deletesTheTeamAndItsMemberships`, `yourJoinRequestIsBeingReviewedByTheTeamLeader`, `thisIsAPrivateTournament`, `shareThisURLToLetPeopleJoinIt`, `isItRated`, `thisTournamentIsRatedAndWillAffectYourRating`, `thisTournamentIsNotRatedAndWillNotAffectYourRating`, `someTournamentsAreRatedAndWillAffectYourRating`, `howAreScoresCalculated`, `aWinHasABaseOfTwoPointsADrawOnePointAndALossWorthsNothing`, `ifYouWinTwoGamesConsecutivelyYouWillStartADoublePointStreak`, `forExampleTwoWinsFollowedByADrawWillBeWorthSixPoints`, `howScoresAreCalculatedDependsOnTheSystemUsedForTheTournament`, `inAllCasesAWinIsWorthTwiceAsMuchAsDrawAnsLossIsWorthNothing`, `inTheArenaSystemWinningGamesIsASuccessionYieldsAnAdditionalBonus`, `howIsTheWinnerDecided`, `thePlayerWithTheMostPointsAtTheConclusionWillBeAnnouncedWinner`, `howDoesThePairingWorks`, `atTheBeginningofTheTournamentPlayersArePairedBaseOnTheirRating`, `asSoonAsYouFinishAGameReturnToTheTournamentLobby`, `thisEnsuresMinimumWaitTime`, `playFastAndReturnToTheLobbyToPlayMoreGamesAndWinMorePoints`, `thePairingMechanismDependsOnTheSystemUsedForTheTournament`, `inTheArenaSystemNewPairingsAreGeneratedAsSoonAsEnough`, `howDoesItEnd`, `theTournamentHasACountdownClock`, `whenItReachesZeroTheTournamentRankingsAreFrozen`, `gamesInProgressMustBeFinishedHoweverTheyDoNotCountForTheTournament`, `otherImportantRules`, `youAreRequiredToMakeYourFirstMoveWithinTwentySecondsOfYourTurn`, `failingToMakeAMoveInThisTimeWillForfeitTheGameToYourOpponent`, `drawingTheGameWithinTheFirstTenMovesOfPlayWillEarnNeitherPlayerAnyPoints`, `about`, `terminateNow`, `terminatesTheTournamentImmediately`, `lichessGames`, `noneFound`, `freeChessVideoLibrary`, `allVideosAreFreeToEveryone`, `clickOneOrManyTagsOnTheLeftToFilter`, `noVideoForTheseTags`, `thatIsAllWeGotForTheseTags`, `clearSearch`, `viewMoreTags`, `videoNotFound`, `returnToTheVideoLibrary`, `noVideoForThisSearch`, `thatIsAllWeGotForThisSearch`)
