...
final class I18nKeys(translator: Translator) {
  ...
  val `ifRatingIsInThreshold` = new Key("ifRatingIsInThreshold")
  ...
  val `joinExistingSimul` = new Key("joinExistingSimul")
