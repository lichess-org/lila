...
val `general-shogi-discussion` = new I18nKey("general-shogi-discussion")
val `game-analysis` = new I18nKey("game-analysis")
val `lishogi-feedback` = new I18nKey("lishogi-feedback")
val `off-topic-discussion` = new I18nKey("off-topic-discussion")
...
val `recentlyPlayedGames` = new I18nKey("tourArrangements:recentlyPlayedGames")
