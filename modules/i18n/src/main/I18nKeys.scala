...
val `chessInsights` = new I18nKey("chessInsights")
val `analyticsFromGames` = new I18nKey("analyticsFromGames")
val `yourGames` = new I18nKey("yourGames")
val `usersGames` = new I18nKey("usersGames")
val `insightsOverNbRatedGames` = new I18nKey("insightsOverNbRatedGames")
val `acplByDate` = new I18nKey("acplByDate")
val `blursByDate` = new I18nKey("blursByDate")
...
val `whatIsTheWinRateOfMyFavouriteOpeningsAsWhite` = new I18nKey("whatIsTheWinRateOfMyFavouriteOpeningsAsWhite")
val `howOftenDoIPunishBlundersMadeByMyOpponentDuringEachGamePhase` = new I18nKey("howOftenDoIPunishBlundersMadeByMyOpponentDuringEachGamePhase")
