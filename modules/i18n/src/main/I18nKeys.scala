...
object I18nKeys:
  ...
  object features:
    val `features` = I18nKey("features")
    val `playAndCreateX` = I18nKey("playAndCreateX")
    val `tournaments` = I18nKey("tournaments")
    val `simultaneousExhibitions` = I18nKey("simultaneousExhibitions")
    val `correspondenceWithConditionalPremoves` = I18nKey("correspondenceWithConditionalPremoves")
    val `standardChessAndX` = I18nKey("standardChessAndX")
    val `deepXServerAnalysis` = I18nKey("deepXServerAnalysis")
    val `boardEditorAndAnalysisBoardWithSf14` = I18nKey("boardEditorAndAnalysisBoardWithSf14")
    val `cloudEngineAnalysis` = I18nKey("cloudEngineAnalysis")
    val `studies` = I18nKey("studies")
    val `chessInsights` = I18nKey("chessInsights")
    ...
    val `personalOpeningExplorerX` = I18nKey("personalOpeningExplorerX")
    val `xGlobalOpeningExplorer` = I18nKey("xGlobalOpeningExplorer")
    val `globalOpeningExplorer` = I18nKey("globalOpeningExplorer")
    val `personalOpeningExplorer` = I18nKey("personalOpeningExplorer")
    val `endgameTablebase` = I18nKey("endgameTablebase")
    val `downloadOrUploadAnyGameAsPgn` = I18nKey("downloadOrUploadAnyGameAsPgn")
    val `xThroughLichessBillionGames` = I18nKey("xThroughLichessBillionGames")
    val `tvForumBlogTeamsMessagingFriendsChallenges` = I18nKey("tvForumBlogTeamsMessagingFriendsChallenges")
    val `availableInNbLanguages` = I18nKey("availableInNbLanguages")
    val `lightOrDarkThemeCustomBoardsPiecesAndBackground` = I18nKey("lightOrDarkThemeCustomBoardsPiecesAndBackground")
    val `allFeaturesToCome` = I18nKey("allFeaturesToCome")
    val `landscapeSupportOnApp` = I18nKey("landscapeSupportOnApp")
    val `supportLichess` = I18nKey("supportLichess")
    val `contributeToLichessAndGetIcon` = I18nKey("contributeToLichessAndGetIcon")
