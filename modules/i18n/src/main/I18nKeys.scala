...
object I18nKeys:
  ...
  val `keyMoveBackward` = I18nKey("keyMoveBackward")
  val `keyMoveForward` = I18nKey("keyMoveForward")
  val `keyGoToStart` = I18nKey("keyGoToStart")
  val `keyGoToEnd` = I18nKey("keyGoToEnd")
  ...
  val `keyCyclePreviousOrNextVariation` = I18nKey("keyCyclePreviousOrNextVariation")
  ...
  val `welcomeToX` = I18nKey("welcomeToX")
  ...
  object ublog:
    ...
    val `continueReadingThisPost` = I18nKey("continueReadingThisPost")
    val `previousBlogPosts` = I18nKey("previousBlogPosts")
    val `discussThisBlogPostInTheForum` = I18nKey("discussThisBlogPostInTheForum")
