...
val `hiHello` = new Translated("hiHello", Site)
val `glGoodLuck` = new Translated("glGoodLuck", Site)
val `hfHaveFun` = new Translated("hfHaveFun", Site)
val `u2YouToo` = new Translated("u2YouToo", Site)
val `ggGoodGame` = new Translated("ggGoodGame", Site)
val `wpWellPlayed` = new Translated("wpWellPlayed", Site)
val `tyThankYou` = new Translated("tyThankYou", Site)
val `gtgIveGotToGo` = new Translated("gtgIveGotToGo", Site)
val `byeBye` = new Translated("byeBye", Site)
