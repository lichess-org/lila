...
object TimeagoLocales {
  val js: Map[String, String] = Map(
    "ar" -> """(function(){lichess.timeagoLocale=function(number, index) {
if (index === 0) {
...
return timeTypes[type][3];
    ...
    "be" -> """(function(){var seconds = formatNum.bind(null, 'секунду','%s секунду','%s секунды','%s секунд'),
...
return str;
    ...
    "bg" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['преди %s години','след %s години']
    ...
    "ca" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['fa %s anys','d\'aquí %s anys']
    ...
    "da" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['for %s år siden','om %s år']
    ...
    "de" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['vor %s Jahren','in %s Jahren']
    ...
    "el" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['μόλις τώρα','σε λίγο'],
...
['%s χρόνια πριν','σε %s χρόνια']
    ...
    "en" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['just now','right now'],
...
['%s years ago','in %s years']
    ...
    "en_short" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['just now','right now'],
['%ss ago','in %ss'],
['1m ago','in 1m'],
...
['%syr ago','in %syr']
    ...
    "es" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['hace %s años','en %s años']
    ...
    "eu" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['duela %s urte','%s urte barru']
    ...
    "fa" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['%s سال پیش','حدود %s سال پیش']
    ...
    "fi" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['%s vuotta sitten','%s vuoden päästä']
    ...
    "fr" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['il y a %s ans','dans %s ans']
    ...
    "gl" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['hai %s anos','en %s anos']
    ...
    "he" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['זה עתה','עכשיו'],
...
['לפני %s שנים','בעוד %s שנים']
    ...
    "hu" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['%s éve','%s éven belül']
    ...
    "in_BG" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
[ 'এইমাত্র' , 'একটা সময়'] ,
...
[ '%s বছর আগে','%s বছরে']
    ...
    "in_HI" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['अभी','कुछ समय'],
...
['%s साल पहले','%s साल में']
    ...
    "in_ID" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['baru saja','sebentar'],
...
['%s tahun yang lalu','dalam %s tahun']
    ...
    "it" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['poco fa','tra poco'],
...
['%s anni fa','%s anni da ora']
    ...
    "ja" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['すこし前','すぐに'],
['%s秒前','%s秒以内'],
['1分前','1分以内'],
...
['%s年前','%s年以内']
    ...
    "ko" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['방금','곧'],
['%s초 전','%s초 후'],
['1분 전','1분 후'],
...
['%s년 전','%s년 후']
    ...
    "ml" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['%s വര്‍ഷങ്ങള്‍ക്കു മുന്‍പ്','%s വര്‍ഷങ്ങള്‍ക്കുല്ല്ളില്‍']
    ...
    "my" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['ယခုအတွင်း','ယခု'],
...
['%s နှစ် အကြာက','%s နှစ်အတွင်း']
    ...
    "nb_NO" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['akkurat nå','om litt'],
...
['%s år siden','om %s år']
    ...
    "nl" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['recent','binnenkort'],
...
['%s jaren geleden','binnen %s jaren']
    ...
    "nn_NO" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['nett no','om litt'],
...
return l[index&1?(number%10>4||number%10<2||1===~~(number/10)%10?index:++index/2+13):index];
    ...
    "pt_BR" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['há %s anos','em %s anos']
    ...
    "ro" -> """(function(){lichess.timeagoLocale=function(number, index) {
var langTable = [
...
langTable[index][1].replace('%s','%s de'),
    ...
    "ru" -> """(function(){var seconds = formatNum.bind(null, 'секунду','%s секунду','%s секунды','%s секунд'),
...
return str;
    ...
    "sv" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['just nu','om en stund'],
...
['%s år sedan','om %s år']
    ...
    "ta" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['%s வருடங்களுக்கு முன்','%s வருடங்களில்']
    ...
    "th" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
...
['%s ปีที่แล้ว','ใน %s ปี']
    ...
    "tr" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['az önce','şimdi'],
...
['%s yıl önce','%s yıl içinde']
    ...
    "uk" -> """(function(){var seconds = formatNum.bind(null, 'секунду','%s секунду','%s секунди','%s секунд'),
...
return str
    ...
    "vi" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['vừa xong','một lúc'],
...
['%s năm trước','trong %s năm']
    ...
    "zh_CN" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['刚刚','片刻后'],
['%s秒前','%s秒后'],
['1分钟前','1分钟后'],
...
['%s年前','%s年后']
    ...
    "zh_TW" -> """(function(){lichess.timeagoLocale=function(number, index) {
return [
['剛剛','片刻後'],
['%s秒前','%s秒後'],
['1分鐘前','1分鐘後'],
