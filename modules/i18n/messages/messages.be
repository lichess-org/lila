...
time=Час
rating=Рэйтынг
ratingStats=Статыстыка рэйтыгнаў
...
tournamentHomeDescription=Гуляйце ў шахматных турнірах у хуткія шахматы! Далучайцеся да запланаванага турніру ці стварыце ўласны. Куля, бліц, класіка, шахматы Фішара, кароль у цэнтры, тры шаха і іншыя даступныя варыянты бясконцага шахматнага задавальнення.
...
weeklyPerfTypeRatingDistribution=Размеркаванне па рэйтынгу %s за месяц
nbPerfTypePlayersThisWeek=%s %s гульцоў за месяц
yourPerfTypeRatingisRating=Ваш %s рэйтынг %s.
youAreBetterThanPercentOfPerfTypePlayers=Вы мацней %s гульцоў у %s.
youDoNotHaveAnEstablishedPerfTypeRating=Ваш %s рэйтынг яшчэ не вызначаны.
checkYourEmail=Пацвердзіце свой Email
weHaveSentYouAnEmailClickTheLink=Мы адправілі вам ліст. Націсніце на спасылку ў ім для актывацыі акаўнта.
ifYouDoNotSeeTheEmailCheckOtherPlaces=Калі ліст не прыходзіць, праверце тэчку для спаму і іншыя месцы, куды яно магло трапіць.
areYouSureYouEvenRegisteredYourEmailOnLichess=Вы ўпэўнены, што рэгістравалі свой Email на Lichess?
itWasNotRequiredForYourRegistration=Ён не быў абавязковы пры рэгістрацыі.
weHaveSentYouAnEmailTo=Мы адправілі ліст па адрасе %s. Націсніце на спасылку ў ім для скіду пароля.
byRegisteringYouAgreeToBeBoundByOur=Рэгіструючыся, вы бераце на сябе абавязак выконваць наша %s
...
crosstable=Лік
youCanAlsoScrollOverTheBoardToMoveInTheGame=Можаце ужываць колца мышкі для перамоткі хадоў (трымайце курсор над дошкай)
pressShiftPlusClickOrRightClickToDrawCirclesAndArrowsOnTheBoard=Ужывайце Shift+левую кнопку мышы ці правую кнопку, каб маляваць кружкі і стрэлкі на дошцы
confirmResignation=Пацвердзіць капітуляцыю
letOtherPlayersMessageYou=Дазволіць дасылаць вам паведамленні
shareYourInsightsData=Дзяліцца статыстыкай
youHaveAlreadyRegisteredTheEmail=Вы ўжо рэгістравалі гэты адрас: %s
kidMode=Дзіцячы рэжым
playChessEverywhere=Гуляй у шахматы паўсюль
asFreeAsLichess=Задарма, як і Lichess
builtForTheLoveOfChessNotMoney=Створана ад любові да шахматаў, ня грошай
everybodyGetsAllFeaturesForFree=Кожны атрымвае ўсе магчымасьці бясплатны
zeroAdvertisement=Без рэклямы
fullFeatured=Паўнавартасны
phoneAndTablet=Смартфон і пляншэт
bulletBlitzClassical=Гульня online
correspondenceChess=Гульня па ліставанні
onlineAndOfflinePlay=Гульня online i offline
correspondenceAndUnlimited=Па ліставанні і без абмежавання часу
viewTheSolution=Паглядзець развязак
followAndChallengeFriends=Падпісацца і выклікаць на гульню сяброў
availableInNbLanguages=Даступна на %s мовах!
