...
toInviteSomeoneToPlayGiveThisUrl=Чтобы пригласить друга, поделитесь с ним этой ссылкой
...
variantEnding=Вариация завершена
...
theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim=Ваш соперник покинул игру. Вы можете запросить победу, объявить ничью или ждать.
makeYourOpponentResign=Объявить соперника сдавшимся
forceResignation=Запросить победу
forceDraw=Объявить ничью
talkInChat=Будьте вежливы в чате!
theFirstPersonToComeOnThisUrlWillPlayWithYou=Первый, кто перейдёт по этой ссылке и присоединится к игре, будет играть с Вами.
...
shareThisUrlToLetSpectatorsSeeTheGame=Пригласите зрителей, поделившись с ними этой ссылкой
...
password=Пароль
haveAnAccount=Уже есть учётная запись?
...
thisPlayerUsesChessComputerAssistance=Этот игрок использует помощь шахматной программы (читер)
thisPlayerArtificiallyIncreasesTheirRating=Этот игрок искусственно увеличивал либо уменьшал свой рейтинг
openingExplorer=Анализ дебютных вариантов
...
cheat=Использование помощи сторонних программ
insult=Оскорбление
troll=Троллинг
other=Другое
reportDescriptionHelp=Поделитесь с нами ссылкой на игру (игры), где, как вам кажется, были нарушены правила, и опишите, в чем дело. Пожалуйста, расскажите, как и исходя из чего вы догадались, что ваш противник нечестен. Мы сработаем оперативнее, если ваше сообщение будет на английском языке.
by=опубликовал %s
...
aboutSimulRules=Старт - каждый игрок начинает игру с сеансёром, получающим белый цвет. Сеанс закончится, когда все партии будут сыграны.
...
simulAddExtraTime=Вы можете добавить дополнительное время к своему таймеру для большей форы.
...
networkLagBetweenYouAndLichess=Задержка сети между Вами и серверами lichess
