...
theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim=Ο αντίπαλος σας έφυγε από το παιχνίδι. Μπορείτε να αξιώσετε νίκη, ισοπαλία, ή να περιμένετε.
makeYourOpponentResign=Αναγκάστε τον αντίπαλο σας να παραιτηθεί
forceResignation=Αξιώστε νίκη
