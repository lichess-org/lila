...
email=Email
emailIsOptional=Email is optioneel. Lichess gebruikt het om een nieuw wachtwoord te verzenden indien u het vergeet.
...
casual=Vrijblijvend
rated=Met rating
thisGameIsRated=Deze artij telt mee voor rating
...
closeYourAccount=Verwijder uw account
changedMindDoNotCloseAccount=Ik ben van gedachten veranderd; verwijder mijn account niet.
closeAccountExplanation=Weet je zeker dat je je account wilt verwijderen? Het verwijderen van uw account is een permanente keuze. U kunt dan niet langer inloggen en uw profielpagina zal dan niet langer toegankelijk zijn.
thisAccountIsClosed=Dit account is verwijderd.
...
whenTimeRemainingLessThanThirtySeconds=Wanneer tijd < 30 seconden
difficultyEasy=Gemakkelijk
difficultyNormal=Normaal
difficultyHard=Moeilijk
xLeftANoteOnY=%s heeft bericht voor %s achtergelaten
...
mobileApp=App voor smartphones/tablets
...
nbPerfTypePlayersThisWeek=%s %s spelers deze week.
yourPerfTypeRatingisRating=Je %srating is %s.
youAreBetterThanPercentOfPerfTypePlayers=Je bent beter dan %s van de %sspelers.
youDoNotHaveAnEstablishedPerfTypeRating=Je hebt geen vastgestelde %srating.
checkYourEmail=Controleer je email
weHaveSentYouAnEmailClickTheLink=We hebben je een email gestuurd. Klink op de link in de email om je account te activeren.
...
areYouSureYouEvenRegisteredYourEmailOnLichess=Weet je zeker dat je dit emailadres op Lichess geregistreed hebt?
itWasNotRequiredForYourRegistration=Het was niet noodzakelijk geweest voor je registratie.
weHaveSentYouAnEmailTo=We hebben een email verstuurd naar %s. Klink op de link in de email om je wachtwoord te resetten.
...
pressShiftPlusClickOrRightClickToDrawCirclesAndArrowsOnTheBoard=Druk op shift+linkermuisknop of rechtermuisknop om cirkels en pijlen op het bord te tekenen.
confirmResignation=Bevestiging bij opgeven
...
correspondenceChess=Correspondentiepartij
onlineAndOfflinePlay=Online en offline spelen
correspondenceAndUnlimited=Correspondentiepartij zonder klok
