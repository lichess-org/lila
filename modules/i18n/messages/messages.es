...
joinTheGame=Únete a la partida
...
viewTheComputerAnalysis=Ve el análisis del ordenador
requestAComputerAnalysis=Solicita un análisis del ordenador
...
downloadAnnotated=Descargar la partida con anotaciones
downloadRaw=Descarga la partida en bruto.
downloadImported=Descargar el juego importado
printFriendlyPDF=Imprimir en formato PDF
crosstable=Tabla cruzada
youCanAlsoScrollOverTheBoardToMoveInTheGame=También puedes usar la rueda del mouse para moverte en la partida.
...
confirmResignation=Confirma rendici´ón
letOtherPlayersMessageYou=Deja que otras personas te envíen un mensaje
