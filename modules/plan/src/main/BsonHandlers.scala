...
private[plan] object BsonHandlers {
  ...
  implicit val ChargeIdBSONHandler: BSONHandler[ChargeId]   = stringAnyValHandler[ChargeId](_.value, ChargeId.apply)
  implicit val CustomerIdBSONHandler: BSONHandler[CustomerId] = stringAnyValHandler[CustomerId](_.value, CustomerId.apply)

  object PatronHandlers {
    import Patron._
    implicit val PayPalEmailBSONHandler: BSONHandler[PayPal.Email] = stringAnyValHandler[PayPal.Email](_.value, PayPal.Email.apply)
    implicit val PayPalSubIdBSONHandler: BSONHandler[PayPal.SubId] = stringAnyValHandler[PayPal.SubId](_.value, PayPal.SubId.apply)
