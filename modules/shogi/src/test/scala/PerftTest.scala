...
class PerftTest extends ShogiTest {
  ...
  //    List("l2s5/3kn2R+L/p1gpp+SQ8G/4np3/2+r3P1N/PP1P2pS1/1pG2P3/4P1G2/LN3KB1+p b GLPsspppp", "165", "16018"),
  ...
  //    List("l1S6/r3k3+L/p1gppl3/4np+SQ8H/2+r3P1N/PP1P2pS1/1pG2P3/4P1G2/LN3KB1+p b GSPsnpppp", "163", "21883"),
  ...
  //    List("l2kgs1+R1/4n+SQ8H+L/p1gpp4/4np3/6P1N/PP+rP2pS1/1pG2P3/4P1G2/LN3KB1+p w SSPlpppp", "95", "10625"),
