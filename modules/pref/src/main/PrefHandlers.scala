  ...
  implicit val prefBSONHandler = new BSON[Pref] {
    ...
    def reads(r: BSON.Reader): Pref =
      Pref(
        ...
        topicMaxPerPage = MaxPerPage(r.getD("topicMaxPerPage", Pref.default.topicMaxPerPage.value)),
        postMaxPerPage = MaxPerPage(r.getD("postMaxPerPage", Pref.default.postMaxPerPage.value)),
