...
case class Metas(
  ...
  forceVariation: Boolean, // TODO, should be able to be removed once support for null move is added
   // TODO, add support for variationComments
)

case class NewBranch(id: UciCharPair,move: Uci.WithSan,metas: Metas)

type NewTree = pgn.Node[NewBranch]
object NewTree:
  // default case class constructor not working with type alias?
  def make(value: NewBranch, child: Option[NewTree], variations: List[NewTree]) = pgn.Node[NewBranch](value, child, variations)
