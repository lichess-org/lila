/*! Sortable 1.4.2 - MIT | git://github.com/rubaxa/Sortable.git | thib size hack */
window.Sortable = (function () {
  ...
  function a(a, b) {
    ...
    (this.nativeDraggable = b.forceFallback ? !1 : P),
      ...
      this.nativeDraggable && (e(a, "dragover", this), e(a, "dragenter", this)),
          ...
          (J.vx !== f || J.vy !== g || J.el !== d) &&
            ...
            d &&
              (J.pid = setInterval(function () {
                d === M
                  ? M.scrollTo(M.pageXOffset + f * i, M.pageYOffset + g * i)
                  : (g && (d.scrollTop += g * i), f && (d.scrollLeft += f * i));
              }, 24)));
      }
    }, 30),
    V = function (a) {
      var b = a.group;
      (b && "object" == typeof b) || (b = a.group = { name: b }),
        ["pull", "put"].forEach(function (a) {
          a in b || (b[a] = !0);
        }),
        (a.groups =
          " " + b.name + (b.put.join ? " " + b.put.join(" ") : "") + " ");
    };
  return (
    (a.prototype = {
      constructor: a,
        ...
        if (
          ...
          if (((D = p(h)), "function" == typeof k)) {
            if (k.call(this, a, h, this))
              return j(b, i, "filter", h, d, D), void a.preventDefault();
          } else if (
            k &&
      ...
      _triggerDragStart: function (a) {
        a
          ? ((G = { target: s, clientX: a.clientX, clientY: a.clientY }),
            this._onDragStart(G, "touch"))
          : this.nativeDraggable
          ? (e(s, "dragend", this), e(w, "dragstart", this._onDragStart))
      ...
      _appendGhost: function () {
        if (!u) {
          ...
          (u = s.cloneNode(!0)),
            ...
            (d.fallbackOnBody && N.body.appendChild(u)) || w.appendChild(u),
      ...
      _onDragOver: function (a) {
        ...
        if (
          (void 0 !== a.preventDefault &&
            (a.preventDefault(), !i.dragoverBubble && a.stopPropagation()),
          (I = !0),
          F &&
            !i.disabled &&
            (o
              ...
              : F.pull &&
                l &&
                (F.name === j.name || (l.indexOf && ~l.indexOf(F.name)))) &&
          ...
          if (
            ...
            return (
              b(!0),
              void (v || x ? w.insertBefore(s, v || x) : p || w.appendChild(s))
            );
          if (
            0 === g.children.length ||
            g.children[0] === u ||
            ...
            var q,
              ...
              z = r.bottom - r.top,
              D =
                /left|right|inline/.test(B.cssFloat + B.display) ||
                ("flex" == C.display &&
                  0 === C["flex-direction"].indexOf("row")),
              E = d.offsetWidth > s.offsetWidth,
              G = d.offsetHeight > s.offsetHeight,
              H =
                (D ? (a.clientX - r.left) / y : (a.clientY - r.top) / z) > 0.5,
              J = d.nextElementSibling,
              K = k(w, g, s, e, d, r);
            if (K !== !1) {
              if (((R = !0), setTimeout(m, 30), b(o), 1 === K || -1 === K))
                q = 1 === K;
              else if (D) {
                var M = s.offsetTop,
                  N = d.offsetTop;
                q =
                  M === N
                    ? (d.previousElementSibling === s && !E) || (H && E)
                    : N > M;
              } else q = (J !== s && !G) || (H && G);
              s.contains(g) ||
                (q && !J
      ...
      _onDrop: function (b) {
        ...
        clearInterval(this._loopId),
          ...
          this.nativeDraggable &&
            (f(N, "drop", this), f(c, "dragstart", this._onDragStart)),
          this._offUpEvents(),
          b &&
            (I && (b.preventDefault(), !d.dropBubble && b.stopPropagation()),
