        ...
        var e = arguments[3],
          n =
            ...
            function (e) {
              ...
              if (null != e)
                for (var r in e)
                  Object.hasOwnProperty.call(e, r) && (n[r] = e[r]);
        ...
        var r = n(require("js-binarypack")),
          ...
          o = (function () {
            ...
            return (
              ...
              (e.CLOUD_HOST = "0.peerjs.com"),
              (e.CLOUD_PORT = 443),
              (e.chunkedBrowsers = { Chrome: 1 }),
              (e.chunkedMTU = 16300),
              (e.defaultConfig = a),
              (e.browser = (n = window).mozRTCPeerConnection
                ? "Firefox"
              ...
              (e.supports = (function () {
                ...
                if (r) {
                  try {
                    (n.binaryType = "blob"), (i = !0);
                  } catch (l) {}
                  var d = new t.RTCPeerConnection(a, {});
                  try {
                    u = d.createDataChannel("_PEERJSRELIABLETEST", {}).ordered;
                  } catch (l) {}
                  d.close();
                }
                return (
        ...
        var r = require("eventemitter3"),
          ...
          a = (function (t) {
            function o(e, s, n, o, r) {
              ...
              (i.WEB_SOCKET_PING_INTERVAL = 2e4),
                (i._disconnected = !1),
                (i._messagesQueue = []);
              var c = e ? "wss://" : "ws://";
            ...
            return (
              ...
              (o.prototype._startWebSocket = function () {
                var e = this;
                this._socket ||
                  ...
                  (this._socket.onclose = function (t) {
                    i.default.log("Socket closed.", t),
                      (e._disconnected = !0),
                      clearTimeout(e._wsPingTimer),
                      e.emit(c.SocketEventType.Disconnected);
                  }),
                  (this._socket.onopen = function () {
                    e._disconnected ||
                      (e._sendQueuedMessages(),
                      i.default.log("Socket open"),
                      e._scheduleHeartbeat());
                  }));
              }),
            ...
            setZeroTimeout: (function (e) {
              ...
              return (
                e.addEventListener
                  ...
                  : e.attachEvent && e.attachEvent("onmessage", n),
                function (n) {
    ...
    "aYFJ": [
      function (require, module, exports) {
        ...
        (e.prototype.send = function (e) {
          var n = t.pack(e);
          n.size < this._mtu
            ? this._handleSend(["no", n])
            : ((this._outgoing[this._count] = {
                ack: 0,
                chunks: this._chunk(n),
              }),
              t.debug && (this._outgoing[this._count].timer = new Date()),
          ...
          (e.prototype._intervalSend = function (e) {
            var n = this;
            (e = t.pack(e)),
              t.blobToBinaryString(e, function (t) {
                n._dc.send(t);
              }),
              0 === n._queue.length &&
          ...
          (e.prototype._handleMessage = function (e) {
            ...
            switch (e[0]) {
              ...
              case "ack":
                if ((n = s)) {
                  var h = e[2];
                  (n.ack = Math.max(h, n.ack)),
                    n.ack >= n.chunks.length
                      ? (t.log("Time: ", new Date() - n.timer),
                        delete this._outgoing[i])
                      : this._processAcks();
                }
                break;
              case "chunk":
                if (!(n = o)) {
                  ...
                  (n = { ack: ["ack", i, 0], chunks: [] }),
                    (this._incoming[i] = n);
                }
                var r = e[2],
                  u = e[3];
                (n.chunks[r] = new Uint8Array(u)),
                  r === n.ack[2] && this._calculateNextAck(i),
                  this._ack(i);
                break;
              default:
                this._handleSend(e);
          ...
          (e.prototype._ack = function (t) {
            ...
            this._received[t] === e[2] &&
              (this._complete(t), (this._received[t] = !0)),
              this._handleSend(e);
          }),
          (e.prototype._calculateNextAck = function (t) {
            for (
              var e = this._incoming[t], n = e.chunks, i = 0, o = n.length;
              i < o;
              i += 1
            )
          ...
          (e.prototype._sendWindowedChunks = function (e) {
            ...
            for (
              var n = this._outgoing[e],
                i = n.chunks,
                o = [],
                s = Math.min(n.ack + this._window, i.length),
                a = n.ack;
              a < s;
              a += 1
            )
              (i[a].sent && a !== n.ack) ||
                ((i[a].sent = !0), o.push(["chunk", e, a, i[a].payload]));
            n.ack + this._window >= i.length && o.push(["end", e, i.length]),
              (o._multiple = !0),
              this._handleSend(o);
          }),
          ...
          d = (function () {
            ...
            return (
              ...
              (o.prototype._startPeerConnection = function () {
                ...
                c.util.supports.sctp
                  ? this.connection.type === l.ConnectionType.Media &&
                    (e = { optional: [{ DtlsSrtpKeyAgreement: !0 }] })
                  : (e = { optional: [{ RtpDataChannels: !0 }] });
                var n = new s.RTCPeerConnection(
              ...
              (o.prototype._setupListeners = function (e) {
                ...
                a.default.log("Listening for ICE candidates."),
                  (e.onicecandidate = function (e) {
                    e.candidate &&
                      (a.default.log("Received ICE candidates for:", t),
                      r.socket.send({
                ...
                return n(this, void 0, Promise, function () {
                  ...
                  return t(this, function (t) {
                    switch (t.label) {
                      ...
                      case 2:
                        (i = t.sent()),
                          a.default.log("Created offer."),
                          c.util.supports.sctp ||
                            this.connection.type !== l.ConnectionType.Data ||
                            ((d = this.connection).reliable &&
                              (i.sdp = r.higherBandwidthSDP(i.sdp))),
                          this.connection.options.sdpTransform &&
                            "function" ==
                              typeof this.connection.options.sdpTransform &&
                            (i.sdp =
                              this.connection.options.sdpTransform(i.sdp) ||
                              i.sdp),
                          (t.label = 3);
                      case 3:
                        return (
                          t.trys.push([3, 5, , 6]),
                          [4, n.setLocalDescription(i)]
                        );
                      case 4:
                        return (
                          t.sent(),
                      ...
                      case 5:
                        return (
                          "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" !=
                            (p = t.sent()) &&
                            (o.emitError(l.PeerErrorType.WebRTC, p),
                            a.default.log(
                      ...
                      case 7:
                        return (
                          (u = t.sent()),
                          o.emitError(l.PeerErrorType.WebRTC, u),
                          a.default.log("Failed to createOffer, ", u),
                          [3, 8]
                        );
                      case 8:
                        return [2];
                ...
                return n(this, void 0, Promise, function () {
                  ...
                  return t(this, function (t) {
                    switch (t.label) {
                      ...
                      case 2:
                        (o = t.sent()),
                          a.default.log("Created answer."),
                          c.util.supports.sctp ||
                            this.connection.type !== l.ConnectionType.Data ||
                            (this.connection.reliable &&
                              (o.sdp = r.higherBandwidthSDP(o.sdp))),
                          this.connection.options.sdpTransform &&
                            "function" ==
                              typeof this.connection.options.sdpTransform &&
                            (o.sdp =
                      ...
                      case 5:
                        return (
                          ...
                          a.default.log("Failed to setLocalDescription, ", i),
                          [3, 6]
                        );
                      case 6:
                        return [3, 8];
                      case 7:
                        return (
                          ...
                          a.default.log("Failed to create answer, ", s),
                          [3, 8]
                        );
                      case 8:
                        return [2];
              ...
              (o.prototype.handleSDP = function (e, o) {
                return n(this, void 0, Promise, function () {
                  ...
                  return t(this, function (t) {
                    switch (t.label) {
                      case 0:
                        (o = new s.RTCSessionDescription(o)),
                          (n = this.connection.peerConnection),
                          (i = this.connection.provider),
                          a.default.log("Setting remote description", o),
                          (r = this),
                          (t.label = 1);
                      case 1:
                        return (
                      ...
                      case 5:
                        return (
                          (c = t.sent()),
                          i.emitError(l.PeerErrorType.WebRTC, c),
                          a.default.log("Failed to setRemoteDescription, ", c),
                          [3, 6]
                        );
                      case 6:
                        return [2];
                  ...
                  return t(this, function (t) {
                    switch (t.label) {
                      ...
                      case 3:
                        return (
                          (d = t.sent()),
                          c.emitError(l.PeerErrorType.WebRTC, d),
                          a.default.log("Failed to handleCandidate, ", d),
                          [3, 4]
                        );
                      case 4:
                        return [2];
                ...
                if ((void 0 === r && (r = {}), this._localStream))
                  ...
                  (this._localStream = e),
                    ...
                    this._negotiator.startConnection(
                      t({}, this.options._payload, { _stream: e }),
                    );
          ...
          l = (function (n) {
            function u(e, t, i) {
              ...
              return (
                ...
                (o._chunkedData = {}),
                (o.connectionId =
                  o.options.connectionId || u.ID_PREFIX + r.util.randomToken()),
                (o.label = o.options.label || o.connectionId),
                (o.serialization =
                  o.options.serialization || s.SerializationType.Binary),
                (o.reliable = o.options.reliable),
                o.options._payload &&
                  (o._peerBrowser = o.options._payload.browser),
                (o._negotiator = new a.Negotiator(o)),
            ...
            return (
              ...
              Object.defineProperty(u.prototype, "type", {
                get: function () {
                  return s.ConnectionType.Data;
                },
                enumerable: !0,
                configurable: !0,
              }),
              Object.defineProperty(u.prototype, "dataChannel", {
                get: function () {
                  return this._dc;
                },
                enumerable: !0,
              ...
              (u.prototype._configureDataChannel = function () {
                var e = this;
                if (
                  (r.util.supports.sctp &&
                    (this.dataChannel.binaryType = "arraybuffer"),
                  (this.dataChannel.onopen = function () {
                    o.default.log("Data channel connection success"),
                      (e._open = !0),
                      e.emit(s.ConnectionEventType.Open);
                  }),
                  !r.util.supports.sctp && this.reliable)
                ) {
                ...
                this._reliable
                  ? (this._reliable.onmessage = function (t) {
                      e.emit(s.ConnectionEventType.Data, t);
                    })
                  : (this.dataChannel.onmessage = function (t) {
                      e._handleDataMessage(t);
                    }),
                  (this.dataChannel.onclose = function () {
                    o.default.log("DataChannel closed for:", e.peer), e.close();
                  });
              }),
              (u.prototype._handleDataMessage = function (e) {
                var t = this,
                  ...
                  a = i;
                if (
                  this.serialization === s.SerializationType.Binary ||
                  this.serialization === s.SerializationType.BinaryUTF8
                ) {
                  if (o === Blob)
                    return void r.util.blobToArrayBuffer(i, function (e) {
                  ...
                  this.serialization === s.SerializationType.JSON &&
                    (a = JSON.parse(i));
                a.__peerData
                  ? this._handleChunk(a)
                  : n.prototype.emit.call(this, s.ConnectionEventType.Data, a);
              }),
              ...
              (u.prototype.close = function () {
                (this._buffer = []),
                  ...
                  this.open &&
                    ((this._open = !1),
                    n.prototype.emit.call(this, s.ConnectionEventType.Close));
              }),
              (u.prototype.send = function (e, t) {
                var i = this;
                if (this.open)
                  if (this._reliable) this._reliable.send(e);
                  else if (this.serialization === s.SerializationType.JSON)
                    this._bufferedSend(JSON.stringify(e));
                  else if (
                    this.serialization === s.SerializationType.Binary ||
                    this.serialization === s.SerializationType.BinaryUTF8
                  ) {
                    var o = r.util.pack(e);
                    if (
                      (r.util.chunkedBrowsers[this._peerBrowser] ||
                        r.util.chunkedBrowsers[r.util.browser]) &&
                      !t &&
                      o.size > r.util.chunkedMTU
                    )
                      return void this._sendChunks(o);
                    r.util.supports.sctp
                      ? r.util.supports.binaryBlob
                        ? this._bufferedSend(o)
                        : r.util.blobToArrayBuffer(o, function (e) {
                            i._bufferedSend(e);
                          })
                      : r.util.blobToBinaryString(o, function (e) {
                          i._bufferedSend(e);
                        });
                  ...
                  n.prototype.emit.call(
                    this,
                    s.ConnectionEventType.Error,
                    new Error(
                      "Connection is not open. You should listen for the `open` event before sending messages.",
                    ),
                  );
              }),
              (u.prototype._bufferedSend = function (e) {
                (!this._buffering && this._trySend(e)) ||
                  (this._buffer.push(e),
                  (this._bufferSize = this._buffer.length));
              }),
              (u.prototype._trySend = function (e) {
                var t = this;
          ...
          f = (function (o) {
            function i(e, n) {
              ...
              return (
                ...
                (r._options = n),
                "/" === n.host && (n.host = window.location.hostname),
                "/" !== n.path[0] && (n.path = "/" + n.path),
                "/" !== n.path[n.path.length - 1] && (n.path += "/"),
                void 0 === n.secure && n.host !== s.util.CLOUD_HOST
                  ? (n.secure = s.util.isSecure())
                  : n.host == s.util.CLOUD_HOST && (n.secure = !0),
                n.logFunction && c.default.setLogFunction(n.logFunction),
                (c.default.logLevel = n.debug),
                s.util.supports.audioVideo || s.util.supports.data
                  ? s.util.validateId(e)
                    ? ((r._api = new p.API(n)),
                      r._initializeServerConnection(),
                      e
                        ? r._initialize(e)
                        : r._api
                            .retrieveId()
                            ...
                            .catch(function (e) {
                              return r._abort(u.PeerErrorType.ServerError, e);
                            }),
                      r)
                    : (r._delayedAbort(
            ...
            return (
              ...
              (i.prototype._initializeServerConnection = function () {
                var e = this;
                (this._socket = new a.Socket(
                  ...
                  this.socket.on(u.SocketEventType.Message, function (t) {
                    e._handleMessage(t);
                  }),
                  this.socket.on(u.SocketEventType.Error, function (t) {
                    e._abort(u.PeerErrorType.SocketError, t);
                  }),
                  this.socket.on(u.SocketEventType.Disconnected, function () {
                    e.disconnected ||
                      (e.emitError(
                  ...
                  this.socket.on(u.SocketEventType.Close, function () {
                    e.disconnected ||
                      e._abort(
              ...
              (i.prototype._handleMessage = function (e) {
                ...
                switch (o) {
                  ...
                  case u.ServerMessageType.Leave:
                    c.default.log("Received leave message from", s),
                      this._cleanupPeer(s),
              ...
              (i.prototype._abort = function (e, t) {
                c.default.error("Aborting!"),
                  this._lastServerId ? this.disconnect() : this.destroy(),
                  this.emitError(e, t);
              }),
              (i.prototype.emitError = function (e, t) {
                c.default.error("Error:", t),
                  "string" == typeof t && (t = new Error(t)),
                  (t.type = e),
                  this.emit(u.PeerEventType.Error, t);
              }),
              (i.prototype.destroy = function () {
                this.destroyed ||
                  (this._cleanup(), this.disconnect(), (this._destroyed = !0));
              }),
              ...
              (i.prototype.disconnect = function () {
                ...
                setTimeout(function () {
                  e.disconnected ||
                    ...
                    e.emit(u.PeerEventType.Disconnected, e.id),
