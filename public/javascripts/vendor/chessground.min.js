  ...
  var t = e(function (e, t) {
    ...
    o = e(function (e, o) {
      Object.defineProperty(o, "__esModule", { value: !0 }),
        (o.createEl = o.isRightButton = o.eventPosition = o.setVisible = o.translateRel = o.translateAbs = o.posToTranslateRel = o.posToTranslateAbs = o.samePiece = o.distanceSq = o.opposite = o.timer = o.memo = o.allPos = o.key2pos = o.pos2key = o.allKeys = o.invRanks = void 0),
        (o.invRanks = ["8", "7", "6", "5", "4", "3", "2", "1"]),
        (o.allKeys = Array.prototype.concat(
          ...t.files.map(e => t.ranks.map(t => e + t)),
        )),
        (o.pos2key = e => o.allKeys[8 * e[0] + e[1]]),
        (o.key2pos = e => [e.charCodeAt(0) - 97, e.charCodeAt(1) - 49]),
        (o.allPos = o.allKeys.map(o.key2pos)),
        (o.memo = function (e) {
          let t;
    ...
    n = e(function (e, t) {
      ...
      const r = (e, t, o, r) => n(e, o) === n(t, r),
        s = (e, t, o, n) => e === o || t === n;
      (t.queen = (e, t, o, n) => r(e, t, o, n) || s(e, t, o, n)),
        (t.premove = function (e, i, a) {
          const c = e.get(i);
          if (!c) return [];
          const l = o.key2pos(i),
            d = c.role,
          ...
          return o.allPos
            .filter(
              e =>
                (l[0] !== e[0] || l[1] !== e[1]) && u(l[0], l[1], e[0], e[1]),
            )
            .map(o.pos2key);
        });
    }),
    r = e(function (e, t) {
      ...
      function r(e) {
        requestAnimationFrame(() => {
          ...
          if (t) {
            const o = a.getKeyAtDomPos(t.pos, a.whitePov(e), e.dom.bounds());
            o || (t.snapToValidMove = !1);
            const n = t.snapToValidMove
              ? a.getSnappedKeyAtDomPos(
                  t.orig,
                  t.pos,
                  a.whitePov(e),
                  e.dom.bounds(),
      ...
      function i(e) {
        var t;
        const r = (e.shiftKey || e.ctrlKey) && o.isRightButton(e),
          s =
            e.altKey ||
            e.metaKey ||
      ...
      (t.start = function (e, t) {
        ...
        t.stopPropagation(),
          t.preventDefault(),
          t.ctrlKey ? a.unselect(e) : a.cancelMove(e);
        const n = o.eventPosition(t),
          s = a.getKeyAtDomPos(n, a.whitePov(e), e.dom.bounds());
        s &&
          ((e.drawable.current = {
            orig: s,
            pos: n,
    ...
    i = e(function (e, t) {
          ...
          if (s && o.samePiece(s, r.piece)) {
            if (
              ...
              o.translateAbs(r.element, [
                r.pos[0] - t.left - t.width / 16,
                r.pos[1] - t.top - t.height / 16,
              ]);
            }
          } else i(e);
          n(e);
      ...
      function l(e, t, n) {
        const r = o.key2pos(e);
        return (
          t || ((r[0] = 7 - r[0]), (r[1] = 7 - r[1])),
          [
            n.left + (n.width * r[0]) / 8 + n.width / 16,
            n.top + (n.height * (7 - r[1])) / 8 + n.height / 16,
          ]
        );
      }
      function d(e, t) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.start = function (e, t) {
          ...
          if (t.touches && t.touches.length > 1) return;
          const i = e.dom.bounds(),
            c = o.eventPosition(t),
            u = a.getKeyAtDomPos(c, a.whitePov(e), i);
          if (!u) return;
          ...
          f ||
            ...
            !1 === t.cancelable ||
              (t.touches &&
                ...
                !f &&
                !(function (e, t) {
                  const n = a.whitePov(e),
                    r = e.dom.bounds(),
                    s = Math.pow(r.width / 8, 2);
                  for (const i in e.pieces) {
                    const e = l(i, n, r);
                    if (o.distanceSq(e, t) <= s) return !0;
                  }
                  return !1;
                })(e, c)) ||
              t.preventDefault();
          ...
          (e.stats.ctrlKey = t.ctrlKey),
            e.selected && a.canMove(e, e.selected, u)
              ? s.anim(e => a.selectSquare(e, u), e)
              : a.selectSquare(e, u);
          const m = e.selected === u,
            h = d(e, u);
          if (p && h && m && a.isDraggable(e, u)) {
            (e.draggable.current = {
              orig: u,
              piece: p,
              origPos: c,
            ...
            r &&
              ((r.className = `ghost ${p.color} ${p.role}`),
              o.translateAbs(
                r,
                o.posToTranslateAbs(i)(o.key2pos(u), a.whitePov(e)),
              ),
              o.setVisible(r, !0)),
              n(e);
          } else g && a.unsetPremove(e), v && a.unsetPredrop(e);
          e.dom.redraw();
        }),
        ...
        (t.end = function (e, t) {
          ...
          a.unsetPremove(e), a.unsetPredrop(e);
          const r = o.eventPosition(t) || n.pos,
            s = a.getKeyAtDomPos(r, a.whitePov(e), e.dom.bounds());
          s && n.started && n.orig !== s
            ? n.newPiece
              ? a.dropNewPiece(e, n.orig, s, n.force)
              : ((e.stats.ctrlKey = t.ctrlKey),
                a.userMove(e, n.orig, s) && (e.stats.dragged = !0))
            : n.newPiece
            ? e.pieces.delete(n.orig)
            : e.draggable.deleteOnDropOff &&
              !s &&
              (e.pieces.delete(n.orig), a.callUserFunction(e.events.change)),
            ((n.orig !== n.previouslySelected || (n.orig !== s && s)) &&
    ...
    a = e(function (e, t) {
        ...
        if (v(e, t, o)) {
          ...
          (function (e, t, o) {
            return (
              t !== o &&
              m(e, t) &&
              n.premove(e.pieces, t, e.premovable.castle).includes(o)
            );
          })(e, t, o)
        )
          return (
      ...
      function p(e, t) {
        (e.selected = t),
          m(e, t)
            ? (e.premovable.dests = n.premove(e.pieces, t, e.premovable.castle))
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.dropNewPiece = function (e, t, o, n) {
          ...
          ((function (e, t, o) {
            ...
            ? (e.pieces.delete(t),
              l(e, i, o, n),
              r(e.movable.events.afterNewPiece, i.role, o, { predrop: !1 }))
            : i &&
              (function (e, t, o) {
                const n = e.pieces.get(t),
                  r = e.pieces.get(o);
        ...
        (t.selectSquare = function (e, t, o) {
          ...
          (g(e, t) || m(e, t)) && (p(e, t), e.hold.start());
        }),
        (t.setSelected = p),
        (t.unselect = f),
        (t.canMove = v),
        ...
        (t.playPredrop = function (e, t) {
          ...
          if (!o) return !1;
          if (t(o)) {
            l(e, { role: o.role, color: e.movable.color }, o.key) &&
        ...
        (t.getKeyAtDomPos = function (e, t, n) {
          ...
          t || (r = 7 - r);
          let s = 7 - Math.floor((8 * (e[1] - n.top)) / n.height);
          return (
            t || (s = 7 - s),
            r >= 0 && r < 8 && s >= 0 && s < 8 ? o.pos2key([r, s]) : void 0
          );
        }),
        (t.getSnappedKeyAtDomPos = function (e, t, r, s) {
          const a = o.key2pos(e),
            c = o.allPos.filter(
              e =>
                n.queen(a[0], a[1], e[0], e[1]) ||
                n.knight(a[0], a[1], e[0], e[1]),
            ),
            l = c
              .map(e => i.computeSquareCenter(o.pos2key(e), r, s))
              .map(e => o.distanceSq(t, e)),
            [, d] = l.reduce((e, t, o) => (e[0] < t ? e : [t, o]), [l[0], 0]);
          return o.pos2key(c[d]);
        }),
    ...
    c = e(function (e, n) {
      Object.defineProperty(n, "__esModule", { value: !0 }),
        ...
        (n.initial = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR");
      const r = {
          p: "pawn",
          r: "rook",
          n: "knight",
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.configure = function (e, t) {
          ...
          if (
            ...
            t.fen && ((e.pieces = c.read(t.fen)), (e.drawable.shapes = [])),
            t.hasOwnProperty("check") && a.setCheck(e, t.check || !1),
            t.hasOwnProperty("lastMove") && !t.lastMove
              ? (e.lastMove = void 0)
              : t.lastMove && (e.lastMove = t.lastMove),
            e.selected && a.setSelected(e, e.selected),
    ...
    u = e(function (e, t) {
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.start = function (e, t) {
          function o() {
            a.toggleOrientation(e), t();
          }
          return {
            set(t) {
              t.orientation && t.orientation !== e.orientation && o(),
                (t.fen ? s.anim : s.render)(e => l.configure(e, t), e);
            },
            state: e,
            getFen: () => c.write(e.pieces),
            toggleOrientation: o,
            setPieces(t) {
              s.anim(e => a.setPieces(e, t), e);
            },
            selectSquare(t, o) {
              t
                ? s.anim(e => a.selectSquare(e, t, o), e)
                : e.selected && (a.unselect(e), e.dom.redraw());
            },
            move(t, o) {
              s.anim(e => a.baseMove(e, t, o), e);
            },
            newPiece(t, o) {
              s.anim(e => a.baseNewPiece(e, t, o), e);
            },
            playPremove() {
              if (e.premovable.current) {
                if (s.anim(a.playPremove, e)) return !0;
                e.dom.redraw();
              }
              return !1;
            },
            playPredrop(t) {
              if (e.predroppable.current) {
                const o = a.playPredrop(e, t);
                return e.dom.redraw(), o;
              }
              return !1;
            },
            cancelPremove() {
              s.render(a.unsetPremove, e);
            },
            cancelPredrop() {
              s.render(a.unsetPredrop, e);
            },
            cancelMove() {
              s.render(e => {
                a.cancelMove(e), i.cancel(e);
              }, e);
            },
            stop() {
              s.render(e => {
            ...
            setAutoShapes(t) {
              s.render(e => (e.drawable.autoShapes = t), e);
            },
            setShapes(t) {
              s.render(e => (e.drawable.shapes = t), e);
            },
            getKeyAtDomPos: t =>
              a.getKeyAtDomPos(t, a.whitePov(e), e.dom.bounds()),
            redrawAll: t,
            dragNewPiece(t, o, n) {
              i.dragNewPiece(e, t, o, n);
            },
            destroy() {
              a.stop(e), e.dom.unbind && e.dom.unbind(), (e.dom.destroyed = !0);
            },
          };
        });
    }),
      ...
      Object.defineProperty(n, "__esModule", { value: !0 }),
        ...
        (n.renderWrap = function (e, n, s) {
          ...
          if (
            ...
            n.drawable.visible &&
              !s &&
              ((l = f.createElement("svg")),
              l.appendChild(f.createElement("defs")),
              a.appendChild(l)),
            n.coordinates)
          ) {
            const e = "black" === n.orientation ? " black" : "";
            a.appendChild(r(t.ranks, "ranks" + e)),
              a.appendChild(r(t.files, "files" + e));
          }
          return (
    ...
    v = e(function (e, t) {
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.setDropMode = function (e, t) {
          (e.dropmode = { active: !0, piece: t }), i.cancel(e);
        }),
        ...
        (t.drop = function (e, t) {
          ...
          if (n) {
            e.pieces.set("a0", n);
            const r = o.eventPosition(t),
              s = r && a.getKeyAtDomPos(r, a.whitePov(e), e.dom.bounds());
            s && a.dropNewPiece(e, "a0", s);
          }
          e.dom.redraw();
        });
    }),
          ...
          const s = (function (e) {
            return t => {
              e.draggable.current
                ...
                ? e.drawable.enabled && r.start(e, t)
                : e.viewOnly ||
                  (e.dropmode.active ? v.drop(e, t) : i.start(e, t));
            };
          })(e);
          n.addEventListener("touchstart", s, { passive: !1 }),
            n.addEventListener("mousedown", s, { passive: !1 }),
        ...
        (t.bindDocument = function (e, t) {
          ...
          if (
            (e.dom.relative ||
              ...
              o.push(n(document.body, "chessground.resize", t)),
            !e.viewOnly)
          ) {
            const t = s(e, i.move, r.move),
              a = s(e, i.end, r.end);
            for (const e of ["touchmove", "mousemove"])
              o.push(n(document, e, t));
            for (const e of ["touchend", "mouseup"]) o.push(n(document, e, a));
            const c = () => e.dom.bounds.clear();
            o.push(n(document, "scroll", c, { capture: !0, passive: !0 })),
              o.push(n(window, "resize", c, { passive: !0 }));
          }
    ...
    h = e(function (e, t) {
      ...
      (t.render = function (e) {
        const t = a.whitePov(e),
          ...
          h = m ? m.plan.anims : new Map(),
          b = m ? m.plan.fadings : new Map(),
          w = e.draggable.current,
          y = (function (e) {
            var t;
            const o = new Map();
            if (e.lastMove && e.highlight.lastMove)
              for (const s of e.lastMove) d(o, s, "last-move");
            ...
            if (n) for (const s of n) d(o, s, "current-premove");
            else
              e.predroppable.current &&
                d(o, e.predroppable.current.key, "current-premove");
            const r = e.exploding;
            if (r) for (const s of r.keys) d(o, s, "exploding" + r.stage);
            return o;
          })(e),
          P = new Set(),
          k = new Set(),
        ...
        for (const [n, r] of v)
          if (((O = h.get(n)), !P.has(n)))
            if (((x = M.get(l(r))), (_ = x && x.pop()), _)) {
              (_.cgKey = n),
                _.cgFading && (_.classList.remove("fading"), (_.cgFading = !1));
              const r = o.key2pos(n);
              e.addPieceZIndex && (_.style.zIndex = c(r, t)),
                O &&
                  ((_.cgAnimating = !0),
                  _.classList.add("anim"),
                  (r[0] += O[2]),
                  (r[1] += O[3])),
                f(_, p(r, t));
            } else {
              ...
              (i.cgPiece = s),
                (i.cgKey = n),
                O && ((i.cgAnimating = !0), (a[0] += O[2]), (a[1] += O[3])),
                f(i, p(a, t)),
                e.addPieceZIndex && (i.style.zIndex = c(a, t)),
                g.appendChild(i);
            }
        for (const o of M.values()) i(e, o);
        for (const o of C.values()) i(e, o);
      }),
        (t.updateBounds = function (e) {
          if (e.dom.relative) return;
          const t = a.whitePov(e),
            i = n.posToTranslateAbs(e.dom.bounds());
          let c = e.dom.elements.board.firstChild;
          for (; c; )
            ((r(c) && !c.cgAnimating) || s(c)) &&
              n.translateAbs(c, i(o.key2pos(c.cgKey), t)),
              (c = c.nextSibling);
        });
    });
  return e(function (e, t) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.Chessground = function (e, t) {
        const r = p.defaults();
        function s() {
          const t = "dom" in r ? r.dom.unbind : void 0,
            s = r.viewOnly && !r.drawable.visible,
            i = g.renderWrap(e, r, s),
            a = o.memo(() => i.board.getBoundingClientRect()),
            c = e => {
              h.render(d), !e && i.svg && f.renderSvg(d, i.svg);
            },
            l = () => {
              a.clear(), h.updateBounds(d), i.svg && f.renderSvg(d, i.svg);
            },
            d = r;
          return (
            (d.dom = {
            ...
            (d.drawable.prevSvgHash = ""),
            c(!1),
            m.bindBoard(d, l),
            t || (d.dom.unbind = m.bindDocument(d, l)),
            d.events.insert && d.events.insert(i),
            d
          );
        }
        return l.configure(r, t || {}), u.start(s(), s);
      });
  }).Chessground;
})();
