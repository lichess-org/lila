function loadShepherd(f) {
  if (typeof Shepherd === "undefined" || Shepherd.activeTour === null) {
    var theme =
      "shepherd-theme-" + ($("body").hasClass("dark") ? "default" : "dark");
    lishogi.loadCss("vendor/shepherd/dist/css/" + theme + ".css");
    lishogi.loadCss("stylesheets/shepherd.css");
    lishogi
      .loadScript("vendor/shepherd/dist/js/tether.js", { noVersion: true })
      .done(function () {
        lishogi
...
lishogi.studyTour = function (study) {
  loadShepherd(function (theme) {
    ...
    [
      {
        title: "Welcome to lishogi study!",
        text:
      ...
      },
      {
        ...
        text:
          "Other members can see your moves in real time!<br>" +
      ...
      study.isOwner
        ? {
            ...
            text:
              "By clicking the <i data-icon='O'></i> button.<br>" +
        ...
        : null,
      {
        ...
        text:
          ...
          // "There is also a <a href='//lishogi.org/blog/V0KrLSkAAMo3hsi4/study-shogi-the-lishogi-way'>blog post about studies</a>.<br>" +
