  ...
  loadShepherd(function (theme) {
    ...
    [
      ...
      },
      {
        ...
        text:
          "Just a board setup for a new game.<br>" +
      ...
      },
      {
        ...
        text:
          "Paste a lishogi game URL<br>" +
          "(like lishogi.org/7fHIU0XI)<br>" +
      ...
      },
      {
        ...
        text:
          "Yes, you can study crazyhouse,<br>" + "and all lishogi variants!",
