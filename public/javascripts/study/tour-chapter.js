  ...
  loadShepherd(function (theme) {
    ...
    [
      ...
      },
      {
        ...
        attachTo: '.dialog-content .tabs-horiz .game top',
        when: onTab('game'),
      },
      {
      ...
      },
      {
        ...
        attachTo: '.dialog-content .help bottom',
      },
    ].forEach(function (s) {
