...
/* hoverIntent v1.8.1 // 2014.08.11 // jQuery v1.9.1+ // hacked for cash.js */
(function(c){"function"===typeof define&&define.amd?define(["cash"],c):$&&!$.fn.hoverIntent&&c($)})(function(c){var n={interval:100,sensitivity:6,timeout:0},p=0,d,k,l=function(b){d=b.pageX;k=b.pageY},m=function(b,c,a,f){if(Math.sqrt((a.pX-d)*(a.pX-d)+(a.pY-k)*(a.pY-k))<f.sensitivity)return c.off("mousemove.hoverIntent"+a.namespace,l),delete a.timeoutId,a.isActive=!0,delete a.pX,delete a.pY,f.over.apply(c[0],[b]);a.pX=d;a.pY=k;a.timeoutId=setTimeout(function(){m(b,c,a,f)},f.interval)};
