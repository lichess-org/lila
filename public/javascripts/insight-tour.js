lishogi = lishogi || {};
lishogi.startInsightTour = function () {
  lishogi.hopscotch(function () {
    var tour = {
      id: "insights",
      showPrevButton: true,
      steps: [
        ...
        },
        {
          ...
          content:
            "Here are a few example questions you can ask. Try clicking them!",
          target: "#insight .panel-tabs a.preset",
          placement: "top",
          yOffset: 10,
          onShow: function () {
            lishogi.insight.setPanel("preset");
          },
        },
        {
          title: "Answers are graphs",
          content:
            "Colorful bars represent the answer to the question posed.<br>" +
        ...
        },
        {
          ...
          content:
            "This table provides an alternative way to read the answer.<br>" +
        ...
        },
        {
          ...
          content:
            "To ask your own questions, start by selecting a metric.<br>" +
            "For instance, let's ask a question about move times.",
          target: "#insight div.ms.metric",
          placement: "left",
          onShow: function () {
            lishogi.insight.clearFilters();
            lishogi.insight.setPanel("filter");
          },
        },
        {
          title: "Ask a question: dimension",
          content:
            "Now select a dimension to compare move times with.<br>" +
        ...
        },
        {
          ...
          content:
            "Make your question more precise by filtering the results.<br>" +
        ...
        },
        {
          ...
          content:
            "Now be inventive and find the right questions to ask!<br>" +
        ...
        },
        {
          ...
          content:
            "By default, your data is visible to your lishogi friends only.<br>" +
...
$(function () {
  if (lishogi.once("insight-tour")) setTimeout(lishogi.startInsightTour, 1000);
});
