...
val fromProd = """d4 Nf6 c4 e6 Nc3 Bb4 Bd2 O-O Nf3 c6 e4 Qa5 Be2 Kh8 O-O h5 Ne5 h4 h3 Be7 Nd5 Qd8 Nxe7 d6 Ne7g6+"""
  ...
  "only raw moves" should {
    ...
    "example from prod" in {
      PgnReader(fromProd) must beSuccess
    }
  }
