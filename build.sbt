...
lazy val allModules = Seq(commonM, dbM, memoM, hubM, i18nM, socketM, ratingM, userM, oauthM, securityM, prefM, chatM, relationM, gameM, shutupM, notifyM, treeM, historyM, msgM, analyseM, puzzleM, evalCacheM, roomM, playbanM, fishnetM, roundM, evaluationM, simulM, perfStatM, reportM, tournamentM, importerM, modM, studyM, teamM, searchM, forumM, practiceM, challengeM, timelineM, teamSearchM, botM, bookmarkM, planM, coachM, streamerM, studySearchM, forumSearchM, lobbyM, tvM, videoM, activityM, appealM, stormM, clasM, coordinateM, gameSearchM, pushM, blogM, apiM, setupM, eventM, learnM)
...
lazy val modM = module("mod", Seq(tournamentM, reportM, perfStatM, simulM, evaluationM))
...
lazy val apiM = module("api", Seq(lobbyM, timelineM, forumSearchM, studySearchM, streamerM, coachM, planM, bookmarkM, botM, teamSearchM, challengeM))
lazy val blogM = module("blog", Seq(timelineM))
...
lazy val fishnetM = module("fishnet", Seq(evalCacheM, puzzleM, analyseM))
...
lazy val ratingM = module("rating", Seq(memoM, i18nM))
