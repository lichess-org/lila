...
lazy val i18n = module("i18n",
  ...
  Compile / sourceGenerators += Def.task {
    MessageCompiler(
      ...
      dbs = "site arena emails learn activity coordinates study class contact patron coach broadcast streamer tfa settings preferences team perfStat search tourname faq lag swiss puzzle puzzleTheme challenge storm ublog insight keyboardMove timeago oauthScope dgt nvui".split(' ').toList,
