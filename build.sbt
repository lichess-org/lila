...
lazy val i18n = module("i18n",
  ...
  Compile / resourceGenerators += Def.task {
    I18n.serialize(
      ...
      dbs = """site arena emails learn activity coordinates study class contact appeal patron
        coach broadcast streamer tfa settings preferences team perfStat search tourname faq
        lag swiss puzzle puzzleTheme challenge storm ublog insight keyboardMove timeago oauthScope
        dgt voiceCommands onboarding features nvui video variant localAnalysis""".split("\\s+").toList,
