          ...
          h("div", [
            h(
              ...
              [
                ...
                optgroup(
                  ctrl.trans.noarg("popularOpenings"),
                  ctrl.cfg.positions.map(position2option),
                ),
              ],
            ),
          ]),
      ...
      h("div.castling", [
        ...
        h("div", [
          castleCheckBox(
            ctrl,
            "K",
            ctrl.trans.noarg("whiteCastlingKingside"),
        ...
        h("div", [
          castleCheckBox(
            ctrl,
            "k",
            ctrl.trans.noarg("blackCastlingKingside"),
            !!ctrl.options.inlineCastling,
          ),
          castleCheckBox(ctrl, "q", "O-O-O", true),
        ]),
            ...
            h(
              "select",
              {
                ...
                on: {
                  change(e) {
                    ctrl.setRules(
                      (e.target as HTMLSelectElement).value as Rules,
                    );
                  },
                },
              },
