...
const glyphProperties = (node: Tree.NodeBase): { advice?: Advice; color?: string } => {
...
function christmasTree(chart: AcplChart, mainline: Tree.NodeBase[], hoverColors: string[]) {
