...
export type SquareName = 'a1' | 'b1' | 'c1' | 'd1' | 'e1' | 'f1' | 'g1' | 'h1' | 'i1' |
...
export type Role = 'pawn' | 'lance' | 'knight' | 'silver' | 'gold' | 'bishop' | 'rook' | 'king' | 'promotedLance' | 'promotedKnight' | 'promotedSilver' | 'horse' | 'dragon' | 'tokin';
