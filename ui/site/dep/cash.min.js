...
function Ea(a){return a.multiple&&a.options?O(y.call(a.options,function(a){return a.selected&&!a.disabled&&!a.parentNode.disabled}),"value"):a.value||""}G.val=function(a){return arguments.length?this.each(function(b,c){if((b=c.multiple&&c.options)||checkableRe.test(c.type)){var d=ba(a)?ea.call(a,String):null===a?[]:[String(a)];b?J(c.options,function(a,b){b.selected=0<=d.indexOf(b.value)},!0):c.checked=0<=d.indexOf(c.value)}else c.value=void 0===a||null===a?"":a}):this[0]&&Ea(this[0])};
G.clone=function(){return this.map(function(a,b){return b.cloneNode(!0)})};G.detach=function(a){M(this,a).each(function(a,c){c.parentNode&&c.parentNode.removeChild(c)});return this};var Ia=/^\s*<(\w+)[^>]*>/,Ja=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,Ka={"*":u,tr:aa,td:w,th:w,thead:v,tbody:v,tfoot:v};function na(a){if(!E(a))return[];if(Ja.test(a))return[t(RegExp.$1)];var b=Ia.test(a)&&RegExp.$1;b=Ka[b]||Ka["*"];b.innerHTML=a;return H(b.childNodes).detach().get()}H.parseHTML=na;
...
G.children=function(a){return M(H(P(O(this,function(a){return a.children}))),a)};G.contents=function(){return H(P(O(this,function(a){return"IFRAME"===a.tagName?[a.contentDocument]:"TEMPLATE"===a.tagName?a.content.childNodes:a.childNodes})))};G.find=function(a){return H(P(O(this,function(b){return A(a,b)})))};var La=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,Ma=/^$|^module$|\/(java|ecma)script/i,Na=["type","src","nonce","noModule"];
function Oa(a,b){a=H(a);a.filter("script").add(a.find("script")).each(function(a,d){if(Ma.test(d.type)&&p.contains(d)){var c=t("script");c.text=d.textContent.replace(La,"");J(Na,function(a,b){d[b]&&(c[b]=d[b])});b.head.insertBefore(c,null);b.head.removeChild(c)}})}
function Z(a,b,c,d,h,f,q,r){J(a,function(a,f){J(H(f),function(a,f){J(H(b),function(b,k){var l=c?k:f;b=c?a:b;k=c?f:k;l=b?l.cloneNode(!0):l;b=!b;h?k.insertBefore(l,d?k.firstChild:null):k.parentNode.insertBefore(l,d?k:k.nextSibling);b&&Oa(l,k.ownerDocument)},r)},q)},f);return b}G.after=function(){return Z(arguments,this,!1,!1,!1,!0,!0)};G.append=function(){return Z(arguments,this,!1,!1,!0)};G.appendTo=function(a){return Z(arguments,this,!0,!1,!0)};G.before=function(){return Z(arguments,this,!1,!0)};
