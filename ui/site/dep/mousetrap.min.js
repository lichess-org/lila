    ...
    return (
      r ||
        (r = (function () {
          if (!e)
            for (var n in ((e = {}), t))
              (n > 95 && n < 112) || (t.hasOwnProperty(n) && (e[t[n]] = n));
          return e;
        })()[n]
          ? "keydown"
          : "keypress"),
      "keypress" == r && a.length && (r = "keydown"),
      r
    );
  }
  function s(e, t) {
    ...
    for (
      ...
      (r = n[o]), a[r] && (r = a[r]), i(r) && s.push(r);
    return { key: r, modifiers: s, action: (t = c(r, s, t)) };
  }
  function l(e) {
    var t = this;
    ...
    function h(e, n, r, o, c, s) {
      ...
      for (
        ...
        if (
          ((u = t._callbacks[e][l]),
          (o || !u.seq || a[u.seq] == u.level) &&
            y == u.action &&
            (("keypress" == y && !r.metaKey && !r.ctrlKey) ||
              ((f = n),
              (h = u.modifiers),
              f.sort().join(",") === h.sort().join(","))))
        ) {
          var d = !o && u.combo == c,
    ...
    function m(e, n, a, r, o) {
      ...
      c.length > 1
        ...
        : ((i = s(e, a)),
          ...
          h(i.key, i.modifiers, { type: i.action }, r, e, o),
          t._callbacks[i.key][r ? "unshift" : "push"]({
            callback: n,
    ...
    (t._handleKey = function (e, t, n) {
      ...
      e.addEventListener("keypress", y),
      e.addEventListener("keydown", y),
      e.addEventListener("keyup", y);
  }
  (l.prototype.bind = function (e, t, n) {
    return (
      this._bindMultiple.call(this, e instanceof Array ? e : [e], t, n), this
    );
  }),
