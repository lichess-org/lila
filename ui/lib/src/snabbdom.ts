...
export type LooseVNode = VNode | string | number | String | Number | undefined | null | boolean;
export type LooseVNodes = LooseVNode[];
export type VNodeKids = LooseVNode | LooseVNodes;

// TODO - add || x === 0 to kidFilter (allow 0 as a valid kid), and fix any issues
...
// Allows looseH('div', [ kids && h('div', 'kid') ]) instead of h('div', [ isKid ? h('div', 'kid') : null ])
