...
const GOOGLY_EYE_LAYOUTS: Record<string, GooglyEyeLayout> = {
  ...
  kosal: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
  leipzig: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
  fantasy: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
  spatial: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
  celtic: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
  california: { eyeX: -2, eyeY: -15, eyeSpacing: 15 },
  caliente: { eyeX: -2, eyeY: -15, eyeSpacing: 15 },
  pixel: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
  firi: { eyeX: -10, eyeY: -8, eyeSpacing: 15 },
  rhosgfx: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
  maestro: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
  fresca: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
  cardinal: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
  ...
  xkcd: { eyeX: -10, eyeY: -15, eyeSpacing: 15 },
