/*import { MaybeVNodes, onInsert, VNode, looseH as h } from 'common/snabbdom';
...
function playerView(ctrl: SetupCtrl): VNode {
  ...
  return h('div.players', [player('white'), player('black')]);
}
class BotDeck {
  bots: Libots;
