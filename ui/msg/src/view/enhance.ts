...
const themes = ['blue', 'blue2', 'blue3', 'canvas', 'wood', 'wood2', 'wood3', 'wood4', 'maple', 'brown', 'leather', 'green', 'marble', 'green-plastic', 'grey', 'metal', 'olive', 'newspaper', 'purple', 'purple-diag', 'pink', 'ic'];

function configureSrc(url: string): string {
  if (url.includes('://')) return url;
  const parsed = new URL(url, window.location.href);
  parsed.searchParams.append('theme', themes.find(theme =>
