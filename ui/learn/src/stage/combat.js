...
module.exports = {
  ...
  levels: [{ // rook
    ...
    goal: 'takeTheBlackPiecesAndDontLoseYours',
    fen: '2r5/8/3b4/2P5/8/1P6/2B5/8 b -',
    nbMoves: 4,
    captures: 2,
    success: assert.extinct('black')
  }, {
    goal: 'takeTheBlackPiecesAndDontLoseYours',
    fen: '1r6/8/5n2/3P4/4P1P1/1Q6/8/8 b -',
    nbMoves: 4,
    captures: 2,
    success: assert.extinct('black')
  }, {
    goal: 'takeTheBlackPiecesAndDontLoseYours',
    fen: '2r5/8/3N4/5b2/8/8/PPP5/8 b -',
    nbMoves: 4,
    captures: 2,
    success: assert.extinct('black')
  }, {
    goal: 'takeTheBlackPiecesAndDontLoseYours',
    fen: '8/6q1/8/4P1P1/8/4B3/r2P2N1/8 b -',
    nbMoves: 8,
    captures: 2,
    success: assert.extinct('black')
  }].map(function(l, i) {
