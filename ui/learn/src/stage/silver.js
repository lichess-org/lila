...
module.exports = {
  ...
  levels: [
    ...
    {
      goal: 'grabAllTheStars',
      fen: '9/9/9/4S4/9/9/9/9/9 b -',
      apples: 'f5 e4 d3 e2 f1',
      nbMoves: 5,
    },
    {
      goal: 'theFewerMoves',
      fen: '9/9/9/9/3S5/6S2/9/9/9 b -',
      apples: 'd4 d3 e4 g5 h4',
      nbMoves: 5,
    },
    {
      goal: 'silverPromotion',
      fen: '9/9/9/6S2/9/9/9/9/9 b -',
      apples: 'e6 f6 f7',
      nbMoves: 3,
    },
    {
      ...
      apples: 'e6',
      nbMoves: 2,
      shapes: [circle('e5'), circle('f5'), circle('d5'), circle('d3'), circle('f3')],
    },
    {
      goal: 'psilverSummary',
      fen: '9/9/9/9/9/4+S4/9/9/9 b -',
      apples: 'e6',
      nbMoves: 2,
