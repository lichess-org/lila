...
module.exports = {
  ...
  levels: [
    {
      goal: 'castleKingSide',
      fen: 'rnbqkbnr/pppppppp/8/8/2B5/4PN2/PPPP1PPP/RNBQK2R b KQkq -',
      nbMoves: 1,
      shapes: [arrow('e1g1')],
    ...
    },
    {
      ...
      fen: 'rnbqkbnr/pppppppp/8/8/4P3/1PN5/PBPPQPPP/R3KBNR b KQkq -',
      nbMoves: 1,
      shapes: [arrow('e1c1')],
    ...
    },
    {
      ...
      fen: 'rnbqkbnr/pppppppp/8/8/8/4P3/PPPPBPPP/RNBQK1NR b KQkq -',
      nbMoves: 2,
    ...
    },
    {
      ...
      fen: 'rnbqkbnr/pppppppp/8/8/3P4/1PN1PN2/PBPQBPPP/R3K1R1 b Qkq -',
      nbMoves: 1,
    ...
    },
    {
      ...
      fen: 'rn1qkbnr/ppp1pppp/3p4/8/2b5/4PN2/PPPP1PPP/RNBQK2R b KQkq -',
      nbMoves: 2,
    ...
    },
    {
      ...
      fen: 'rnb2rk1/pppppppp/8/8/8/4Nb1n/PPPP1P1P/RNB1KB1R b KQkq -',
      nbMoves: 2,
      shapes: [arrow('e1g1')],
      success: castledKingSide,
      failure: cantCastleKingSide,
    ...
    },
    {
      ...
      fen: '1r1k2nr/p2ppppp/7b/7b/4P3/2nP4/P1P2P2/RN2K3 b Q -',
      nbMoves: 4,
      shapes: [arrow('e1c1')],
      success: castledQueenSide,
      failure: cantCastleQueenSide,
