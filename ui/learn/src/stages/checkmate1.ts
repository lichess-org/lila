...
const levels: IncompleteLevel[] = [
  ...
  {
    goal: i18n('learn:dropsCommonDeliverMate'),
  ...
  {
    goal: i18n('learn:chooseYourPieceCarefully'),
  ...
  {
    // pawn
    goal: i18n('learn:mateWithADroppedPawnIs'),
  ...
  {
    // pawn 2
    goal: i18n('learn:mateWithAPushedPawnIs'),
