...
module.exports = function (data, el) {
  util.requestAnimationFrame(function () {
    ...
    const japaneseNotation = ['九', '八', '七', '六', '五', '四', '三', '二', '一'];
    coords.appendChild(renderCoords(data.notation === 0 ? westernNotation : japaneseNotation, 'ranks' + orientClass));
    coords.appendChild(renderCoords(['9', '8', '7', '6', '5', '4', '3', '2', '1'], 'files' + orientClass));
  ...
  return function (o) {
    ...
    for (var i = 0; i < coords.length; ++i) coords[i].classList.toggle('gote', o === 'gote');
  };
};
