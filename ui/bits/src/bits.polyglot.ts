...
import { PolyglotBook } from './exports/types';

export default function initModule(bytes: DataView): PolyglotBook {
  const book = new Map<bigint, { uci: Uci; weight: number }[]>();
...
const rolodex = {
  pawn: { white: 1, black: 0 },
  knight: { white: 3, black: 2 },
  bishop: { white: 5, black: 4 },
  rook: { white: 7, black: 6 },
  queen: { white: 9, black: 8 },
  king: { white: 11, black: 10 },
};
