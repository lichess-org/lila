...
const lexicon: Token[] = [
  ...
  { in: 'takeback', out: 'takeback', tags: ['move', 'rounds', 'exact'] },
  { in: 'draw', out: 'draw', tags: ['move', 'rounds', 'exact'] },
  { in: 'offer draw', out: 'draw', tags: ['move', 'rounds', 'exact'] },
  { in: 'accept draw', out: 'draw', tags: ['move', 'rounds', 'exact'] },
  { in: 'resign', out: 'resign', tags: ['move', 'rounds', 'exact'] },
