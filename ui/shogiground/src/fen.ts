...
const roles: { [letter: string]: cg.Role } = {
  'p': 'pawn', 'l': 'lance', 'n': 'knight', 's': 'silver', 'g': 'gold', 'b': 'bishop', 'r': 'rook', 'k': 'king',
  '+p': 'tokin', 't': 'tokin', '+l': 'promotedLance', 'u': 'promotedLance', '+n': 'promotedKnight', 'm': "promotedKnight",
  '+s': 'promotedSilver', 'a': 'promotedSilver', '+b': 'horse', 'h': 'horse', '+r': 'dragon', 'd': 'dragon'
};

const letters = {
  pawn: 'p', lance: 'l', knight: 'n', silver: 's', gold: 'g', bishop: 'b', rook: 'r', king: 'k',
  tokin: 't', promotedLance: 'u', promotedKnight: 'm', promotedSilver: 'a', horse: 'h', dragon: 'd'
};
