    ...
    content: [
      ...
      h(
        "form.form3",
        {
          hook: bindSubmit(e => {
            const obj: FormData = {};
            "name visibility computer explorer cloneable chat sticky description"
              .split(" ")
              .forEach(n => {
          ...
          h("div.form-split", [
            h(
              ...
              select({
                ...
                choices: userSelectionChoices.map(c => [
                  c[0],
                  ctrl.trans.noarg(c[1]),
                ]),
            ...
            h(
              ...
              select({
                ...
                choices: [
                  [
                    "true",
                    ctrl.trans.noarg("yesKeepEveryoneOnTheSamePosition"),
                  ],
      ...
      h("div.destructive", [
        ...
        h(
          ...
          [
            h(
              emptyRedButton,
              ctrl.trans.noarg(isNew ? "cancel" : "deleteStudy"),
            ),
          ],
        ),
      ]),
