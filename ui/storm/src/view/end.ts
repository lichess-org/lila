          ...
          h(
            ...
            h("div.storm--end__high__content", [
              h("div.storm--end__high__text", [
                ...
                high.prev
                  ? h("span", ctrl.trans("previousHighscoreWasX", high.prev))
                  : null,
              ]),
            ]),
          ),
      ...
      h("table.slist", [
        h("tbody", [
          ...
          h("tr", [
            ...
            h("td", [
              h("number", Number(run.time / run.moves).toFixed(2)),
              "s",
            ]),
          ]),
          h("tr", [
        ...
        h("div.storm--end__history__round", [
          h("a.storm--end__history__round__puzzle.mini-board.cg-wrap.is2d", {
            ...
            hook: onInsert(e => {
              const pos = Chess.fromSetup(
                parseFen(round.puzzle.fen).unwrap(),
              ).unwrap();
          ...
          h("span.storm--end__history__round__meta", [
            h("span.storm--end__history__round__result", [
              h(
                round.win ? "good" : "bad",
                Math.round(round.millis / 1000) + "s",
              ),
