...
function renderSvg(state, root) {
    var d = state.drawable, curD = d.current, arrowDests = {};
    var cur = curD && (curD.mouseSq || curD.prev) ? curD : undefined;
...
function renderPiece(baseUrl, pos, piece, bounds) {
    var o = pos2px(pos, bounds), size = bounds.width / 10 * (piece.scale || 1), name = piece.color[0] + (piece.role === 'man' ? 'Q' : piece.role[0]).toUpperCase();
