...
function start(s, e) {
    ...
    if (piece && element && stillSelected && board.isDraggable(s, orig)) {
        ...
        if (ghost) {
            ghost.className = 'ghost ' + render_1.pieceNameOf(piece);
    ...
    util.raf(function () {
        ...
        if (!origPiece || !util.samePiece(origPiece, cur.piece))
            ...
            if (cur.started) {
                ...
                var translation = util.posToTranslateAbs(bounds)(cur.origPos, asWhite, 0);
...
function end(s, e) {
    ...
    if (dest && cur.started) {
        if (cur.newPiece)
            ...
            s.stats.ctrlKey = e.ctrlKey;
            if (anim_1.anim(function (state) { return board.userMove(state, cur.orig, dest); }, s, true)) {
