...
object Dependencies {
  ...
  val scalalib    = "com.github.ornicar"           %% "scalalib"                        % "9.3.0-RC6"
  val hasher      = "com.roundeights"              %% "hasher"                          % "1.3.1"
  val jodaTime    = "joda-time"                     % "joda-time"                       % "2.12.5"
  val chess       = "org.lichess"                  %% "scalachess"                      % "14.8.0"
  ...
  val nettyTransport =
    "io.netty" % s"netty-transport-native-$notifier" % "4.1.90.Final" classifier s"$os-$arch"
