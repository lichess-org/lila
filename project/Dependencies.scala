...
object Dependencies {
  ...
  val scalalib    = "com.github.ornicar"           %% "scalalib"                        % "9.5.1"
  val hasher      = "com.roundeights"              %% "hasher"                          % "1.3.1"
  val jodaTime    = "joda-time"                     % "joda-time"                       % "2.12.5"
  val chess       = "org.lichess"                  %% "scalachess"                      % "15.2.14"
  ...
  val googleOAuth = "com.google.auth"               % "google-auth-library-oauth2-http" % "1.18.0"
