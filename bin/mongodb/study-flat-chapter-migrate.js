...
function encodePath(path) {
  return path ? path.replace(dotRegex, String.fromCharCode(251)).replace(dollarRegex, String.fromCharCode(252)) : '';
}
...
const totalNb = (db.study_chapter.count() - db.study_chapter_flat.count()) / parallelism;
