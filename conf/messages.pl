...
makeYourOpponentResign=Wymuś rezygnację
...
thisPlayerArtificiallyIncreasesTheirRating=Ten gracz sztucznie zwiększa swój rating
opening=Debiut
...
board=szachownica
sharePGN=udostępnij partię w PGN
playOnline=zagraj online
playOffline=zagraj z komputerem
allowAnalytics=udostępnij wszystkim swoje statystyki
shareGameURL=udostępnij partię
