...
nbRelayedGames=%s Przekazanych gier
...
error.email_acceptable=Ten adres e-mail jest nie do zaakceptowania
error.email_unique=Ten adres e-mail jest już zajęty
blindfoldChess=Szachy dla niewidomych(niewidoczne figury)
moveConfirmation=Potwierdzenie ruchu
inCorrespondenceGames=W grach korespondencyjnych
ifRatingIsPlusMinusX=Jeśli ranking jest +/- %s
