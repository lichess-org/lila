...
playANewGame=Rozegraj nową partię
rematch=Rewanż
...
contact=Kontakt
thereIsNothingToSeeHereIfYouThinkItsABugYouCouldSendAnEmailToEmail=Nie ma tutaj niczego ciekawego. Jeżeli myślisz że to błąd, wyślij email na adres %s
