...
rematchOfferDeclined=Ofertę rewanżu anulowano
...
noNewMessages=Żadnych nowych wiadomości
subject=Przedmiot
recipient=Odbiorca
send=Prześlij
...
thisIsAChessCaptcha=To są szachy CAPTCHA.
clickOnTheBoardToMakeYourMove=Kliknij na szachownicę by zrobić ruch i udowodnij że jesteś człowiekiem.
