...
keyYouCanDrawArrowsCirclesAndScrollToMove=Aby rysować kółka i strzałki na szachownicy użyj prawego przycisku myszy. Alternatywnie możesz użyć lewego przycisku myszy w połącznieu z klawiszem shift. Za pomocą rolki możesz odtwarzać posunięcia zarówno do przodu jak i wstecz.
