...
theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim=Twój przeciwnik opuścił grę. Możesz wymusić zwycięstwo, wymusić remis lub poczekać.
...
whiteLeftTheGame=Białe porzuciły gę
...
gamesBeingPlayedRightNow=Obecnie rozgrywane gry
...
blindfoldChess=Szachy dla niewidomych (niewidoczne bierki)
...
menu=Menu
castling=Roszada
whiteCastlingKingside=Krótka roszada białych
whiteCastlingQueenside=Długa roszada białych
blackCastlingKingside=Krótka roszada czarnych
blackCastlingQueenside=Długa roszada czarnych
...
returnToTournamentsHomepage=Powrót na stronę turniejową
