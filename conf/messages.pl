...
closeAccountExplanation=Czy jesteś pewien,że chcesz zamknąć swoje konto?Zamknięcie konta jest decyzją na stałe.Nie będziesz mógł zalogować się już więcej,twoja strona profilowa nie będzie już więcej dostępna
...
claimDrawOnThreefoldRepetitionAutomatically=Wymuszenie remisu w %strzykrotnym powtórzeniu ruchów na planszy,automatycznie
privacy=Prywatność
...
sound=Głos
soundControlInTheTopBarOfEveryPage=Kontrola dźwięku jest wysoką linią na każdej stronie,w prawej części
