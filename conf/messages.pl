...
never=Nigdy
whenTimeRemainingLessThanTenSeconds=Kiedy pozostało czasu<10 sekund
horizontalGreenProgressBars=Pozioma,zielona linia postępu
soundWhenTimeGetsCritical=Dźwięk kiedy czas jest krytyczny
