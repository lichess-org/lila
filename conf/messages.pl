...
theComputerAnalysisYouRequestedIsNowAvailable=Żądana komputerowa analiza jest już dostępny
...
youNeedAUsernameToDoThat=Potrzebujesz nazwę użytkownika aby to zrobić
signUp=Zarejestruj się
people=Ludzie
games=Gry
forum=Forum
searchInForum=Szukaj na forum
...
noMessageHereYet=Żadnych wiadomości tutaj jeszcze nie ma
subject=Przedmiot
recipient=Odbiorca
send=Prześlij
...
xStartedFollowingY=%s Rozpoczęto po %s
