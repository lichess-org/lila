...
email=E-mail
emailIsOptional=E-mail jest w opcji.Lichess użyje go aby zresetować Twoje hasło,jeśli zapomnisz je
...
whiteDeclinesDraw=Białe odmawiają remis
blackDeclinesDraw=Czarne odmawiają remis
...
yourOpeningRatingX=Twój ranking otwarć: %s
...
recentlyPlayedOpenings=Ostatnio grane otwarcia
