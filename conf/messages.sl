...
networkLagBetweenYouAndLichess=slaba povezava z lichessom
confirmResignation=potrdi predajo
letOtherPlayersMessageYou=dovoli sporočila od nasprotnikov
kidMode=otroški način
playChessEverywhere=igraj šah vsepovsod
asFreeAsLichess=zastonj kot lichess
builtForTheLoveOfChessNotMoney=narejen iz ljubezni do šaha, ne denarja
everybodyGetsAllFeaturesForFree=vse funkcije dobiš zastonj
zeroAdvertisement=brez oglasov
phoneAndTablet=telefon in tablica
bulletBlitzClassical=metek, strela, klasično
correspondenceChess=dopisni šah
onlineAndOfflinePlay=igra s povezavo ali brez povezave
