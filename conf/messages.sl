...
nbForumPosts=%s sporočil na forumu
...
joinExistingSimul=Alternativno, pridruži se obstoječi simultanki
...
averageCentipawnLoss=Povprečna izguba v stotinkah vrednosti kmeta
keyboardShortcuts=Bližnjice na tipkovnici
keyMoveBackwardOrForward=premik naprej/nazaj
keyGoToStartOrEnd=pojdi na začetek/konec
keyShowOrHideComments=pokaži/skrij komentarje
keyEnterOrExitVariation=vstopi/izstopi variacijo
