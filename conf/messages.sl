...
training=Uganke
yourPuzzleRatingX=Tvoj ugankarski rejting: %s
findTheBestMoveForColor=Poišči najboljšo potezo za %s
toTrackYourProgress=Spremljaj svoj napredek
trainingSignupExplanation=Da bo reševanje uspešnejše, bo Lichess poiskal uganke primerne tvojemu rejtingu,
recentlyPlayedPuzzles=Nedavno igrane uganke
puzzleId=Uganka %s
goodMove=Dobra poteza
butYouCanDoBetter=Vendar obstaja boljša poteza
bestMove=Najboljša poteza!
keepGoing=Nadaljuj...
puzzleFailed=Reševanje uganke ti je spodletelo
butYouCanKeepTrying=Lahko poskušaš še naprej
victory=Zmaga!
giveUp=Predaj
puzzleSolvedInXSeconds=Uganka rešena v %s sekundah
wasThisPuzzleAnyGood=Je bila uganka zanimiva?
pleaseVotePuzzle=Glasuj in pomagaj Lichess-u. Klikni na gor/dol puščici
thankYou=Hvala!
ratingX=Rejting: %s
playedXTimes=Uganka odigrana %s krat
...
retryThisPuzzle=Poskusi ponovno to uganko
thisPuzzleIsCorrect=Ta uganka je pravilna in zanimiva
thisPuzzleIsWrong=Ta uganka je napačna ali dolgočasna
