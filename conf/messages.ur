...
lastPost=آخری تبصرہ
replies=جوابات
replyToThisTopic=اس موضوع پر رائے دیں
message=پیغام
createTheTopic=نیا موضوع تخلیق کریں
reportAUser=کھلاڑی کے غیر اخلاقی رویے کی شکایت کریں
user=کھلاڑی
reason=شکا یت کی وجہ
whatIsIheMatter=معاملہ کی نوعیت؟
insult=ہتک آمیز رویہ
other=دیگر
thisTopicIsNowClosed=اس موضوع پر مزید تبصرہ ممکن نہیں
map=نقشہ
questionsAndAnswers=سوال جواب
closeAccount=اکاؤنٹ ختم کریں
closeYourAccount=اپنا اکاؤنٹ ختم کریں
never=کبھی نہیں
whenTimeRemainingLessThanTenSeconds=جب بقیہ وقت ١٠ سیکنڈ سے کم ہو
sound=صوتی اختیارات
none=کوئی نہیں
fast=تیز
normal=عام
slow=آہستہ
insideTheBoard=تختے کی اندرونی جانب
outsideTheBoard=تختے کی بیرونی جانب
onSlowGames=کم مدتی مقابلوں میں
always=ہمیشہ
inCasualGamesOnly=صرف دوستانہ مقابلوں میں
difficultyEasy=آسان
difficultyNormal=عام
difficultyHard=مشکل
xCompetesInY=کھلاڑی %s ٹورنامنٹ %s میں کھیل رہا ہے
yourCityRegionOrDepartment=محل وقوع
biographyDescription=اپنے، شطرنج، کھلاڑیوں وغیرہ کے بارے میں اظہار خیال
maximumNbCharacters=میعاد: %s حروف
blocks=%s ممنوعہ کھلاڑی
listBlockedPlayers=ممنوعہ کھلاڑیوں کی فہرست دیکھیں
