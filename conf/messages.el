...
thisPlayerArtificiallyIncreasesTheirRating=Αυτός ο παίκτης αυξάνει τεχνητά την βαθμολογία τους
opening=Άνοιγμα
...
noInternetConnection=Χωρίς σύνδεση. Για να παίξτε χωρίς σύνδεση, ανοίξτε το μενού.
connectedToLichess=Έχετε συνδεθεί με το lichess.org
connectedToLichessAnonymous=Έχετε συνδεθεί με το lichess.org. Μπήτε στον λογαριασμό σας ή ξεκινήστε νέο παιχίδι από το μενού.
