...
nbRelayedGames=%s μεταδιδόμενες παρτίδες
...
error.email=Αυτή η διεύθυνση email είναι άκυρη
error.email_acceptable=Αυτή η διεύθυνση email δεν είναι αποδεκτή
error.email_unique=Αυτή η διεύθυνση email χρησιμοποιείται ήδη
...
ifRatingIsPlusMinusX=Αν το έλο είναι ± %s
onlyFriends=Μόνο φίλους
