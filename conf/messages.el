...
changedMindDoNotCloseAccount=Άλλαξα γνώμη, μην κλείνετε το λογαριασμό μου
...
horizontalGreenProgressBars=Οριζόντιες πράσινες μπάρες προόδου
...
claimDrawOnThreefoldRepetitionAutomatically=Αίτημα ισοπαλίας σε %sτριπλή επανάληψη%s αυτόματα
privacy=Απόρρητο
...
whenTimeRemainingLessThanThirtySeconds=Όταν απομένουν < 10 δευτερόλεπτα
difficultyEasy=Εύκολοι
difficultyNormal=Κανονικοί
difficultyHard=Δύσκολοι
xLeftANoteOnY=Ο χρήστης %s άφησε ένα μήνυμα στον χρήστη %s
xCompetesInY=%s διαγωνίζεται στο %s
xAskedY=%s ρώτησε %s
xAnsweredY=%s απάντησε %s
xCommentedY=%s σχολίασε %s
timeline=Χρονικό
