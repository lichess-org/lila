...
makeYourOpponentResign=Υποχρεώστε τον αντίπαλο σας να παραιτηθεί
forceResignation=Υποχρεώστε παραίτηση
forceDraw=Υποχρεώστε ισοπαλία
...
trainingSignupExplanation=Το lichess θα σας προσφέρει γρίφους που αντοιστιχούν με την ικανότητα σας, με αποτέλεσμα μια καλύτερη εμπειρία εξάσκησης στο σκάκι.
...
blog=Ιστολόγιο
map=Χάρτης
realTimeWorldMapOfChessMoves=Χάρτης του κόσμου που δείχνει κινήσεις σε πραγματικό χρόνο
...
whiteCastlingQueenside=Λευκά O-O-O
blackCastlingKingside=Μαύρα O-O
blackCastlingQueenside=Μαύρα O-O-O
...
aboutSimulImage=Από τους 50 αντιπάλους, ο Φίσερ κέρδισε 47 παιχνίδια, επέστησε 2 και έχασε 1.
aboutSimulRealLife=Η έννοια προέρχεται από πραγματικά παγκόσμια γεγονότα. Στην πραγματική ζωή, ο διοργανωτής της έκθεσης μετακινείται από τραπέζι σε τραπέζι για να παίξει μία και μόνο κίνηση.
aboutSimulRules=Όταν ξεκινήσει η έκθεση, κάθε παίκτης ξεκινά το παιχνίδι με τον διοργανωτή, ο οποίος θα έχει τα λευκά κομμάτια. Η διοργάνωση τελειώνει όταν όλα τα παιχνίδια ολοκληρωθούν.
aboutSimulSettings=Οι ταυτ.εκθέσεις είναι πάντα αβαθμολόγητες. Οι επαναλήψεις, ανακλήσεις κινήσεων και προσθήκες επιπλέον χρόνου έχουν απενεργοποιηθεί.
create=Δημιουργήστε
whenCreateSimul=Όταν δημιουργείτε μία έκθεση, θα έχετε να παίξετε με αρκετούς παίκτες ταυτόχρονα.
joinExistingSimul=Εναλλακτικά, συμμετέχετε σε μια υπάρχουσα έκθεση
...
lichessTournaments=Lichess Πρωταθλήματα
tournamentFAQ=Αρένα πρωτάθλημα FAQ
