...
joinTheGame=Ξεκινήστε το παιχνίδι
whitePlays=Παίζουν τα λευκά
blackPlays=Παίζουν τα μαύρα
theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim=Ο αντίπαλος σας έφυγε από το παιχνίδι. Μπορείτε να διεκδικήσετε νίκη, ισοπαλία, ή να περιμένετε.
makeYourOpponentResign=Αναγκάστε τον αντίπαλο σας να παραιτηθεί
forceResignation=Ισχυριστείτε νίκη
forceDraw=Ζητήστε ισοπαλία
