...
forceResignation=Αξιώστε τη νίκη
...
logOut=Έξοδος
signIn=Είσοδος
newToLichess=Νέος/α στο Lichess;
...
variant=Εκδοχή (Βαριάντα)
variants=Εκδοχές (Βαριάντες)
...
tournamentHomeDescription=Παίξτε συναρπαστικά πρωταθλήματα σκακιού! Ενταχθείτε σε επίσημα προγραμματισμένα τουρνουά, η οργανώστε δικά σας. Μπούλετ, Μπλιτς, Κλασσικό, Chess960, King of the Hill, 3-Σαχ και περισσότερες επιλογές είναι διαθέσιμες για ατελείωτη διασκέδαση στη σκακιέρα.
tournamentNotFound=Πρωτάθλημα δε βρέθηκε
tournamentDoesNotExist=Το πρωτάθλημα δεν υπάρχει.
tournamentMayHaveBeenCanceled=Μπορεί να ακυρώθεικε, αν όλοι οι παίκτες έφυγαν πριν αρχίσει.
returnToTournamentsHomepage=Επιστροφή στον κατάλογο πρωταθλημάτων
