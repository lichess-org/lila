...
checkYourEmail=Μεταβείτε στο ηλεκτρονικό ταχυδρομείο σας
weHaveSentYouAnEmailTo=Ένα μήνυμα έχει σταλεί στο %s. επιλέξτε τον σύνδεσμο στο ηλεκτρονικό ταχυδρομείο  για να ακυρώσετε τον κωδικό σας
networkLagBetweenYouAndLichess=Καθυστέρηση σύνδεσης με lichess
