...
tournamentHomeDescription=Παίξτε στιγμιαία σκακιστικά πρωταθλήματα! Συμμετάσχετε σε ένα επίσημο προγραμματισμένο πρωτάθλημα ή να δημιουργήσετε δικά σας. Ύπερταχέα, Ταχέα, Κλασσικά, 960, Βασιλιάς στο κέντρο, 3σαχ, και άλλες διαθέσιμες επιλογές για ατελείωτη σκακιστική διασκέδαση.
tournamentNotFound=Πρωτάθλημα δεν ευρέθη
tournamentDoesNotExist=Αυτό το πρωτάθλημα δεν υπάρχει.
tournamentMayHaveBeenCanceled=Ίσως έχει ακυρωθεί, εάν όλοι οι παίκτες αποχωρήσαν πριν το πρωτάθλημα ξεκινήσει.
