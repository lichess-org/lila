playWithAFriend=Παίξε με ένα φίλο
playWithTheMachine=Παίξε με τον υπολογιστή
toInviteSomeoneToPlayGiveThisUrl=Για να προσκαλέσεις κάποιον σε ένα παιχνίδι, στείλε του αυτήν τη διεύθυνση
gameOver=Έχασες
...
playWithTheSameOpponentAgain=Ξαναπαίξε με τον ίδιο αντίπαλο
newOpponent=Νέος αντίπαλος
playWithAnotherOpponent=Παίξε με άλλο αντίπαλο
yourOpponentWantsToPlayANewGameWithYou=Ο αντίπαλος θέλει να παίξει νέο παιχνίδι μαζί σας
joinTheGame=Ξεκίνησε το παιχνίδι
whitePlays=Παίζουν τα λευκά
blackPlays=Παίζουν τα μαύρα
theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim=Ο αντίπαλος έφυγε από το παιχνίδι. Μπορείς να τελειώσεις το παιχνίδι με νίκη, με ισοπαλία, ή να περιμένεις.
makeYourOpponentResign=Τελείωσε το παιχνίδι με νίκη, αναγκάζοντας τον αντίπαλο να παραιτηθεί
forceResignation=Νίκησα
forceDraw=Ήταν ισοπαλία
talkInChat=Παρακαλούμε να είστε ευγενικοί στη συνομιλία
theFirstPersonToComeOnThisUrlWillPlayWithYou=Ο πρώτος που επισκευτεί αυτήν τη διεύθυνση θα παίξει μαζί σου
...
monthlyPerfTypeRatingDistribution=Μηνιαία %s κατανομή βαθμολογίας
nbPerfTypePlayersThisMonth=%s %s παίκτες αυτό το μήνα.
