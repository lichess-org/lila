...
logOut=Έξοδος
signIn=Είσοδος
newToLichess=Νέος στο Lichess;
youNeedAnAccountToDoThat=Χρειάζεστε λογαριασμό για να το κάνετε αυτό
signUp=Εγγραφή
people=Άτομα
games=Παιχνίδια
forum=Φόρουμ
searchInForum=Αναζήτηση φόρουμ
xPostedInForumY=%s έγραψε στο φόρουμ %s
...
viewTournament=Παρακολούθηση τουρνουά
...
colorPlaysCheckmateInOne=Τα %s παίζουν·κάντε ματ σε μία κοίνηση
retry=Επανάληψη
