...
openTournaments=Ανοιχτά πρωταθλήματα
duration=Διάρκεια
winner=Νικητής
standing=Βαθμολογία
...
watchLichessTV=Παρακολούθησε/Παρακολουθήστε Lichess TV
previouslyOnLichessTV=Προηγουμένως στο Lichess TV
todaysLeaders=Σημερινοί αρχηγοί/Πρώτοι Ημέρας
onlinePlayers=Συνδεδεμένοι παίχτες
progressToday=Σημερινή πρόοδος
progressThisWeek=Εβδομαδιαία πρόοδος
progressThisMonth=Μηνιαία πρόοδος
leaderboardThisWeek=Εβδομαδιαία πρόοδος
leaderboardThisMonth=Μηνιαία πρόοδος
activeToday=Ενεργός/Ενεργοί σήμερα
activeThisWeek=Ενεργός/Ενεργοί αυτή την εβδομάδα
activePlayers=Ενεργοί παίχτες
bestBulletPlayers=Καλύτεροι παίχτες bullet('σφαίρα')
bestBlitzPlayers=Καλύτεροι παίχτες blitz('αστραπιαίο')
bestSlowPlayers=Καλύτεροι παίχτες slow(αργό)
