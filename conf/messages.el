...
internationalEvents=Διεθνείς αγώνες
...
aboutSimulImage=Από τους 50 αντιπάλους, ο Φίσερ κέρδισε 47 παιχνίδια, 2 ισοπαλίες και έχασε 1.
aboutSimulRealLife=Η έννοια προέρχεται από πραγματικά παγκόσμια γεγονότα. Στην αληθινή ζωή, ο διοργανωτής της έκθεσης μετακινείται από τραπέζι σε τραπέζι για να παίξει μία και μόνο κίνηση.
