...
noInternetConnection=Χωρίς σύνδεση. Για να παίξετε offline πατήστε μενού.
connectedToLichess=Έχετε συνδεθεί με το lichess.org
connectedToLichessAnonymous=Έχετε συνδεθεί με το lichess.org. Δώστε στοιχεία ή ξεκινήστε νέο παιχίδι από το μενού.
signedOut=Αποσύνδεση στοιχείων
