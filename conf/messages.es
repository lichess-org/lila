...
progressThisWeek=Progreso de esta semana
progressThisMonth=Progreso de este mes
leaderboardThisWeek=Líderes de esta semana
leaderboardThisMonth=Líderes de este mes
activeToday=Activos hoy
activePlayers=Jugadores activos
bewareTheGameIsRatedButHasNoClock=¡Cuidado, el juego es con puntos pero sin reloj!
...
monthlyPerfTypeRatingDistribution=Distribución de puntos mensual de %s
nbPerfTypePlayersThisMonth=%s %s jugadores este mes.
yourPerfTypeRatingisRating=Tu puntuación de %s es %s.
youAreBetterThanPercentOfPerfTypePlayers=Eres mejor que el %s de jugadores de %s.
