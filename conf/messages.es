...
noInternetConnection=No hay conexión a internet. Pero puede jugar fuera de línea desde el menú.
connectedToLichess=Está conectado a lichess.org
connectedToLichessAnonymous=Está conectado a lichess.org. Puede iniciar sesión o iniciar un nuevo juego desde el menú.
signedOut=Usted ha cerrado la sesión
playOnTheBoardOffline=Jugar fuera de línea
showPGN=Ver PGN
