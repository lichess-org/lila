...
myTeams=Mi equipo
noTeamFound=Equipo no encontrado
joinTeam=Unirse al equipo
quitTeam=Salir del equipo
anyoneCanJoin=Cualquiera puede unirse
aConfirmationIsRequiredToJoin=Confirmación requerida para unirse
joiningPolicy=Política de unión
teamLeader=Líder del equipo
teamBestPlayers=Mejores jugadores del equipo
teamRecentMembers=Miembros más recientes del equipo
