...
aboutSimul=Una exhibición simultánea es un evento en el que un anfitrión juega múltiples partidas de ajedrez a la vez contra varios jugadores.
aboutSimulImage=De 50 contrincantes, Fischer ganó 47 partidas, empató 2 y perdió 1.
aboutSimulRealLife=En la vida real, el anfitrión va de tablero en tablero en un orden fijado.
aboutSimulRules=El anfitrión juega todas las partidas con las piezas blancas. Cuando el anfitrión llega a un tablero, primero espera a que mueva el oponente y luego efectúa su movimiento.
...
simulAddExtraTime=Puedes darle tiempo extra a tu reloj para manejar la simultánea.
simulHostExtraTime=Tiempo extra del anfitrión
lichessTournaments=Torneos Lichess
...
tournamentHomeTitle=Torneos con varios controles de tiempo y variantes
tournamentHomeDescription=¡ Juega torneos de ritmo rápido ! Únete a un torneo oficial programado, o crea los tuyos. Bala, Blitz, Clásico, Ajedrez960, Rey de la colina, Tres Jaques, y más opciones disponibles para un sinfin de diversión.
tournamentNotFound=Torneo no encontrado
tournamentDoesNotExist=Este torneo no existe.
tournamentMayHaveBeenCanceled=Pudo haberse cancelado, si todos los participantes dejaron el torneo antes de iniciar.
returnToTournamentsHomepage=Regrese a la página de torneos
