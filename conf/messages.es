...
signUp=Regístrate
computersAreNotAllowedToPlay=No les está permitido jugar a las computadores ni a jugadores asistidos por ellas. Por favor, no te ayudes de motores de ajedrez, bases de datos o de otros jugadores durante el juego. También ten en cuenta que se desalienta tener mas de una cuenta y el uso excesivo de varias cuentas resultara en la cancelacion de las mismas.
games=Partidas
forum=Foro
...
leaderboardThisWeek=Lideres de esta semana
leaderboardThisMonth=Lideres de este mes
...
findTheBestMoveForWhite=Encuentra la mejor movida para las blancas.
findTheBestMoveForBlack=Encuentra la mejor movida para las negras.
toTrackYourProgress=Para monitorizar tu progreso:
trainingSignupExplanation=Lichess te proporcionara ejercicios de acuerdo a tu habilidad de juego para optimizar tus sesiones de entrenamiento
...
pleaseVotePuzzle=Ayuda a Lichess a mejorar a traves de tu votacion, usando las flechas arriba o abajo.
thankYou=¡Gracias!
...
automaticallyProceedToNextGameAfterMoving=Proceder a la siguiente partida automáticamente despues de mi movida
...
thisAccountIsClosed=Esta cuenta esta cerrada.
...
boardHighlights=Destacar casillas del tablero (última movida y jaque)
...
sound=Sonido
soundControlInTheTopBarOfEveryPage=El control de sonido esta en la barra superior de cada página, en el lado derecho.
...
moveConfirmation=Confirmación de movida
...
noSimulFound=Simultanea no encontrada
noSimulExplanation=Esta exhibición simultánea no existe.
returnToSimulHomepage=Volver a la página de simultáneas
aboutSimul=Simultaneas implican un jugador enfrentandose a varios jugadores al mismo tiempo.
aboutSimulImage=De 50 oponentes, Fischer ganó 47 partidas, empató 2 y perdió 1.
aboutSimulRealLife=El concepto de simultaneas en lichess es tomado de la vida real, donde el anfitrion va de mesa en mesa para hacer su movida.
aboutSimulRules=Cuando la simultanea empieza, cada jugador comienza un juego con el anfitrion, el cual juega con las blancas. La simultanea termina cuando todos los juegos se completan.
aboutSimulSettings=Las simultaneas siempre son partidas amistosas. Peticiones de revancha, deshacer jugada y agregar tiempo son desabilitadas.
create=Crear
whenCreateSimul=Cuando creas una simultanea, juegas contra varios jugadores a la vez.
joinExistingSimul=Como alternativa, unirse a una simultánea disponibles
simulVariantsHint=Si seleccionas varias variantes, cada jugador escoge cual jugar.
...
timeBeforeTournamentStarts=Tiempo antes de que comienze el torneo
...
keyShowOrHideComments=mostrar/esconder commentarios
keyEnterOrExitVariation=entre/deje variacion
keyYouCanDrawArrowsCirclesAndScrollToMove=Presione shift+click o click derecho para dibujar circulos y flechas en el tablero. Tambien puede desplazarse por el tablero para moverlas en el juego.
