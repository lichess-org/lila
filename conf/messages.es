...
makeYourOpponentResign=Forzar a tu oponente a abandonar
...
blindfoldChess=El ajedrez a la ciega
...
ifRatingIsInThreshold=Rango de puntuación de ± %s
...
biographyDescription=Cuéntanos que te gusta del ajedrez, tu apertura favorita, partidad, jugadores...
...
noInternetConnection=No hay conexión a internet. Pero puede jugar sin conexión desde el menú.
...
shareGameURL=Compartir juego URL
...
simulImageDesc=Jugando contra 50 oponentes a la vez, Bobby Fischer ganó 47 partidas, empató dos y perdió una.
...
castling=Enroque
menu=Menú
freeChessVideoLibrary=Videos de ajedrez gratis
videoLibraryExplanOne=Todos estos videos son gratis.
videoLibraryExplanTwo=Hacer click en las etiquetas para filtro.
...
or=o
moveBackwardOrForward=avanzar/regresar
...
lichessWorldMap=Mapamundi Lichess
moves=movimientos
countries=países
lichessMonitor=Monitor Lichess
backToLichessHome=volver a la página de inicio
lichessReactor=Reactor Lichess
down=CAÍDO
up=OPERATIVO
shutdownDoNotClick=Parada de Emergencia - ¡NO HAGAS CLIC AQUÍ!
