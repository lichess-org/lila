...
yourOpeningRatingX=Tu puntuación en aperturas: %s
findNbStrongMoves=Encuentra %s movimientos fuertes
thisMoveGivesYourOpponentTheAdvantage=El movimiento le da ventaja a tu oponente
openingFailed=Apertura fallada
openingSolved=Apertura resuelta
recentlyPlayedOpenings=Últimas aperturas jugadas
