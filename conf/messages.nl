...
theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim=De andere speler is weggegaan. U kunt opgeven afdwingen of een remise of nog even wachten.
...
findTheBestMoveForWhite=Vindt de beste zet voor wit.
findTheBestMoveForBlack=Vindt de beste zet voor zwart.
...
claimDrawOnThreefoldRepetitionAutomatically=Automatisch remise opeisen bij %sdriemaal zelfde stelling%s
privacy=Privacy
...
connectedToLichessAnonymous=U bent nu verbonden met lichess.org. U kan inloggen of een nieuw spel starten vanuit het menu.
