...
theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim=De andere speler is weggegaan. U kunt de overwinning opeisen, remiseren of wachten.
...
menu=Menu
castling=Rokeren
whiteCastlingKingside=Wit 0-0
whiteCastlingQueenside=Wit 0-0-0
blackCastlingKingside=Zwart 0-0
blackCastlingQueenside=Zwart 0-0-0
...
joinExistingSimul=Je kunt ook deelnemen aan een al bestaande simultaan
