...
findNbStrongMoves=Vind %s sterke zetten
thisMoveGivesYourOpponentTheAdvantage=Deze zet geeft uw tegenstander het voordeel
...
tournamentWinners=Toernooi winners
name=Naam
description=Beschrijving
no=Nee
yes=Ja
help=Help:
createANewTopic=Creëer een nieuw topic
topics=Topics
posts=Posts
lastPost=Laatste posts
views=Views
replies=Replies
...
blog=Blog
map=Kaart
realTimeWorldMapOfChessMoves=Real time wereldkaart van schaakzetten
...
changedMindDoNotCloseAccount=Ik ben van gedachte veranderd, sluit mijn account niet
closeAccountExplanation=Weet je zeker dat je je account wilt sluiten? Je account sluiten is een permanente beslissing. Je zal niet meer kunnen inloggen en je profielpagina zal niet meer bereikbaar zijn.
...
boardHighlights=Bord highlights (laatste zet en schaak)
pieceDestinations=Stuk bestemming (geldige zetten en premoves)
boardCoordinates=Bord coördinaten (A-H, 1-8)
moveListWhilePlaying=Zetnotatie lijst tijdens het spelen
chessClock=Schaakklok
tenthsOfSeconds=Tienden van seconden
never=Nooit
whenTimeRemainingLessThanTenSeconds=Wanneer overgebleven tijd < 10 seconden
horizontalGreenProgressBars=Horizontale groene vorderingsbalk
soundWhenTimeGetsCritical=Geluid wanneer tijd bijna op is
gameBehavior=Spelgedrag
premovesPlayingDuringOpponentTurn=Premoves (zetten tijdens de beurt van tegenstander)
...
claimDrawOnThreefoldRepetitionAutomatically=Automatisch gelijkspel claimen bij %sdriemaal dezelfde stelling%s
privacy=Privacy
letOtherPlayersFollowYou=Volgers toestaan
letOtherPlayersChallengeYou=Uitdagingen van andere spelers toestaan
sound=Geluid
soundControlInTheTopBarOfEveryPage=De geluidsbediening is in de bovenste balk van elke pagina, aan de rechter zijde.
...
onSlowGames=Bij langzame partijen
always=Altijd
inCasualGamesOnly=Enkel in vrijblijvende partijen
whenPremoving=Wanneer er een premove gespeeld wordt
whenTimeRemainingLessThanThirtySeconds=Wanneer overgebleven tijd < 30 seconden
difficultyEasy=Gemakkelijk
difficultyNormal=Normaal
difficultyHard=Moeilijk
xLeftANoteOnY=%s liet een bericht achter bij %s
xCompetesInY=%s speelt mee in %s
xAskedY=%s vroeg %s
xAnsweredY=%s antwoordde %s
xCommentedY=%s schreef %s
timeline=Tijdslijn
seeAllTournaments=Zie alle toernooien
starting=Startend:
allInformationIsPublicAndOptional=Alle informatie is openbaar en optioneel.
yourCityRegionOrDepartment=Je stad, regio of afdeling
biographyDescription=Vertel over jezelf, wat je leuk vindt in schaken, je favoriete openingen, partijen, spelers...
maximumNbCharacters=Maximaal: %s tekens.
blocks=%s blokkeringen
listBlockedPlayers=Lijst van spelers die jij geblokkeerd hebt
