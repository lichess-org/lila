...
training=Training
yourPuzzleRatingX=Jouw puzzel rating: %s
findTheBestMoveForColor=Vind de beste zet voor %s.
toTrackYourProgress=Om je vooruitgang bij te houden:
trainingSignupExplanation=Lichess zal puzzels kiezen die bij je vaardigheden passen, zodat de training sessies nog beter worden.
...
pleaseVotePuzzle=Help om lichess beter te maken door te stemmen (gebruik de omhoog of omlaag knop):
thankYou=Dank u!
ratingX=Rating: %s
playedXTimes=Al %s keer gespeeld
winRateX=Winst percentage: %s
fromGameLink=Uit partij %s
startTraining=Begin training
continueTraining=Ga verder met de training
retryThisPuzzle=Probeer deze puzzel nog eens
