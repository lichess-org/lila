...
moveListWhilePlaying=Zettenlijst tijdens spel
chessClock=Schaakklok
tenthsOfSeconds=Tienden van seconden
never=Nooit
whenTimeRemainingLessThanTenSeconds=Indien resterende tijd < 10 seconden
horizontalGreenProgressBars=Horizontale groene voortgangsbalk
gameBehavior=Spel gedrag
takebacksWithOpponentApproval=Terugname (mits goedkeuring tegenstander)
promoteToQueenAutomatically=Promoveer automatisch tot koningin
sound=Geluid
...
seeAllTournaments=Zie alle tornooien
