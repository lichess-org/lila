...
yes=Ja
help=Help:
createANewTopic=Begin een nieuw onderwerp
topics=Onderwerpen
posts=Berichten
...
reply=Reageer
message=Bericht
createTheTopic=Begin het onderwerp
reportAUser=Rapporteer een gebruiker
user=Gebruiker
reason=Reden
...
troll=Troll
other=Anders
reportDescriptionHelp=Plak de link van de partij(en) en leg uit wat er mis is met het gedrag van de gebruiker.
by=door %s
thisTopicIsNowClosed=Dit onderwerp is nu gesloten.
theming=Thematiseren
donate=Doneren
blog=Blog
map=Map
realTimeWorldMapOfChessMoves=Live globale map van schaakzetten
questionsAndAnswers=Vragen en antwoorden
notes=Aantekeningen
typePrivateNotesHere=Typ hier privé aantekeningen
gameDisplay=Partijweergave
pieceAnimation=Stuk animaties
materialDifference=Materieel verschil
