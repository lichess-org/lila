...
training=Training
yourPuzzleRatingX=Je puzzel score: %s
findTheBestMoveForColor=Vind de beste zet voor %s.
toTrackYourProgress=Om je vooruitgang te volgen:
trainingSignupExplanation=Lichess zal puzzels verschaffen die overeenkomen met je niveau, wat leidt voor betere trainingssessies.
