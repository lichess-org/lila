...
xToYMinutes=%s в %s минут
textIsTooShort=Текст очень короткий.
textIsTooLong=Текст очень длинный.
required=Необходимо.
addToChrome=Добавить в Chrome
openTournaments=Активные соревнования.
winner=Победитель
join=Войти
winStreak=Побед подряд
createdBy=Создано
tournamentIsStarting=Начало турнира
