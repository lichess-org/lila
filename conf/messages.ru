...
byRegisteringYouAgreeToBeBoundByOur=Регистрируясь, Вы соглашаетесь с нашими %s.
...
downloadAnnotated=С пояснениями
downloadRaw=В виде текста
downloadImported=Исходный файл
printFriendlyPDF=PDF для печати
crosstable=Общий зачёт
youCanAlsoScrollOverTheBoardToMoveInTheGame=Наведите курсор на доску и листайте ходы колёсиком мышки.
pressShiftPlusClickOrRightClickToDrawCirclesAndArrowsOnTheBoard=Кликайте с нажатым shift или правой кнопкой мыши для рисования кругов и линий.
