...
email=Email
emailIsOptional=Email не обязателен. Он нужен для восстановления забытого пароля.
passwordReset=Строс пароля
...
blackDeclinesDraw=Черные отказываются от ничьей
