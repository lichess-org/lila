...
theComputerAnalysisYouRequestedIsNowAvailable=Компьютерный анализ для вас теперь доступен
...
youNeedAUsernameToDoThat=Вам нужно имя пользователя, чтобы это сделать
signUp=Регистрация
people=Люди
games=Игры
forum=Форум
...
noMessageHereYet=Пока здесь нет сообщений
subject=Тема
...
pasteTheFenStringHere=Вставьте строку в формате ФЕН
...
favoriteOpponents=Избранные противники
follow=Следит
following=Следят
unfollow=Не следить
block=Блокировать
...
followsYou=Следят за вами
xStartedFollowingY=%s начали следить %s
nbFollowers=%s следят
nbFollowing=%s следит
profile=Профиль
more=Больше
