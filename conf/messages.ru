...
error.email_acceptable=Этот почтовый ящик не подтвержден.
error.email_unique=Этот почтовый ящик уже используется.
blindfoldChess=Шахматы вслепую. (не отображаются)
