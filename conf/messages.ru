...
toInviteSomeoneToPlayGiveThisUrl=Чтобы пригласить кого-нибудь поиграть, отправьте эту ссылку
...
level=Уровень
toggleTheChat=Показать/скрыть окно чата
