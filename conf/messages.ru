...
latestForumPosts=Последнее сообщение
players=Игроки
...
training=Шахматные задачи
findTheBestMoveForColor=Поиск лучшего хода для %s
goodMove=Хороший ход
butYouCanDoBetter=Но возможно лучше.
bestMove=Лучший ход!
victory=Победа!
puzzleSolvedInXSeconds=Задача решена за %s секунд.
thankYou=Спасибо!
fromGameLink=Для игры %s
