...
confirmResignation=Подтверждать ничью
letOtherPlayersMessageYou=Разрешить другим пользователям писать мне
youHaveAlreadyRegisteredTheEmail=Вы уже зарегистрировали адрес
kidMode=Детский режим
security=Безопасность
current=ОНЛАЙН
alternativelyYouCan=Вы также можете
revokeAllSessions=закрыть все сессии
thisIsAListOfDevicesThatHaveLoggedIntoYourAccount=Это список устройств, вошедших в Ваш аккаунт. Вы можете закрыть любую сессию, которая кажется Вам подозрительной.
date=Дата
from=С
to=До
...
source=Источник
whetherThePlayersOpponentWasAHumanOrAComputer=С кем играл пользователь?
...
rankIsUpdatedEveryFifteenMinute=Места обновляются каждые 15 минут
notes=Заметок
averageScoreAs=Средний рейтинг за 
knowingTheChessboardCoordinatesIsAVeryImportantChessSkill=Знание координат доски - очень важное умение
aSquareNameAppearsOnTheBoardAndYouMustClickOnTheCorrectSquare=Вам необходимо нажимать на клетки, координаты которых появляются на доске.
youHaveThirtySecondsToRecognizeAsManySquaresAsPossible=Распознайте как можно больше клеток за 30 секунд!
...
lichessOnTheGo=lichess на ходу
challengeOnlinePlayers=Соревнуйтесь онлайн
playStockfishLevelOneToEight=Играйте с компьютером
...
lookOutForUpdatesRegularly=Регулярно проверяйте обновления!
moreOfTheFeaturesWillBeAddedSoon=Многие любимые функции скоро будут доступны на телефоне.