...
joinExistingSimul=Или присоединитесь к готовому сеансу
...
tournamentFAQ=FAQ турнира Арена
...
tournamentDoesNotExist=Турнир не существует.
tournamentMayHaveBeenCanceled=Можно аннулировать, если все игроки покинули турнир до его начала.
