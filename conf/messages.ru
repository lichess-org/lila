...
rematch=Реванш
rematchOfferSent=Предложение отправлено реванша
rematchOfferAccepted=Предложение принято реванша
rematchOfferCanceled=Предложение отклонено реванша
rematchOfferDeclined=Предложение отклонено реванша
...
takebackPropositionAccepted=Предложение принято возврата
