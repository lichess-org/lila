...
nbBookmarks=Закладки
nbPopularGames=Популярные игры
...
rematchOfferCanceled=Переигровка отменена
rematchOfferDeclined=Переигровка отклонена
cancelRematchOffer=Отказаться от реванша
play=Играть
inbox=Входящие
chatRoom=Чат-комната
spectatorRoom=Чат зрителей
...
bookmarkThisGame=Добавить эту игру в закладки
