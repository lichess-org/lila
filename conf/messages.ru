...
claimDrawOnThreefoldRepetitionAutomatically=Считать ничью после %sthreefold repetition%s повторений
privacy=Приватность
...
computer=Компьютер
side=Цвет
clock=Контроль времени
unauthorizedError=Вы не авторизованы
noInternetConnection=Нет связи. Вы можете играть оффлайн
connectedToLichess=Вы подключились к lichess.org
connectedToLichessAnonymous=Вы подключились к lichess.org. Авторизуйтесь или начните игру.
signedOut=Вы вышли
playOnTheBoardOffline=Играть оффлайн,
