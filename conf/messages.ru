...
seeTheGamesBeingPlayedInRealTime=Посмотреть партии, которые играются в данный момент
...
membersOnly=Только зарегистрированные
...
leaderboardThisWeek=Прогресс на этой неделе
leaderboardThisMonth=Прогресс в этом месяце
...
bewareTheGameIsRatedButHasNoClock=Внимание! Игра на рейтинг, но она не приурочен!
