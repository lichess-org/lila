...
theComputerAnalysisYouRequestedIsNowAvailable=Камп'ютарны аналіз паводле запыту даступны
...
talkAboutChessAndDiscussLichessFeaturesInTheForum=Паразмаўляць пра шахматы ды абмеркаваць асаблівасьці lichess на форуме
...
rematchOfferCanceled=У прапанове перагуляць адмоўлена
...
sentMessages=Дасланыя паведамленьні
