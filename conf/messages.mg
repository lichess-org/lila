...
playWithTheSameOpponentAgain=Milalaova indray miaraka amin'ny mpifanandrina
newOpponent=Mpifanandrina vaovao
playWithAnotherOpponent=Milalaova miaraka amina mpifanandrina hafa
...
theOtherPlayerHasLeftTheGameYouCanForceResignationOrWaitForHim=Mety nandao ny lalao ny mpifanandrina. Afaka mitaky ny fandresena, miandry ny fiverenany, na manery azy hiala ilany ianao.
makeYourOpponentResign=Asaivo miverina ny mpifanandrina aminao
...
whiteCreatesTheGame=Ny fotsy no nanomboka ny lalao
blackCreatesTheGame=Ny mainty no nanomboka ny lalao
whiteJoinsTheGame=Miditra ao amin'ny lalao ny fotsy
blackJoinsTheGame=Miditra ao amin'ny lalao ny mainty
whiteResigned=Niverina ny fotsy
blackResigned=Niverina ny mainty
...
theComputerAnalysisYouRequestedIsNowAvailable=Efa vonona ny fanadihadiana nangatahanao
...
viewGameStats=Jereo ny antotan'isan'ny lalao
...
talkAboutChessAndDiscussLichessFeaturesInTheForum=Miresaha momba ny echéc sy lichess ao amin'ny serasera
seeTheGamesBeingPlayedInRealTime=Jereo ny lalao amin'izao fotoana sy ny efa lasa
...
drawOfferAccepted=Noekena ny fangatahana ny hahasahala ny lalao
drawOfferCanceled=Nadaboka ny fangatahana ny hahasahala ny lalao
yourOpponentOffersADraw=Manome soso-kevitra ny hahasahala ny lalao ny mpifanandrina
accept=Ekena
decline=Lavina
...
toggleBackground=Ovay ny loko ambadika
search=Fitadiavana
...
progressToday=Ny fivoarana androany
progressThisWeek=Ny fivoarana tamin'ity erinandro ity
progressThisMonth=Ny fivoarana tamin'ity volana ity
