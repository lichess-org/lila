...
draw=Gêm gyfartal
nbConnectedPlayers=%s o chwaraewyr wedi'i gysylltu
...
findTheBestMoveForWhite=Chwiliwch am y symudiad gorau i Wyn
findTheBestMoveForBlack=Chwiliwch am y symudiad gorau i Ddu
toTrackYourProgress=I ddilyn eich gwelliant:
trainingSignupExplanation=Bydd Lichess yn rhoi ichi posau sy'n addas i'ch gallu.
recentlyPlayedPuzzles=Posau wedi'u chwarae
puzzleId=Pos %s
puzzleOfTheDay=Pos heddiw
clickToSolve=Cliciwch i ddatrys
goodMove=Symudiad da
butYouCanDoBetter=Ond gellwch ffeindio un gwell.
bestMove=Symudiad gorau!
keepGoing=Daliwch ati ...
puzzleFailed=Wedi methu
butYouCanKeepTrying=Ond gellwch ddal ati a thrio eto
...
youHaveNbSecondsToMakeYourFirstMove=Mae gennoch %s eiliad i wneud y symudiad cyntaf!
...
openingId=Agoriad %s
yourOpeningRatingX=Eich graddfa agoriad: %s
findNbStrongMoves=Ffeindiwch %s o symudiadau cryf
...
blog=Blog
map=Map
realTimeWorldMapOfChessMoves=Map y byd symudiadau gwyddbwyll (amser go iawn)
