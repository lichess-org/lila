...
leaderboardThisWeek=Chwaraewyr gorau a chwaraeodd yr wythnos ma
leaderboardThisMonth=Chwaraewyr gorau a chwaraeodd y mis ma
activeToday=Gweithredol heddiw
activeThisWeek=Gweithredol yr wythnos ma
...
blog=Blog
map=Map
realTimeWorldMapOfChessMoves=Map y byd symudiadau gwyddbwyll (amser real)
...
joinExistingSimul=Gelli hefyd ymuno at cystadleuaeth cyfochrog sydd yn bodoli yn barod.
simulAddExtraTime=Gelli ychwanegu amser at dy gloc i'th helpu ymdopi â'r cystadleuaeth cyfochrog.
